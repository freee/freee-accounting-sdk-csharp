...
namespace Freee.Accounting.Api
{
    ...
    public interface IItemsApiSync : IApiAccessor
    {
        ...
        InlineResponse2006 GetItems (int companyId, int? offset = default(int?), int? limit = default(int?));
        ...
        ApiResponse<InlineResponse2006> GetItemsWithHttpInfo (int companyId, int? offset = default(int?), int? limit = default(int?));
        /// <summary>
        /// 品目の更新
        /// </summary>
        /// <remarks>
    ...
    public interface IItemsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2006> GetItemsAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse2006>> GetItemsWithHttpInfoAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 品目の更新
        /// </summary>
        /// <remarks>
    ...
    public partial class ItemsApi : IItemsApi
    {
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 50, 最小: 1, 最大: 3000) (optional)</param>
        /// <returns>InlineResponse2006</returns>
        public InlineResponse2006 GetItems (int companyId, int? offset = default(int?), int? limit = default(int?))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse2006> localVarResponse = GetItemsWithHttpInfo(companyId, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 50, 最小: 1, 最大: 3000) (optional)</param>
        /// <returns>ApiResponse of InlineResponse2006</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse2006 > GetItemsWithHttpInfo (int companyId, int? offset = default(int?), int? limit = default(int?))
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse2006 >("/api/1/items", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2006</returns>
        public async System.Threading.Tasks.Task<InlineResponse2006> GetItemsAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse2006> localVarResponse = await GetItemsWithHttpInfoAsync(companyId, offset, limit, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse2006)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse2006>> GetItemsWithHttpInfoAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse2006>("/api/1/items", localVarRequestOptions, this.Configuration, cancellationToken);
