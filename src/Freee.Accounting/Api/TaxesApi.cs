...
namespace Freee.Accounting.Api
{
    ...
    public interface ITaxesApiSync : IApiAccessor
    {
        ...
        InlineResponse20013 GetTaxCodes ();
        ...
        ApiResponse<InlineResponse20013> GetTaxCodesWithHttpInfo ();
        /// <summary>
        /// 税区分コード詳細一覧の取得
        /// </summary>
        /// <remarks>
        ...
        InlineResponse20014 GetTaxesCompanies (int companyId);
        ...
        ApiResponse<InlineResponse20014> GetTaxesCompaniesWithHttpInfo (int companyId);
    ...
    public interface ITaxesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse20013> GetTaxCodesAsync (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20013>> GetTaxCodesWithHttpInfoAsync (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 税区分コード詳細一覧の取得
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<InlineResponse20014> GetTaxesCompaniesAsync (int companyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20014>> GetTaxesCompaniesWithHttpInfoAsync (int companyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TaxesApi : ITaxesApi
    {
        ...
        /// <exception cref="Freee.Accounting.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>InlineResponse20013</returns>
        public InlineResponse20013 GetTaxCodes ()
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20013> localVarResponse = GetTaxCodesWithHttpInfo();
             return localVarResponse.Data;
        }
        ...
        /// <exception cref="Freee.Accounting.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of InlineResponse20013</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse20013 > GetTaxCodesWithHttpInfo ()
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse20013 >("/api/1/taxes/codes", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20013</returns>
        public async System.Threading.Tasks.Task<InlineResponse20013> GetTaxCodesAsync (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20013> localVarResponse = await GetTaxCodesWithHttpInfoAsync(cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20013)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse20013>> GetTaxCodesWithHttpInfoAsync (System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20013>("/api/1/taxes/codes", localVarRequestOptions, this.Configuration, cancellationToken);
        ...
        /// <param name="companyId">事業所ID</param>
        /// <returns>InlineResponse20014</returns>
        public InlineResponse20014 GetTaxesCompanies (int companyId)
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20014> localVarResponse = GetTaxesCompaniesWithHttpInfo(companyId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="companyId">事業所ID</param>
        /// <returns>ApiResponse of InlineResponse20014</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse20014 > GetTaxesCompaniesWithHttpInfo (int companyId)
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse20014 >("/api/1/taxes/companies/{company_id}", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20014</returns>
        public async System.Threading.Tasks.Task<InlineResponse20014> GetTaxesCompaniesAsync (int companyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20014> localVarResponse = await GetTaxesCompaniesWithHttpInfoAsync(companyId, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20014)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse20014>> GetTaxesCompaniesWithHttpInfoAsync (int companyId, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20014>("/api/1/taxes/companies/{company_id}", localVarRequestOptions, this.Configuration, cancellationToken);
