...
namespace Freee.Accounting.Api
{
    ...
    public interface IWalletTxnsApiSync : IApiAccessor
    {
        ...
        InlineResponse20018 GetWalletTxns (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?));
        ...
        ApiResponse<InlineResponse20018> GetWalletTxnsWithHttpInfo (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?));
    ...
    public interface IWalletTxnsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse20018> GetWalletTxnsAsync (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class WalletTxnsApi : IWalletTxnsApi
    {
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 100)  (optional)</param>
        /// <returns>InlineResponse20018</returns>
        public InlineResponse20018 GetWalletTxns (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20018> localVarResponse = GetWalletTxnsWithHttpInfo(companyId, walletableType, walletableId, startDate, endDate, entrySide, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 100)  (optional)</param>
        /// <returns>ApiResponse of InlineResponse20018</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse20018 > GetWalletTxnsWithHttpInfo (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?))
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse20018 >("/api/1/wallet_txns", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20018</returns>
        public async System.Threading.Tasks.Task<InlineResponse20018> GetWalletTxnsAsync (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20018> localVarResponse = await GetWalletTxnsWithHttpInfoAsync(companyId, walletableType, walletableId, startDate, endDate, entrySide, offset, limit, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20018)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse20018>> GetWalletTxnsWithHttpInfoAsync (int companyId, string walletableType = default(string), int? walletableId = default(int?), string startDate = default(string), string endDate = default(string), string entrySide = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20018>("/api/1/wallet_txns", localVarRequestOptions, this.Configuration, cancellationToken);
