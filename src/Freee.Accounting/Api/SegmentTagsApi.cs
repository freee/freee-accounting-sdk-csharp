...
namespace Freee.Accounting.Api
{
    ...
    public interface ISegmentTagsApiSync : IApiAccessor
    {
        ...
        InlineResponse20011 GetSegmentTags (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?));
        ...
        ApiResponse<InlineResponse20011> GetSegmentTagsWithHttpInfo (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?));
        /// <summary>
        /// セグメントタグの更新
        /// </summary>
        /// <remarks>
    ...
    public interface ISegmentTagsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse20011> GetSegmentTagsAsync (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20011>> GetSegmentTagsWithHttpInfoAsync (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// セグメントタグの更新
        /// </summary>
        /// <remarks>
    ...
    public partial class SegmentTagsApi : ISegmentTagsApi
    {
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 500)  (optional)</param>
        /// <returns>InlineResponse20011</returns>
        public InlineResponse20011 GetSegmentTags (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20011> localVarResponse = GetSegmentTagsWithHttpInfo(companyId, segmentId, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 500)  (optional)</param>
        /// <returns>ApiResponse of InlineResponse20011</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse20011 > GetSegmentTagsWithHttpInfo (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?))
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse20011 >("/api/1/segments/{segment_id}/tags", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20011</returns>
        public async System.Threading.Tasks.Task<InlineResponse20011> GetSegmentTagsAsync (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20011> localVarResponse = await GetSegmentTagsWithHttpInfoAsync(companyId, segmentId, offset, limit, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20011)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse20011>> GetSegmentTagsWithHttpInfoAsync (int companyId, int segmentId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20011>("/api/1/segments/{segment_id}/tags", localVarRequestOptions, this.Configuration, cancellationToken);
