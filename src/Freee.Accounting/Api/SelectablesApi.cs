...
namespace Freee.Accounting.Api
{
    ...
    public interface ISelectablesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<SelectablesIndexResponse> GetFormsSelectablesAsync (int companyId, string includes = default(string));
        ...
        System.Threading.Tasks.Task<ApiResponse<SelectablesIndexResponse>> GetFormsSelectablesAsyncWithHttpInfo (int companyId, string includes = default(string));
    ...
    public partial class SelectablesApi : ISelectablesApi
    {
        ...
        public Freee.Accounting.Client.ApiResponse< SelectablesIndexResponse > GetFormsSelectablesWithHttpInfo (int companyId, string includes = default(string))
        {
            ...
            if (includes != null)
            {
                foreach (var _kvp in Freee.Accounting.Client.ClientUtils.ParameterToMultiMap("", "includes", includes))
                {
                    foreach (var _kvpValue in _kvp.Value)
                    {
                        localVarRequestOptions.QueryParameters.Add(_kvp.Key, _kvpValue);
        ...
        /// <param name="includes">取得する項目(項目: account_item) (optional)</param>
        /// <returns>Task of SelectablesIndexResponse</returns>
        public async System.Threading.Tasks.Task<SelectablesIndexResponse> GetFormsSelectablesAsync (int companyId, string includes = default(string))
        {
             Freee.Accounting.Client.ApiResponse<SelectablesIndexResponse> localVarResponse = await GetFormsSelectablesAsyncWithHttpInfo(companyId, includes);
             return localVarResponse.Data;
        ...
        /// <param name="includes">取得する項目(項目: account_item) (optional)</param>
        /// <returns>Task of ApiResponse (SelectablesIndexResponse)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<SelectablesIndexResponse>> GetFormsSelectablesAsyncWithHttpInfo (int companyId, string includes = default(string))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<SelectablesIndexResponse>("/api/1/forms/selectables", localVarRequestOptions, this.Configuration);
