...
namespace Freee.Accounting.Api
{
    ...
    public interface ITransfersApiSync : IApiAccessor
    {
        ...
        InlineResponse20015 GetTransfers (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?));
        ...
        ApiResponse<InlineResponse20015> GetTransfersWithHttpInfo (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?));
        /// <summary>
        /// 取引（振替）の更新
        /// </summary>
        /// <remarks>
    ...
    public interface ITransfersApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse20015> GetTransfersAsync (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20015>> GetTransfersWithHttpInfoAsync (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 取引（振替）の更新
        /// </summary>
        /// <remarks>
    ...
    public partial class TransfersApi : ITransfersApi
    {
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 100)  (optional)</param>
        /// <returns>InlineResponse20015</returns>
        public InlineResponse20015 GetTransfers (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20015> localVarResponse = GetTransfersWithHttpInfo(companyId, startDate, endDate, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最小: 1, 最大: 100)  (optional)</param>
        /// <returns>ApiResponse of InlineResponse20015</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse20015 > GetTransfersWithHttpInfo (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?))
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse20015 >("/api/1/transfers", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20015</returns>
        public async System.Threading.Tasks.Task<InlineResponse20015> GetTransfersAsync (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20015> localVarResponse = await GetTransfersWithHttpInfoAsync(companyId, startDate, endDate, offset, limit, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20015)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse20015>> GetTransfersWithHttpInfoAsync (int companyId, string startDate = default(string), string endDate = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20015>("/api/1/transfers", localVarRequestOptions, this.Configuration, cancellationToken);
