...
namespace Freee.Accounting.Api
{
    ...
    public interface IQuotationsApiSync : IApiAccessor
    {
        ...
        InlineResponse2008 GetQuotations (int companyId, int? partnerId = default(int?), string partnerCode = default(string), string startIssueDate = default(string), string endIssueDate = default(string), string quotationNumber = default(string), string description = default(string), string quotationStatus = default(string), int? offset = default(int?), int? limit = default(int?));
    ...
    public interface IQuotationsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse2008> GetQuotationsAsync (int companyId, int? partnerId = default(int?), string partnerCode = default(string), string startIssueDate = default(string), string endIssueDate = default(string), string quotationNumber = default(string), string description = default(string), string quotationStatus = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class QuotationsApi : IQuotationsApi
    {
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 20, 最大: 100)  (optional)</param>
        /// <returns>InlineResponse2008</returns>
        public InlineResponse2008 GetQuotations (int companyId, int? partnerId = default(int?), string partnerCode = default(string), string startIssueDate = default(string), string endIssueDate = default(string), string quotationNumber = default(string), string description = default(string), string quotationStatus = default(string), int? offset = default(int?), int? limit = default(int?))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse2008> localVarResponse = GetQuotationsWithHttpInfo(companyId, partnerId, partnerCode, startIssueDate, endIssueDate, quotationNumber, description, quotationStatus, offset, limit);
             return localVarResponse.Data;
        }
        ...
        public Freee.Accounting.Client.ApiResponse< InlineResponse2008 > GetQuotationsWithHttpInfo (int companyId, int? partnerId = default(int?), string partnerCode = default(string), string startIssueDate = default(string), string endIssueDate = default(string), string quotationNumber = default(string), string description = default(string), string quotationStatus = default(string), int? offset = default(int?), int? limit = default(int?))
        {
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse2008 >("/api/1/quotations", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse2008</returns>
        public async System.Threading.Tasks.Task<InlineResponse2008> GetQuotationsAsync (int companyId, int? partnerId = default(int?), string partnerCode = default(string), string startIssueDate = default(string), string endIssueDate = default(string), string quotationNumber = default(string), string description = default(string), string quotationStatus = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse2008> localVarResponse = await GetQuotationsWithHttpInfoAsync(companyId, partnerId, partnerCode, startIssueDate, endIssueDate, quotationNumber, description, quotationStatus, offset, limit, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse2008>> GetQuotationsWithHttpInfoAsync (int companyId, int? partnerId = default(int?), string partnerCode = default(string), string startIssueDate = default(string), string endIssueDate = default(string), string quotationNumber = default(string), string description = default(string), string quotationStatus = default(string), int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse2008>("/api/1/quotations", localVarRequestOptions, this.Configuration, cancellationToken);
