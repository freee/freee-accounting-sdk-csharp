...
namespace Freee.Accounting.Api
{
    ...
    public interface ITagsApiSync : IApiAccessor
    {
        ...
        InlineResponse20012 GetTags (int companyId, int? offset = default(int?), int? limit = default(int?));
        ...
        ApiResponse<InlineResponse20012> GetTagsWithHttpInfo (int companyId, int? offset = default(int?), int? limit = default(int?));
        /// <summary>
        /// メモタグの更新
        /// </summary>
        /// <remarks>
    ...
    public interface ITagsApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<InlineResponse20012> GetTagsAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<InlineResponse20012>> GetTagsWithHttpInfoAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// メモタグの更新
        /// </summary>
        /// <remarks>
    ...
    public partial class TagsApi : ITagsApi
    {
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 50, 最小: 1, 最大: 3000) (optional)</param>
        /// <returns>InlineResponse20012</returns>
        public InlineResponse20012 GetTags (int companyId, int? offset = default(int?), int? limit = default(int?))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20012> localVarResponse = GetTagsWithHttpInfo(companyId, offset, limit);
             return localVarResponse.Data;
        }
        ...
        /// <param name="limit">取得レコードの件数 (デフォルト: 50, 最小: 1, 最大: 3000) (optional)</param>
        /// <returns>ApiResponse of InlineResponse20012</returns>
        public Freee.Accounting.Client.ApiResponse< InlineResponse20012 > GetTagsWithHttpInfo (int companyId, int? offset = default(int?), int? limit = default(int?))
        {
            Freee.Accounting.Client.RequestOptions localVarRequestOptions = new Freee.Accounting.Client.RequestOptions();
            ...
            // make the HTTP request
            var localVarResponse = this.Client.Get< InlineResponse20012 >("/api/1/tags", localVarRequestOptions, this.Configuration);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of InlineResponse20012</returns>
        public async System.Threading.Tasks.Task<InlineResponse20012> GetTagsAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
             Freee.Accounting.Client.ApiResponse<InlineResponse20012> localVarResponse = await GetTagsWithHttpInfoAsync(companyId, offset, limit, cancellationToken);
             return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (InlineResponse20012)</returns>
        public async System.Threading.Tasks.Task<Freee.Accounting.Client.ApiResponse<InlineResponse20012>> GetTagsWithHttpInfoAsync (int companyId, int? offset = default(int?), int? limit = default(int?), System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            var localVarResponse = await this.AsynchronousClient.GetAsync<InlineResponse20012>("/api/1/tags", localVarRequestOptions, this.Configuration, cancellationToken);
