...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSectionsResponse_trial_cr_sections_balances")]
    public partial class TrialCrSectionsResponseTrialCrSectionsBalances : IEquatable<TrialCrSectionsResponseTrialCrSectionsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSectionsResponseTrialCrSectionsBalances" /> class.
        /// </summary>
        ...
        public TrialCrSectionsResponseTrialCrSectionsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), string parentAccountCategoryName = default(string), List<TrialCrSectionsResponseTrialCrSectionsSections> sections = default(List<TrialCrSectionsResponseTrialCrSectionsSections>), bool totalLine = default(bool))
        {
        ...
        public List<TrialCrSectionsResponseTrialCrSectionsSections> Sections { get; set; }
        ...
        {
            return this.Equals(input as TrialCrSectionsResponseTrialCrSectionsBalances);
        }

        /// <summary>
        /// Returns true if TrialCrSectionsResponseTrialCrSectionsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSectionsResponseTrialCrSectionsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSectionsResponseTrialCrSectionsBalances input)
        {
            if (input == null)
            {
                return false;
