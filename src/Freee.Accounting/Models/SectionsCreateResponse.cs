...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SectionsCreateResponse :  IEquatable<SectionsCreateResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionsCreateResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SectionsCreateResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionsCreateResponse" /> class.
        /// </summary>
        ...
        public SectionsCreateResponseSection Section { get; set; }
        ...
        {
            return this.Equals(input as SectionsCreateResponse);
        }

        /// <summary>
        /// Returns true if SectionsCreateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SectionsCreateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SectionsCreateResponse input)
        {
            if (input == null)
                return false;
