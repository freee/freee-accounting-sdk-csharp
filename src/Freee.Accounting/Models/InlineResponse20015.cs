...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>
    {
        ...
        public InlineResponse20015(List<User> users = default(List<User>))
        {
            // to ensure "users" is required (not null)
            this.Users = users ?? throw new ArgumentNullException("users is a required property for InlineResponse20015 and cannot be null");
        }
