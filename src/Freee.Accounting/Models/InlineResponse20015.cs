...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20015 :  IEquatable<InlineResponse20015>
    {
        ...
        public InlineResponse20015(List<Transfer> transfers = default(List<Transfer>))
        {
            // to ensure "transfers" is required (not null)
            this.Transfers = transfers ?? throw new ArgumentNullException("transfers is a required property for InlineResponse20015 and cannot be null");
        }
