...
namespace Freee.Accounting.Models
{
    ...
    public partial class RenewsCreateDetailParams
    {
        /// <summary>
        /// Initializes a new instance of the RenewsCreateDetailParams class.
        /// </summary>
        ...
        public RenewsCreateDetailParams(int accountItemId, int taxCode, int amount, int? vat = default(int?), int? itemId = default(int?), int? sectionId = default(int?), IList<int?> tagIds = default(IList<int?>), int? segment1TagId = default(int?), int? segment2TagId = default(int?), int? segment3TagId = default(int?), string description = default(string))
        {
