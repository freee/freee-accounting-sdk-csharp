...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RenewsCreateDetailParams :  IEquatable<RenewsCreateDetailParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewsCreateDetailParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RenewsCreateDetailParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewsCreateDetailParams" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RenewsCreateDetailParams);
        }

        /// <summary>
        /// Returns true if RenewsCreateDetailParams instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewsCreateDetailParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewsCreateDetailParams input)
        {
            if (input == null)
                return false;
