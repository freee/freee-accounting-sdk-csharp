...
namespace Freee.Accounting.Models
{
    ...
    public partial class UserCapability :  IEquatable<UserCapability>
    {
        ...
        public UserCapability(bool create = default(bool), bool destroy = default(bool), bool read = default(bool), bool update = default(bool))
        {
            this.Create = create;
        ...
        {
            return this.Equals(input as UserCapability);
        }

        /// <summary>
        /// Returns true if UserCapability instances are equal
        /// </summary>
        /// <param name="input">Instance of UserCapability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserCapability input)
        {
            if (input == null)
                return false;
