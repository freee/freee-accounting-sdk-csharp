...
namespace Freee.Accounting.Models
{
    ...
    public partial class JournalsResponseJournals : IEquatable<JournalsResponseJournals>
    {
        ...
        public JournalsResponseJournals(int companyId = default(int), DownloadTypeEnum? downloadType = default(DownloadTypeEnum?), string endDate = default(string), int id = default(int), List<string> messages = default(List<string>), string startDate = default(string), string statusUrl = default(string), List<VisibleTagsEnum> visibleTags = default(List<VisibleTagsEnum>))
        {
