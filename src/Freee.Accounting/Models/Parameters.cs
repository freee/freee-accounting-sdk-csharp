...
namespace Freee.Accounting.Models
{
    ...
    public partial class Parameters
    {
        ...
        /// <param name="name">メモタグ名 (30文字以内)</param>
        /// <param name="shortcut1">ショートカット１ (20文字以内)</param>
        /// <param name="shortcut2">ショートカット２ (20文字以内)</param>
        public Parameters(int companyId, string name, string shortcut1 = default(string), string shortcut2 = default(string))
        {
            CompanyId = companyId;
            Name = name;
            Shortcut1 = shortcut1;
