...
namespace Freee.Accounting.Models
{
    ...
    public partial class RenewCreateParams : IEquatable<RenewCreateParams>
    {
        ...
        public RenewCreateParams(int companyId = default(int), List<RenewCreateParamsDetails> details = default(List<RenewCreateParamsDetails>), int renewTargetId = default(int), string updateDate = default(string))
        {
            ...
            this.Details = details ?? throw new ArgumentNullException("details is a required property for RenewCreateParams and cannot be null");
            this.RenewTargetId = renewTargetId;
            // to ensure "updateDate" is required (not null)
            this.UpdateDate = updateDate ?? throw new ArgumentNullException("updateDate is a required property for RenewCreateParams and cannot be null");
        }
