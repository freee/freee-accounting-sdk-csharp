...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20017 :  IEquatable<InlineResponse20017>
    {
        ...
        public InlineResponse20017(UserCapability tags = default(UserCapability), UserCapability accountItemStatements = default(UserCapability), UserCapability accountItems = default(UserCapability), UserCapability annualReports = default(UserCapability), UserCapability approvalFlowRoutes = default(UserCapability), UserCapability approvalRequests = default(UserCapability), UserCapability backups = default(UserCapability), UserCapability bankAccountantStaffUsers = default(UserCapability), UserCapability bizAllocations = default(UserCapability), UserCapability companies = default(UserCapability), UserCapability consumptionEntries = default(UserCapability), UserCapability costAllocations = default(UserCapability), UserCapability dealTemplates = default(UserCapability), UserCapability deals = default(UserCapability), UserCapability docPostings = default(UserCapability), UserCapability docs = default(UserCapability), UserCapability expenseApplicationTemplates = default(UserCapability), UserCapability expenseApplications = default(UserCapability), UserCapability fixedAssets = default(UserCapability), UserCapability inventoryRefreshes = default(UserCapability), UserCapability invitations = default(UserCapability), UserCapability items = default(UserCapability), UserCapability manualJournalTemplates = default(UserCapability), UserCapability manualJournals = default(UserCapability), UserCapability monthEnd = default(UserCapability), UserCapability oauthApplications = default(UserCapability), UserCapability oauthAuthorizations = default(UserCapability), UserCapability openingBalances = default(UserCapability), UserCapability partners = default(UserCapability), UserCapability paymentRecords = default(UserCapability), UserCapability paymentRequests = default(UserCapability), UserCapability receiptStreamEditor = default(UserCapability), UserCapability receipts = default(UserCapability), UserCapability reports = default(UserCapability), UserCapability reportsBs = default(UserCapability), UserCapability reportsCashBalance = default(UserCapability), UserCapability reportsCrosstabs = default(UserCapability), UserCapability reportsGeneralLedgers = default(UserCapability), UserCapability reportsIncomeExpense = default(UserCapability), UserCapability reportsJournals = default(UserCapability), UserCapability reportsManagementsNavigation = default(UserCapability), UserCapability reportsManagementsPlanning = default(UserCapability), UserCapability reportsPayables = default(UserCapability), UserCapability reportsPl = default(UserCapability), UserCapability reportsReceivables = default(UserCapability), UserCapability requestForms = default(UserCapability), UserCapability resets = default(UserCapability), UserCapability sections = default(UserCapability), UserCapability signInLogs = default(UserCapability), UserCapability spreadsheets = default(UserCapability), UserCapability systemConversion = default(UserCapability), UserCapability taxReports = default(UserCapability), UserCapability taxReturn = default(UserCapability), UserCapability taxes = default(UserCapability), UserCapability transfers = default(UserCapability), UserCapability userMatchers = default(UserCapability), UserCapability walletTxns = default(UserCapability), UserCapability walletables = default(UserCapability), UserCapability workflows = default(UserCapability), UserCapability yearEnd = default(UserCapability))
        {
            // to ensure "tags" is required (not null)
            this.Tags = tags ?? throw new ArgumentNullException("tags is a required property for InlineResponse20017 and cannot be null");
            // to ensure "accountItemStatements" is required (not null)
            this.AccountItemStatements = accountItemStatements ?? throw new ArgumentNullException("accountItemStatements is a required property for InlineResponse20017 and cannot be null");
            // to ensure "accountItems" is required (not null)
            this.AccountItems = accountItems ?? throw new ArgumentNullException("accountItems is a required property for InlineResponse20017 and cannot be null");
            // to ensure "annualReports" is required (not null)
            this.AnnualReports = annualReports ?? throw new ArgumentNullException("annualReports is a required property for InlineResponse20017 and cannot be null");
            // to ensure "approvalFlowRoutes" is required (not null)
            this.ApprovalFlowRoutes = approvalFlowRoutes ?? throw new ArgumentNullException("approvalFlowRoutes is a required property for InlineResponse20017 and cannot be null");
            // to ensure "approvalRequests" is required (not null)
            this.ApprovalRequests = approvalRequests ?? throw new ArgumentNullException("approvalRequests is a required property for InlineResponse20017 and cannot be null");
            // to ensure "backups" is required (not null)
            this.Backups = backups ?? throw new ArgumentNullException("backups is a required property for InlineResponse20017 and cannot be null");
            // to ensure "bankAccountantStaffUsers" is required (not null)
            this.BankAccountantStaffUsers = bankAccountantStaffUsers ?? throw new ArgumentNullException("bankAccountantStaffUsers is a required property for InlineResponse20017 and cannot be null");
            // to ensure "bizAllocations" is required (not null)
            this.BizAllocations = bizAllocations ?? throw new ArgumentNullException("bizAllocations is a required property for InlineResponse20017 and cannot be null");
            // to ensure "companies" is required (not null)
            this.Companies = companies ?? throw new ArgumentNullException("companies is a required property for InlineResponse20017 and cannot be null");
            // to ensure "consumptionEntries" is required (not null)
            this.ConsumptionEntries = consumptionEntries ?? throw new ArgumentNullException("consumptionEntries is a required property for InlineResponse20017 and cannot be null");
            // to ensure "costAllocations" is required (not null)
            this.CostAllocations = costAllocations ?? throw new ArgumentNullException("costAllocations is a required property for InlineResponse20017 and cannot be null");
            // to ensure "dealTemplates" is required (not null)
            this.DealTemplates = dealTemplates ?? throw new ArgumentNullException("dealTemplates is a required property for InlineResponse20017 and cannot be null");
            // to ensure "deals" is required (not null)
            this.Deals = deals ?? throw new ArgumentNullException("deals is a required property for InlineResponse20017 and cannot be null");
            // to ensure "docPostings" is required (not null)
            this.DocPostings = docPostings ?? throw new ArgumentNullException("docPostings is a required property for InlineResponse20017 and cannot be null");
            // to ensure "docs" is required (not null)
            this.Docs = docs ?? throw new ArgumentNullException("docs is a required property for InlineResponse20017 and cannot be null");
            // to ensure "expenseApplicationTemplates" is required (not null)
            this.ExpenseApplicationTemplates = expenseApplicationTemplates ?? throw new ArgumentNullException("expenseApplicationTemplates is a required property for InlineResponse20017 and cannot be null");
            // to ensure "expenseApplications" is required (not null)
            this.ExpenseApplications = expenseApplications ?? throw new ArgumentNullException("expenseApplications is a required property for InlineResponse20017 and cannot be null");
            // to ensure "fixedAssets" is required (not null)
            this.FixedAssets = fixedAssets ?? throw new ArgumentNullException("fixedAssets is a required property for InlineResponse20017 and cannot be null");
            // to ensure "inventoryRefreshes" is required (not null)
            this.InventoryRefreshes = inventoryRefreshes ?? throw new ArgumentNullException("inventoryRefreshes is a required property for InlineResponse20017 and cannot be null");
            // to ensure "invitations" is required (not null)
            this.Invitations = invitations ?? throw new ArgumentNullException("invitations is a required property for InlineResponse20017 and cannot be null");
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for InlineResponse20017 and cannot be null");
            // to ensure "manualJournalTemplates" is required (not null)
            this.ManualJournalTemplates = manualJournalTemplates ?? throw new ArgumentNullException("manualJournalTemplates is a required property for InlineResponse20017 and cannot be null");
            // to ensure "manualJournals" is required (not null)
            this.ManualJournals = manualJournals ?? throw new ArgumentNullException("manualJournals is a required property for InlineResponse20017 and cannot be null");
            // to ensure "monthEnd" is required (not null)
            this.MonthEnd = monthEnd ?? throw new ArgumentNullException("monthEnd is a required property for InlineResponse20017 and cannot be null");
            // to ensure "oauthApplications" is required (not null)
            this.OauthApplications = oauthApplications ?? throw new ArgumentNullException("oauthApplications is a required property for InlineResponse20017 and cannot be null");
            // to ensure "oauthAuthorizations" is required (not null)
            this.OauthAuthorizations = oauthAuthorizations ?? throw new ArgumentNullException("oauthAuthorizations is a required property for InlineResponse20017 and cannot be null");
            // to ensure "openingBalances" is required (not null)
            this.OpeningBalances = openingBalances ?? throw new ArgumentNullException("openingBalances is a required property for InlineResponse20017 and cannot be null");
            // to ensure "partners" is required (not null)
            this.Partners = partners ?? throw new ArgumentNullException("partners is a required property for InlineResponse20017 and cannot be null");
            // to ensure "paymentRecords" is required (not null)
            this.PaymentRecords = paymentRecords ?? throw new ArgumentNullException("paymentRecords is a required property for InlineResponse20017 and cannot be null");
            // to ensure "paymentRequests" is required (not null)
            this.PaymentRequests = paymentRequests ?? throw new ArgumentNullException("paymentRequests is a required property for InlineResponse20017 and cannot be null");
            // to ensure "receiptStreamEditor" is required (not null)
            this.ReceiptStreamEditor = receiptStreamEditor ?? throw new ArgumentNullException("receiptStreamEditor is a required property for InlineResponse20017 and cannot be null");
            // to ensure "receipts" is required (not null)
            this.Receipts = receipts ?? throw new ArgumentNullException("receipts is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reports" is required (not null)
            this.Reports = reports ?? throw new ArgumentNullException("reports is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsBs" is required (not null)
            this.ReportsBs = reportsBs ?? throw new ArgumentNullException("reportsBs is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsCashBalance" is required (not null)
            this.ReportsCashBalance = reportsCashBalance ?? throw new ArgumentNullException("reportsCashBalance is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsCrosstabs" is required (not null)
            this.ReportsCrosstabs = reportsCrosstabs ?? throw new ArgumentNullException("reportsCrosstabs is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsGeneralLedgers" is required (not null)
            this.ReportsGeneralLedgers = reportsGeneralLedgers ?? throw new ArgumentNullException("reportsGeneralLedgers is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsIncomeExpense" is required (not null)
            this.ReportsIncomeExpense = reportsIncomeExpense ?? throw new ArgumentNullException("reportsIncomeExpense is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsJournals" is required (not null)
            this.ReportsJournals = reportsJournals ?? throw new ArgumentNullException("reportsJournals is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsManagementsNavigation" is required (not null)
            this.ReportsManagementsNavigation = reportsManagementsNavigation ?? throw new ArgumentNullException("reportsManagementsNavigation is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsManagementsPlanning" is required (not null)
            this.ReportsManagementsPlanning = reportsManagementsPlanning ?? throw new ArgumentNullException("reportsManagementsPlanning is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsPayables" is required (not null)
            this.ReportsPayables = reportsPayables ?? throw new ArgumentNullException("reportsPayables is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsPl" is required (not null)
            this.ReportsPl = reportsPl ?? throw new ArgumentNullException("reportsPl is a required property for InlineResponse20017 and cannot be null");
            // to ensure "reportsReceivables" is required (not null)
            this.ReportsReceivables = reportsReceivables ?? throw new ArgumentNullException("reportsReceivables is a required property for InlineResponse20017 and cannot be null");
            // to ensure "requestForms" is required (not null)
            this.RequestForms = requestForms ?? throw new ArgumentNullException("requestForms is a required property for InlineResponse20017 and cannot be null");
            // to ensure "resets" is required (not null)
            this.Resets = resets ?? throw new ArgumentNullException("resets is a required property for InlineResponse20017 and cannot be null");
            // to ensure "sections" is required (not null)
            this.Sections = sections ?? throw new ArgumentNullException("sections is a required property for InlineResponse20017 and cannot be null");
            // to ensure "signInLogs" is required (not null)
            this.SignInLogs = signInLogs ?? throw new ArgumentNullException("signInLogs is a required property for InlineResponse20017 and cannot be null");
            // to ensure "spreadsheets" is required (not null)
            this.Spreadsheets = spreadsheets ?? throw new ArgumentNullException("spreadsheets is a required property for InlineResponse20017 and cannot be null");
            // to ensure "systemConversion" is required (not null)
            this.SystemConversion = systemConversion ?? throw new ArgumentNullException("systemConversion is a required property for InlineResponse20017 and cannot be null");
            // to ensure "taxReports" is required (not null)
            this.TaxReports = taxReports ?? throw new ArgumentNullException("taxReports is a required property for InlineResponse20017 and cannot be null");
            // to ensure "taxReturn" is required (not null)
            this.TaxReturn = taxReturn ?? throw new ArgumentNullException("taxReturn is a required property for InlineResponse20017 and cannot be null");
            // to ensure "taxes" is required (not null)
            this.Taxes = taxes ?? throw new ArgumentNullException("taxes is a required property for InlineResponse20017 and cannot be null");
            // to ensure "transfers" is required (not null)
            this.Transfers = transfers ?? throw new ArgumentNullException("transfers is a required property for InlineResponse20017 and cannot be null");
            // to ensure "userMatchers" is required (not null)
            this.UserMatchers = userMatchers ?? throw new ArgumentNullException("userMatchers is a required property for InlineResponse20017 and cannot be null");
            // to ensure "walletTxns" is required (not null)
            this.WalletTxns = walletTxns ?? throw new ArgumentNullException("walletTxns is a required property for InlineResponse20017 and cannot be null");
            // to ensure "walletables" is required (not null)
            this.Walletables = walletables ?? throw new ArgumentNullException("walletables is a required property for InlineResponse20017 and cannot be null");
            // to ensure "workflows" is required (not null)
            this.Workflows = workflows ?? throw new ArgumentNullException("workflows is a required property for InlineResponse20017 and cannot be null");
            // to ensure "yearEnd" is required (not null)
            this.YearEnd = yearEnd ?? throw new ArgumentNullException("yearEnd is a required property for InlineResponse20017 and cannot be null");
        }
