...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsThreeYearsResponse_trial_bs_three_years_partners")]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsPartners : IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>
    {
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsPartners(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
