...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsPartners :  IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsPartners" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsThreeYearsResponseTrialBsThreeYearsPartners() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsPartners" /> class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsPartners(int id = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialBsThreeYearsResponseTrialBsThreeYearsPartners);
        }

        /// <summary>
        /// Returns true if TrialBsThreeYearsResponseTrialBsThreeYearsPartners instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsThreeYearsResponseTrialBsThreeYearsPartners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsThreeYearsResponseTrialBsThreeYearsPartners input)
        {
            if (input == null)
                return false;
