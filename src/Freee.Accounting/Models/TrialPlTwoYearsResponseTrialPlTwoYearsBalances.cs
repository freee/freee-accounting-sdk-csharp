...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsBalances :  IEquatable<TrialPlTwoYearsResponseTrialPlTwoYearsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlTwoYearsResponseTrialPlTwoYearsBalances" /> class.
        /// </summary>
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalances(int accountItemId = default(int), string accountItemName = default(string), List<TrialBsTwoYearsResponseTrialBsTwoYearsPartners> partners = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsPartners>), List<TrialBsTwoYearsResponseTrialBsTwoYearsItems> items = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsItems>), List<TrialPlTwoYearsResponseTrialPlTwoYearsSections> sections = default(List<TrialPlTwoYearsResponseTrialPlTwoYearsSections>), int accountCategoryId = default(int), string accountCategoryName = default(string), bool totalLine = default(bool), int hierarchyLevel = default(int), int parentAccountCategoryId = default(int), string parentAccountCategoryName = default(string), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
        ...
        public List<TrialPlTwoYearsResponseTrialPlTwoYearsSections> Sections { get; set; }
        ...
        {
            return this.Equals(input as TrialPlTwoYearsResponseTrialPlTwoYearsBalances);
        }

        /// <summary>
        /// Returns true if TrialPlTwoYearsResponseTrialPlTwoYearsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlTwoYearsResponseTrialPlTwoYearsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlTwoYearsResponseTrialPlTwoYearsBalances input)
        {
            if (input == null)
                return false;
