...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlTwoYearsResponse_trial_pl_two_years_balances")]
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsBalances : IEquatable<TrialPlTwoYearsResponseTrialPlTwoYearsBalances>
    {
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), List<TrialBsTwoYearsResponseTrialBsTwoYearsItems> items = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsItems>), int lastYearClosingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialBsTwoYearsResponseTrialBsTwoYearsPartners> partners = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsPartners>), List<TrialPlTwoYearsResponseTrialPlTwoYearsSections> sections = default(List<TrialPlTwoYearsResponseTrialPlTwoYearsSections>), List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags> segment1Tags = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags>), List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags> segment2Tags = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags>), List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment3Tags> segment3Tags = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment3Tags>), bool totalLine = default(bool), decimal yearOnYear = default(decimal))
        {
        ...
        public List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags> Segment1Tags { get; set; }
        ...
        public List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment2Tags> Segment2Tags { get; set; }
        ...
        public List<TrialBsTwoYearsResponseTrialBsTwoYearsSegment3Tags> Segment3Tags { get; set; }
