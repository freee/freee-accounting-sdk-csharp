...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "partnersResponse_address_attributes")]
    public partial class PartnersResponseAddressAttributes : IEquatable<PartnersResponseAddressAttributes>
    {
        ...
        public PartnersResponseAddressAttributes(int prefectureCode = default(int), string streetName1 = default(string), string streetName2 = default(string), string zipcode = default(string))
        {
        ...
        {
            return this.Equals(input as PartnersResponseAddressAttributes);
        }

        /// <summary>
        /// Returns true if PartnersResponseAddressAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnersResponseAddressAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnersResponseAddressAttributes input)
        {
            if (input == null)
                return false;
