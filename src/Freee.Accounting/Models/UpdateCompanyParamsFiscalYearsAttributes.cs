...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCompanyParamsFiscalYearsAttributes :  IEquatable<UpdateCompanyParamsFiscalYearsAttributes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCompanyParamsFiscalYearsAttributes" /> class.
        /// </summary>
        /// <param name="useIndustryTemplate">製造業向け機能（0: 使用しない、1: 使用する）.</param>
        /// <param name="indirectWriteOffMethod">固定資産の控除法（0: 直接控除法、1: 間接控除法）.</param>
        /// <param name="indirectWriteOffMethodType">間接控除時の累計額（0: 共通、1: 資産分類別）.</param>
        ...
        /// <param name="returnCode">不動産所得使用区分(個人事業主のみ)（0: 使用しない、3: 使用する）.</param>
        ...
        /// </summary>
        /// <value>製造業向け機能（0: 使用しない、1: 使用する）</value>
        ...
        /// </summary>
        /// <value>固定資産の控除法（0: 直接控除法、1: 間接控除法）</value>
        ...
        /// </summary>
        /// <value>間接控除時の累計額（0: 共通、1: 資産分類別）</value>
        ...
        /// </summary>
        /// <value>不動産所得使用区分(個人事業主のみ)（0: 使用しない、3: 使用する）</value>
        ...
        {
            return this.Equals(input as UpdateCompanyParamsFiscalYearsAttributes);
        }

        /// <summary>
        /// Returns true if UpdateCompanyParamsFiscalYearsAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCompanyParamsFiscalYearsAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCompanyParamsFiscalYearsAttributes input)
        {
            if (input == null)
                return false;
