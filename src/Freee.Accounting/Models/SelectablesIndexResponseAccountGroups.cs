...
namespace Freee.Accounting.Models
{
    ...
    public partial class SelectablesIndexResponseAccountGroups :  IEquatable<SelectablesIndexResponseAccountGroups>
    {
        ...
        public SelectablesIndexResponseAccountGroups(int id = default(int), string name = default(string), int accountStructureId = default(int), int accountCategoryId = default(int), int detailType = default(int), int index = default(int), string createdAt = default(string), string updatedAt = default(string))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SelectablesIndexResponseAccountGroups and cannot be null");;
