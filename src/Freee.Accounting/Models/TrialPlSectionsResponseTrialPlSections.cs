...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlSectionsResponseTrialPlSections :  IEquatable<TrialPlSectionsResponseTrialPlSections>
    {
        ...
        protected TrialPlSectionsResponseTrialPlSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSectionsResponseTrialPlSections" /> class.
        /// </summary>
        /// <param name="companyId">事業所ID (required).</param>
        /// <param name="upToDate">集計結果が最新かどうか (required).</param>
        /// <param name="sectionIds">出力する部門の指定 (required).</param>
        ...
        public TrialPlSectionsResponseTrialPlSections(int companyId = default(int), bool upToDate = default(bool), string sectionIds = default(string), int fiscalYear = default(int), int startMonth = default(int), int endMonth = default(int), string startDate = default(string), string endDate = default(string), AccountItemDisplayTypeEnum? accountItemDisplayType = default(AccountItemDisplayTypeEnum?), BreakdownDisplayTypeEnum? breakdownDisplayType = default(BreakdownDisplayTypeEnum?), int partnerId = default(int), string partnerCode = default(string), int itemId = default(int), AdjustmentEnum? adjustment = default(AdjustmentEnum?), CostAllocationEnum? costAllocation = default(CostAllocationEnum?), string createdAt = default(string), List<TrialPlSectionsResponseTrialPlSectionsBalances> balances = default(List<TrialPlSectionsResponseTrialPlSectionsBalances>))
        {
            this.CompanyId = companyId;
            this.UpToDate = upToDate;
            // to ensure "sectionIds" is required (not null)
            this.SectionIds = sectionIds ?? throw new ArgumentNullException("sectionIds is a required property for TrialPlSectionsResponseTrialPlSections and cannot be null");;
            // to ensure "balances" is required (not null)
            this.Balances = balances ?? throw new ArgumentNullException("balances is a required property for TrialPlSectionsResponseTrialPlSections and cannot be null");;
        ...
        {
            return this.Equals(input as TrialPlSectionsResponseTrialPlSections);
        }

        /// <summary>
        /// Returns true if TrialPlSectionsResponseTrialPlSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlSectionsResponseTrialPlSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlSectionsResponseTrialPlSections input)
        {
            if (input == null)
                return false;
