...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlSectionsResponseTrialPlSections
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlSectionsResponseTrialPlSections class.
        /// </summary>
        ...
        /// <param name="sectionIds">出力する部門の指定</param>
        /// <param
        ...
        /// 勘定科目: account_item）(条件に指定した時のみ含まれる）. Possible values include:
        /// 'partner', 'item', 'account_item'</param>
        ...
        public TrialPlSectionsResponseTrialPlSections(int companyId, string sectionIds, IList<TrialPlSectionsResponseTrialPlSectionsBalancesItem> balances, int? fiscalYear = default(int?), int? startMonth = default(int?), int? endMonth = default(int?), string startDate = default(string), string endDate = default(string), string accountItemDisplayType = default(string), string breakdownDisplayType = default(string), int? partnerId = default(int?), string partnerCode = default(string), int? itemId = default(int?), string adjustment = default(string), string costAllocation = default(string), string createdAt = default(string))
        {
            CompanyId = companyId;
        ...
        /// <summary>
        /// Gets or sets 出力する部門の指定
        /// </summary>
        [JsonProperty(PropertyName = "section_ids")]
        ...
        /// <summary>
        /// Gets or sets 内訳の表示（取引先: partner, 品目: item, 勘定科目:
        ...
        public IList<TrialPlSectionsResponseTrialPlSectionsBalancesItem> Balances { get; set; }
