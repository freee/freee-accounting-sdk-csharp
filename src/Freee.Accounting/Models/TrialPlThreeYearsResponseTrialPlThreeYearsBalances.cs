...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlThreeYearsResponseTrialPlThreeYearsBalances :  IEquatable<TrialPlThreeYearsResponseTrialPlThreeYearsBalances>
    {
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalances(int accountItemId = default(int), string accountItemName = default(string), List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners> partners = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>), List<TrialBsThreeYearsResponseTrialBsThreeYearsItems> items = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsItems>), List<TrialPlThreeYearsResponseTrialPlThreeYearsSections> sections = default(List<TrialPlThreeYearsResponseTrialPlThreeYearsSections>), int accountCategoryId = default(int), string accountCategoryName = default(string), bool totalLine = default(bool), int hierarchyLevel = default(int), int parentAccountCategoryId = default(int), string parentAccountCategoryName = default(string), int twoYearsBeforeClosingBalance = default(int), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
