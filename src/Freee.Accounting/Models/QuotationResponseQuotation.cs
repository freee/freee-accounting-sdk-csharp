...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "quotationResponse_quotation")]
    public partial class QuotationResponseQuotation : IEquatable<QuotationResponseQuotation>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotationResponseQuotation" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected QuotationResponseQuotation() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="QuotationResponseQuotation" /> class.
        /// </summary>
        ...
        /// <param name="relatedInvoiceId">関連する請求書ID&lt;br&gt; 下記で作成したものが該当します。  &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/203318410#1-2\&quot; target&#x3D;\&quot;_blank\&quot;&gt;見積書・納品書を納品書・請求書に変換する&lt;/a&gt;&lt;br&gt; &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/209076226\&quot; target&#x3D;\&quot;_blank\&quot;&gt;複数の見積書・納品書から合算請求書を作成する&lt;/a&gt;&lt;br&gt; .</param>
        ...
        public QuotationResponseQuotation(string companyAddress1 = default(string), string companyAddress2 = default(string), string companyContactInfo = default(string), int companyId = default(int), string companyName = default(string), int? companyPrefectureCode = default(int?), string companyPrefectureName = default(string), string companyZipcode = default(string), string description = default(string), int id = default(int), string issueDate = default(string), string mailSentAt = default(string), string message = default(string), string notes = default(string), string partnerAddress1 = default(string), string partnerAddress2 = default(string), string partnerCode = default(string), string partnerContactInfo = default(string), string partnerDisplayName = default(string), int? partnerId = default(int?), string partnerName = default(string), int? partnerPrefectureCode = default(int?), string partnerPrefectureName = default(string), string partnerTitle = default(string), string partnerZipcode = default(string), List<QuotationIndexResponseQuotationContents> quotationContents = default(List<QuotationIndexResponseQuotationContents>), QuotationLayoutEnum quotationLayout = default(QuotationLayoutEnum), string quotationNumber = default(string), QuotationStatusEnum quotationStatus = default(QuotationStatusEnum), int? relatedInvoiceId = default(int?), List<int> relatedQuotationIds = default(List<int>), int subTotal = default(int), TaxEntryMethodEnum taxEntryMethod = default(TaxEntryMethodEnum), string title = default(string), int totalAmount = default(int), InvoiceIndexResponseTotalAmountPerVatRate totalAmountPerVatRate = default(InvoiceIndexResponseTotalAmountPerVatRate), int totalVat = default(int), string webConfirmedAt = default(string), string webDownloadedAt = default(string), string webPublishedAt = default(string))
        {
            ...
            if (issueDate == null)
            {
                throw new ArgumentNullException("issueDate is a required property for QuotationResponseQuotation and cannot be null");
            }
            this.IssueDate = issueDate;
            // to ensure "partnerId" is required (not null)
            if (partnerId == null)
            {
                throw new ArgumentNullException("partnerId is a required property for QuotationResponseQuotation and cannot be null");
            }
            this.PartnerId = partnerId;
            // to ensure "partnerTitle" is required (not null)
            if (partnerTitle == null)
            {
                throw new ArgumentNullException("partnerTitle is a required property for QuotationResponseQuotation and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("quotationNumber is a required property for QuotationResponseQuotation and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalAmountPerVatRate is a required property for QuotationResponseQuotation and cannot be null");
            }
        ...
        public List<QuotationIndexResponseQuotationContents> QuotationContents { get; set; }
        ...
        /// </summary>
        /// <value>関連する請求書ID&lt;br&gt; 下記で作成したものが該当します。  &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/203318410#1-2\&quot; target&#x3D;\&quot;_blank\&quot;&gt;見積書・納品書を納品書・請求書に変換する&lt;/a&gt;&lt;br&gt; &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/209076226\&quot; target&#x3D;\&quot;_blank\&quot;&gt;複数の見積書・納品書から合算請求書を作成する&lt;/a&gt;&lt;br&gt; </value>
        [DataMember(Name = "related_invoice_id", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as QuotationResponseQuotation);
        }

        /// <summary>
        /// Returns true if QuotationResponseQuotation instances are equal
        /// </summary>
        /// <param name="input">Instance of QuotationResponseQuotation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QuotationResponseQuotation input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RelatedInvoiceId == input.RelatedInvoiceId ||
                    (this.RelatedInvoiceId != null &&
                    this.RelatedInvoiceId.Equals(input.RelatedInvoiceId))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RelatedInvoiceId.GetHashCode();
                }
