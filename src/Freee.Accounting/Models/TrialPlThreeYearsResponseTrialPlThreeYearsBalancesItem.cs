...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItem class.
        /// </summary>
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItem()
        {
            CustomInit();
        }
        ...
        /// account_item_display_type:account_item指定時のみ含まれる</param>
        /// <param name="sections">breakdown_display_type:section,
        /// account_item_display_type:account_item指定時のみ含まれる</param>
        /// <param
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItem(int? accountItemId = default(int?), string accountItemName = default(string), IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem> partners = default(IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem>), IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem> items = default(IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem>), IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemSectionsItem> sections = default(IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemSectionsItem>), int? accountCategoryId = default(int?), string accountCategoryName = default(string), bool? totalLine = default(bool?), int? hierarchyLevel = default(int?), int? parentAccountCategoryId = default(int?), string parentAccountCategoryName = default(string), int? twoYearsBeforeClosingBalance = default(int?), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
        ...
        public IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem> Partners { get; set; }
        ...
        public IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem> Items { get; set; }

        /// <summary>
        /// Gets or sets breakdown_display_type:section,
        /// account_item_display_type:account_item指定時のみ含まれる
        /// </summary>
        [JsonProperty(PropertyName = "sections")]
        public IList<TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemSectionsItem> Sections { get; set; }
