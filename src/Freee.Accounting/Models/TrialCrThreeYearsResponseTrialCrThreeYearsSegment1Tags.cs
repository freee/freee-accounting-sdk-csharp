...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrThreeYearsResponse_trial_cr_three_years_segment_1_tags")]
    public partial class TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags : IEquatable<TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags" /> class.
        /// </summary>
        ...
        public TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags);
        }

        /// <summary>
        /// Returns true if TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags input)
        {
            if (input == null)
            {
                return false;
