...
namespace Freee.Accounting.Models
{
    ...
    public partial class ManualJournal :  IEquatable<ManualJournal>
    {
        ...
        public ManualJournal(int id = default(int), int companyId = default(int), string issueDate = default(string), bool adjustment = default(bool), string txnNumber = default(string), List<ManualJournalDetails> details = default(List<ManualJournalDetails>))
        {
            this.Id = id;
            this.CompanyId = companyId;
            // to ensure "issueDate" is required (not null)
            this.IssueDate = issueDate ?? throw new ArgumentNullException("issueDate is a required property for ManualJournal and cannot be null");;
            this.Adjustment = adjustment;
            // to ensure "txnNumber" is required (not null)
            this.TxnNumber = txnNumber ?? throw new ArgumentNullException("txnNumber is a required property for ManualJournal and cannot be null");;
            // to ensure "details" is required (not null)
            this.Details = details ?? throw new ArgumentNullException("details is a required property for ManualJournal and cannot be null");;
        }
