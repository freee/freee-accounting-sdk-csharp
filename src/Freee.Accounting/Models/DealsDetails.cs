...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DealsDetails :  IEquatable<DealsDetails>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsDetails" /> class.
        /// </summary>
        ...
        public DealsDetails(int id = default(int), int accountItemId = default(int), int taxId = default(int), int taxCode = default(int), int? itemId = default(int?), int? sectionId = default(int?), List<int> tagIds = default(List<int>), int? segment1TagId = default(int?), int? segment2TagId = default(int?), int? segment3TagId = default(int?), int amount = default(int), int vat = default(int), string description = default(string), EntrySideEnum entrySide = default(EntrySideEnum))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as DealsDetails);
        }

        /// <summary>
        /// Returns true if DealsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsDetails input)
        {
            if (input == null)
                return false;
