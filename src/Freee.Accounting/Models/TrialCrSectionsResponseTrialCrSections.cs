...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSectionsResponse_trial_cr_sections")]
    public partial class TrialCrSectionsResponseTrialCrSections : IEquatable<TrialCrSectionsResponseTrialCrSections>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>内訳の表示（取引先: partner, 品目: item, 勘定科目: account_item, セグメント1(法人向けプロフェッショナル, 法人向けエンタープライズプラン): segment_1_tag, セグメント2(法人向け エンタープライズプラン):segment_2_tag, セグメント3(法人向け エンタープライズプラン): segment_3_tag）(条件に指定した時のみ含まれる）</value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSectionsResponseTrialCrSections" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrSectionsResponseTrialCrSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSectionsResponseTrialCrSections" /> class.
        /// </summary>
        ...
        /// <param name="breakdownDisplayType">内訳の表示（取引先: partner, 品目: item, 勘定科目: account_item, セグメント1(法人向けプロフェッショナル, 法人向けエンタープライズプラン): segment_1_tag, セグメント2(法人向け エンタープライズプラン):segment_2_tag, セグメント3(法人向け エンタープライズプラン): segment_3_tag）(条件に指定した時のみ含まれる）.</param>
        ...
        public TrialCrSectionsResponseTrialCrSections(AccountItemDisplayTypeEnum? accountItemDisplayType = default(AccountItemDisplayTypeEnum?), AdjustmentEnum? adjustment = default(AdjustmentEnum?), ApprovalFlowStatusEnum? approvalFlowStatus = default(ApprovalFlowStatusEnum?), List<TrialCrSectionsResponseTrialCrSectionsBalances> balances = default(List<TrialCrSectionsResponseTrialCrSectionsBalances>), BreakdownDisplayTypeEnum? breakdownDisplayType = default(BreakdownDisplayTypeEnum?), int companyId = default(int), CostAllocationEnum? costAllocation = default(CostAllocationEnum?), string createdAt = default(string), string endDate = default(string), int endMonth = default(int), int fiscalYear = default(int), int itemId = default(int), string partnerCode = default(string), int partnerId = default(int), string sectionIds = default(string), string startDate = default(string), int startMonth = default(int))
        {
            // to ensure "balances" is required (not null)
            if (balances == null) {
                throw new ArgumentNullException("balances is a required property for TrialCrSectionsResponseTrialCrSections and cannot be null");
            }
            this.Balances = balances;
            this.CompanyId = companyId;
            // to ensure "sectionIds" is required (not null)
            if (sectionIds == null) {
                throw new ArgumentNullException("sectionIds is a required property for TrialCrSectionsResponseTrialCrSections and cannot be null");
            }
        ...
        public List<TrialCrSectionsResponseTrialCrSectionsBalances> Balances { get; set; }
        ...
        {
            return this.Equals(input as TrialCrSectionsResponseTrialCrSections);
        }

        /// <summary>
        /// Returns true if TrialCrSectionsResponseTrialCrSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSectionsResponseTrialCrSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSectionsResponseTrialCrSections input)
        {
            if (input == null)
            {
                return false;
