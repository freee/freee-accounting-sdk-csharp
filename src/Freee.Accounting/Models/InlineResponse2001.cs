...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2001 : IEquatable<InlineResponse2001>
    {
        ...
        public InlineResponse2001(List<Bank> banks = default(List<Bank>))
        {
            // to ensure "banks" is required (not null)
            this.Banks = banks ?? throw new ArgumentNullException("banks is a required property for InlineResponse2001 and cannot be null");
        }
