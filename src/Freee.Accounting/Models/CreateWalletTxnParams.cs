...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateWalletTxnParams :  IEquatable<CreateWalletTxnParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWalletTxnParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateWalletTxnParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateWalletTxnParams" /> class.
        /// </summary>
        ...
        public CreateWalletTxnParams(EntrySideEnum entrySide = default(EntrySideEnum), string description = default(string), int amount = default(int), int walletableId = default(int), WalletableTypeEnum walletableType = default(WalletableTypeEnum), string date = default(string), int companyId = default(int), int balance = default(int))
        {
            ...
            this.Date = date ?? throw new ArgumentNullException("date is a required property for CreateWalletTxnParams and cannot be null");;
        ...
        {
            return this.Equals(input as CreateWalletTxnParams);
        }

        /// <summary>
        /// Returns true if CreateWalletTxnParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateWalletTxnParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateWalletTxnParams input)
        {
            if (input == null)
                return false;
