...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>
    {
        ...
        public InlineResponse2009(List<Section> sections = default(List<Section>))
        {
            // to ensure "sections" is required (not null)
            this.Sections = sections ?? throw new ArgumentNullException("sections is a required property for InlineResponse2009 and cannot be null");
        }
