...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2009 :  IEquatable<InlineResponse2009>
    {
        ...
        public InlineResponse2009(List<Receipt> receipts = default(List<Receipt>))
        {
            // to ensure "receipts" is required (not null)
            this.Receipts = receipts ?? throw new ArgumentNullException("receipts is a required property for InlineResponse2009 and cannot be null");
        }
