...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSegment_1TagsResponse_trial_cr_segment_1_tags_balances")]
    public partial class TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances : IEquatable<TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances" /> class.
        /// </summary>
        ...
        /// <param name="segment1Tags">セグメント1タグ.</param>
        /// <param name="totalLine">合計行(勘定科目カテゴリーの時のみ含まれる).</param>
        public TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), string parentAccountCategoryName = default(string), List<TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags> segment1Tags = default(List<TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags>), bool totalLine = default(bool))
        {
        ...
        /// セグメント1タグ
        /// </summary>
        /// <value>セグメント1タグ</value>
        [DataMember(Name = "segment_1_tags", EmitDefaultValue = false)]
        public List<TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags> Segment1Tags { get; set; }
        ...
        {
            return this.Equals(input as TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances);
        }

        /// <summary>
        /// Returns true if TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSegment1TagsResponseTrialCrSegment1TagsBalances input)
        {
            if (input == null)
            {
                return false;
