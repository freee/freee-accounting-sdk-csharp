...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountItemsIndexResponseAccountItems :  IEquatable<AccountItemsIndexResponseAccountItems>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountItemsIndexResponseAccountItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountItemsIndexResponseAccountItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountItemsIndexResponseAccountItems" /> class.
        /// </summary>
        ...
        public AccountItemsIndexResponseAccountItems(int id = default(int), string name = default(string), string shortcut = default(string), string shortcutNum = default(string), int defaultTaxId = default(int), int defaultTaxCode = default(int), List<string> categories = default(List<string>), bool available = default(bool), int? walletableId = default(int?))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for AccountItemsIndexResponseAccountItems and cannot be null");;
            this.DefaultTaxCode = defaultTaxCode;
            // to ensure "categories" is required (not null)
            this.Categories = categories ?? throw new ArgumentNullException("categories is a required property for AccountItemsIndexResponseAccountItems and cannot be null");;
            this.Available = available;
            // to ensure "walletableId" is required (not null)
            this.WalletableId = walletableId ?? throw new ArgumentNullException("walletableId is a required property for AccountItemsIndexResponseAccountItems and cannot be null");;
        ...
        {
            return this.Equals(input as AccountItemsIndexResponseAccountItems);
        }

        /// <summary>
        /// Returns true if AccountItemsIndexResponseAccountItems instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountItemsIndexResponseAccountItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountItemsIndexResponseAccountItems input)
        {
            if (input == null)
                return false;
