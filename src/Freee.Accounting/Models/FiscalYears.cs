...
namespace Freee.Accounting.Models
{
    ...
    public partial class FiscalYears : IEquatable<FiscalYears>
    {
        ...
        [DataMember(Name = "indirect_write_off_method", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "use_industry_template", IsRequired = true, EmitDefaultValue = true)]
