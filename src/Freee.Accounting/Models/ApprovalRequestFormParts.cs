...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "approval_request_form_parts")]
    public partial class ApprovalRequestFormParts : IEquatable<ApprovalRequestFormParts>
    {
        ...
        protected ApprovalRequestFormParts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApprovalRequestFormParts" /> class.
        /// </summary>
        ...
        /// <param name="type">項目種別 (title: 申請タイトル, single_line: 自由記述形式 1行, multi_line: 自由記述形式 複数行, select: プルダウン, date: 日付, amount: 金額, receipt: 添付ファイル).</param>
        /// <param name="values">選択項目.</param>
        public ApprovalRequestFormParts(string annotation = default(string), int id = default(int), string label = default(string), int? maxAmount = default(int?), int? minAmount = default(int?), int order = default(int), bool? required = default(bool?), TypeEnum? type = default(TypeEnum?), List<ApprovalRequestFormValues> values = default(List<ApprovalRequestFormValues>))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ApprovalRequestFormParts);
        }

        /// <summary>
        /// Returns true if ApprovalRequestFormParts instances are equal
        /// </summary>
        /// <param name="input">Instance of ApprovalRequestFormParts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApprovalRequestFormParts input)
        {
            if (input == null)
                return false;
