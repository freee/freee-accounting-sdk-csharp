...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20016 :  IEquatable<InlineResponse20016>
    {
        ...
        public InlineResponse20016(List<User> users = default(List<User>))
        {
            // to ensure "users" is required (not null)
            this.Users = users ?? throw new ArgumentNullException("users is a required property for InlineResponse20016 and cannot be null");
        }
