...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20020 :  IEquatable<InlineResponse20020>
    {
        ...
        public InlineResponse20020(InlineResponse20019Meta meta = default(InlineResponse20019Meta), Walletable walletable = default(Walletable))
        {
            // to ensure "walletable" is required (not null)
            this.Walletable = walletable ?? throw new ArgumentNullException("walletable is a required property for InlineResponse20020 and cannot be null");
            this.Meta = meta;
        }
