...
namespace Freee.Accounting.Models
{
    ...
    {
        /// <summary>
        /// 行の種類 &lt;ul&gt; &lt;li&gt;normal、discountを指定する場合、account_item_id,tax_codeとunit_priceが必須となります。&lt;/li&gt; &lt;li&gt;normalを指定した場合、qtyが必須となります。&lt;/li&gt; &lt;li&gt;discountを指定した場合、qtyとunitは値を登録できずにエラーとなります。&lt;/li&gt; &lt;/ul&gt;
        /// </summary>
        /// <value>行の種類 &lt;ul&gt; &lt;li&gt;normal、discountを指定する場合、account_item_id,tax_codeとunit_priceが必須となります。&lt;/li&gt; &lt;li&gt;normalを指定した場合、qtyが必須となります。&lt;/li&gt; &lt;li&gt;discountを指定した場合、qtyとunitは値を登録できずにエラーとなります。&lt;/li&gt; &lt;/ul&gt;</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceUpdateParamsInvoiceContents" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceUpdateParamsInvoiceContents() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceUpdateParamsInvoiceContents" /> class.
        /// </summary>
        ...
        /// <param name="type">行の種類 &lt;ul&gt; &lt;li&gt;normal、discountを指定する場合、account_item_id,tax_codeとunit_priceが必須となります。&lt;/li&gt; &lt;li&gt;normalを指定した場合、qtyが必須となります。&lt;/li&gt; &lt;li&gt;discountを指定した場合、qtyとunitは値を登録できずにエラーとなります。&lt;/li&gt; &lt;/ul&gt; (required).</param>
        ...
        {
            return this.Equals(input as InvoiceUpdateParamsInvoiceContents);
        }

        /// <summary>
        /// Returns true if InvoiceUpdateParamsInvoiceContents instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceUpdateParamsInvoiceContents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceUpdateParamsInvoiceContents input)
        {
            if (input == null)
                return false;
