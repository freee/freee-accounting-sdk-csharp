...
namespace Freee.Accounting.Models
{
    ...
    public partial class ExpenseApplicationLineTemplateParams :  IEquatable<ExpenseApplicationLineTemplateParams>
    {
        ...
        /// <param name="accountItemsId">勘定科目ID.</param>
        ...
        public ExpenseApplicationLineTemplateParams(int companyId = default(int), string name = default(string), int accountItemsId = default(int), int itemId = default(int), int taxCode = default(int), string description = default(string), string lineDescription = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ExpenseApplicationLineTemplateParams and cannot be null");;
        ...
        /// </summary>
        /// <value>勘定科目ID</value>
        [DataMember(Name="account_items_id", EmitDefaultValue=false)]
        public int AccountItemsId { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  AccountItemsId: ").Append(AccountItemsId).Append("\n");
        ...
        public bool Equals(ExpenseApplicationLineTemplateParams input)
        {
            ...
            return 
                ...
                (
                    this.AccountItemsId == input.AccountItemsId ||
                    this.AccountItemsId.Equals(input.AccountItemsId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.AccountItemsId.GetHashCode();
