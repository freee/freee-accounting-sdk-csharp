...
namespace Freee.Accounting.Models
{
    ...
    public partial class ExpenseApplicationLineTemplateParams :  IEquatable<ExpenseApplicationLineTemplateParams>
    {
        ...
        public ExpenseApplicationLineTemplateParams(int accountItemId = default(int), int companyId = default(int), string description = default(string), int itemId = default(int), string lineDescription = default(string), string name = default(string), int taxCode = default(int))
        {
