...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "partnerResponse_partner_partner_doc_setting_attributes")]
    public partial class PartnerResponsePartnerPartnerDocSettingAttributes : IEquatable<PartnerResponsePartnerPartnerDocSettingAttributes>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerResponsePartnerPartnerDocSettingAttributes" /> class.
        /// </summary>
        /// <param name="sendingMethod">請求書送付方法(email:メール、posting:郵送、email_and_posting:メールと郵送).</param>
        public PartnerResponsePartnerPartnerDocSettingAttributes(SendingMethodEnum? sendingMethod = default(SendingMethodEnum?))
        {
        ...
        {
            return this.Equals(input as PartnerResponsePartnerPartnerDocSettingAttributes);
        }

        /// <summary>
        /// Returns true if PartnerResponsePartnerPartnerDocSettingAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerResponsePartnerPartnerDocSettingAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerResponsePartnerPartnerDocSettingAttributes input)
        {
            if (input == null)
            {
                return false;
