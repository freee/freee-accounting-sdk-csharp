...
namespace Freee.Accounting.Models
{
    ...
    public partial class ApprovalRequestResponseApprovalRequest : IEquatable<ApprovalRequestResponseApprovalRequest>
    {
        ...
        public ApprovalRequestResponseApprovalRequest(int applicantId = default(int), string applicationDate = default(string), string applicationNumber = default(string), List<ApprovalRequestResponseApprovalRequestApprovalFlowLogs> approvalFlowLogs = default(List<ApprovalRequestResponseApprovalRequestApprovalFlowLogs>), int approvalFlowRouteId = default(int), ApprovalRequestResponseApprovalRequestApprovalRequestForm approvalRequestForm = default(ApprovalRequestResponseApprovalRequestApprovalRequestForm), List<ApprovalRequestResponseApprovalRequestApprovers> approvers = default(List<ApprovalRequestResponseApprovalRequestApprovers>), List<ApprovalRequestResponseApprovalRequestComments> comments = default(List<ApprovalRequestResponseApprovalRequestComments>), int companyId = default(int), int currentRound = default(int), int? currentStepId = default(int?), int? dealId = default(int?), DealStatusEnum dealStatus = default(DealStatusEnum), int formId = default(int), int id = default(int), int? manualJournalId = default(int?), List<ApprovalRequestResponseApprovalRequestRequestItems> requestItems = default(List<ApprovalRequestResponseApprovalRequestRequestItems>), StatusEnum status = default(StatusEnum), string title = default(string))
        {
            ...
            {
                throw new ArgumentNullException("approvalRequestForm is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            this.ApprovalRequestForm = approvalRequestForm;
            // to ensure "approvers" is required (not null)
            if (approvers == null)
            {
                throw new ArgumentNullException("approvers is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            this.Approvers = approvers;
            // to ensure "comments" is required (not null)
            if (comments == null)
            {
                throw new ArgumentNullException("comments is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("currentStepId is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            this.CurrentStepId = currentStepId;
            // to ensure "dealId" is required (not null)
            if (dealId == null)
            {
                throw new ArgumentNullException("dealId is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            this.DealId = dealId;
            ...
            {
                throw new ArgumentNullException("manualJournalId is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            this.ManualJournalId = manualJournalId;
            // to ensure "requestItems" is required (not null)
            if (requestItems == null)
            {
                throw new ArgumentNullException("requestItems is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            ...
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            }
            this.Title = title;
        }
