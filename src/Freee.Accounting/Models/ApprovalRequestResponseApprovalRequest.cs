...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "approvalRequestResponse_approval_request")]
    public partial class ApprovalRequestResponseApprovalRequest : IEquatable<ApprovalRequestResponseApprovalRequest>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApprovalRequestResponseApprovalRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApprovalRequestResponseApprovalRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApprovalRequestResponseApprovalRequest" /> class.
        /// </summary>
        ...
        /// <param name="approvalFlowLogs">各種申請の承認履歴（配列） (required).</param>
        ...
        /// <param name="comments">各種申請のコメント一覧（配列） (required).</param>
        ...
        public ApprovalRequestResponseApprovalRequest(int applicantId = default(int), string applicationDate = default(string), string applicationNumber = default(string), List<ApprovalRequestResponseApprovalRequestApprovalFlowLogs> approvalFlowLogs = default(List<ApprovalRequestResponseApprovalRequestApprovalFlowLogs>), int approvalFlowRouteId = default(int), ApprovalRequestResponseApprovalRequestApprovalRequestForm approvalRequestForm = default(ApprovalRequestResponseApprovalRequestApprovalRequestForm), List<ApprovalRequestResponseApprovalRequestApprovers> approvers = default(List<ApprovalRequestResponseApprovalRequestApprovers>), List<ApprovalRequestResponseApprovalRequestComments> comments = default(List<ApprovalRequestResponseApprovalRequestComments>), int companyId = default(int), int currentRound = default(int), int? currentStepId = default(int?), int formId = default(int), int id = default(int), List<ApprovalRequestResponseApprovalRequestRequestItems> requestItems = default(List<ApprovalRequestResponseApprovalRequestRequestItems>), StatusEnum status = default(StatusEnum), string title = default(string))
        {
            this.ApplicantId = applicantId;
            // to ensure "applicationDate" is required (not null)
            this.ApplicationDate = applicationDate ?? throw new ArgumentNullException("applicationDate is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            // to ensure "applicationNumber" is required (not null)
            this.ApplicationNumber = applicationNumber ?? throw new ArgumentNullException("applicationNumber is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            // to ensure "approvalFlowLogs" is required (not null)
            this.ApprovalFlowLogs = approvalFlowLogs ?? throw new ArgumentNullException("approvalFlowLogs is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            this.ApprovalFlowRouteId = approvalFlowRouteId;
            // to ensure "approvalRequestForm" is required (not null)
            this.ApprovalRequestForm = approvalRequestForm ?? throw new ArgumentNullException("approvalRequestForm is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            // to ensure "approvers" is required (not null)
            this.Approvers = approvers ?? throw new ArgumentNullException("approvers is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            // to ensure "comments" is required (not null)
            this.Comments = comments ?? throw new ArgumentNullException("comments is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            this.CompanyId = companyId;
            this.CurrentRound = currentRound;
            // to ensure "currentStepId" is required (not null)
            this.CurrentStepId = currentStepId ?? throw new ArgumentNullException("currentStepId is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            this.FormId = formId;
            this.Id = id;
            // to ensure "requestItems" is required (not null)
            this.RequestItems = requestItems ?? throw new ArgumentNullException("requestItems is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
            this.Status = status;
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for ApprovalRequestResponseApprovalRequest and cannot be null");
        }
        ...
        /// 各種申請の承認履歴（配列）
        /// </summary>
        /// <value>各種申請の承認履歴（配列）</value>
        [DataMember(Name = "approval_flow_logs", EmitDefaultValue = false)]
        ...
        /// </summary>
        [DataMember(Name = "approval_request_form", EmitDefaultValue = false)]
        public ApprovalRequestResponseApprovalRequestApprovalRequestForm ApprovalRequestForm { get; set; }
        ...
        {
            return this.Equals(input as ApprovalRequestResponseApprovalRequest);
        }

        /// <summary>
        /// Returns true if ApprovalRequestResponseApprovalRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApprovalRequestResponseApprovalRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApprovalRequestResponseApprovalRequest input)
        {
            if (input == null)
                return false;
