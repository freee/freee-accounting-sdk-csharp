...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_13_taxes")]
    public partial class InlineResponse20013Taxes : IEquatable<InlineResponse20013Taxes>
    {
        ...
        protected InlineResponse20013Taxes() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse20013Taxes" /> class.
        /// </summary>
        ...
        public InlineResponse20013Taxes(bool available = default(bool), int code = default(int), DisplayCategoryEnum displayCategory = default(DisplayCategoryEnum), string name = default(string), string nameJa = default(string))
        {
            this.Available = available;
            this.Code = code;
            this.DisplayCategory = displayCategory;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for InlineResponse20013Taxes and cannot be null");
            // to ensure "nameJa" is required (not null)
            this.NameJa = nameJa ?? throw new ArgumentNullException("nameJa is a required property for InlineResponse20013Taxes and cannot be null");
        }
        ...
        {
            return this.Equals(input as InlineResponse20013Taxes);
        }

        /// <summary>
        /// Returns true if InlineResponse20013Taxes instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20013Taxes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20013Taxes input)
        {
            if (input == null)
                return false;
