...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SectionsCreateResponseSection :  IEquatable<SectionsCreateResponseSection>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionsCreateResponseSection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SectionsCreateResponseSection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionsCreateResponseSection" /> class.
        /// </summary>
        ...
        public SectionsCreateResponseSection(int id = default(int), string name = default(string), string longName = default(string), int companyId = default(int), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SectionsCreateResponseSection and cannot be null");;
        ...
        {
            return this.Equals(input as SectionsCreateResponseSection);
        }

        /// <summary>
        /// Returns true if SectionsCreateResponseSection instances are equal
        /// </summary>
        /// <param name="input">Instance of SectionsCreateResponseSection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SectionsCreateResponseSection input)
        {
            if (input == null)
                return false;
