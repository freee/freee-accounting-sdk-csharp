...
namespace Freee.Accounting.Models
{
    ...
    public partial class CompanyResponseCompany : IEquatable<CompanyResponseCompany>
    {
        ...
        /// </summary>
        /// <value>種別（agriculture_forestry_fisheries_ore: 農林水産業/鉱業,construction: 建設,manufacturing_processing: 製造/加工,it: IT,transportation_logistics: 運輸/物流,retail_wholesale: 小売/卸売,finance_insurance: 金融/保険,real_estate_rental: 不動産/レンタル,profession: 士業/学術/専門技術サービス,design_production: デザイン/制作,food: 飲食,leisure_entertainment: レジャー/娯楽,lifestyle: 生活関連サービス,education: 教育/学習支援,medical_welfare: 医療/福祉,other_services: その他サービス,other_association: NPO、一般社団法人等,other: その他, \&quot;\&quot;: 未選択）</value>
        [DataMember(Name = "industry_class", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <param name="accountItems">accountItems.</param>
        ...
        /// <param name="defaultWalletAccountId">デフォルトの決済口座が紐づく勘定科目ID.</param>
        ...
        public List<CompanyResponseCompanyTags> Tags { get; set; }

        /// <summary>
        /// Gets or Sets AccountItems
        /// </summary>
        [DataMember(Name = "account_items", EmitDefaultValue = false)]
        public List<CompanyResponseCompanyAccountItems> AccountItems { get; set; }
        ...
        /// </summary>
        /// <value>デフォルトの決済口座が紐づく勘定科目ID</value>
        ...
        public List<CompanyResponseCompanyItems> Items { get; set; }
        ...
        public List<CompanyResponseCompanyPartners> Partners { get; set; }
        ...
        [DataMember(Name = "private_settlement", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<CompanyResponseCompanySections> Sections { get; set; }

        /// <summary>
        /// 市区町村・番地
        /// </summary>
        /// <value>市区町村・番地</value>
        [DataMember(Name = "street_name1", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "street_name2", IsRequired = true, EmitDefaultValue = true)]
        ...
        [DataMember(Name = "use_partner_code", IsRequired = true, EmitDefaultValue = true)]
        ...
        public List<CompanyResponseCompanyWalletables> Walletables { get; set; }
