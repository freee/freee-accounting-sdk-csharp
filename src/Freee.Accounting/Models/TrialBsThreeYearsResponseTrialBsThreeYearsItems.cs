...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsItems :  IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsItems>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsThreeYearsResponseTrialBsThreeYearsItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsItems" /> class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsItems(int id = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialBsThreeYearsResponseTrialBsThreeYearsItems);
        }

        /// <summary>
        /// Returns true if TrialBsThreeYearsResponseTrialBsThreeYearsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsThreeYearsResponseTrialBsThreeYearsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsThreeYearsResponseTrialBsThreeYearsItems input)
        {
            if (input == null)
                return false;
