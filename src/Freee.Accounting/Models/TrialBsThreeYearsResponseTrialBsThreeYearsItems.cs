...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsThreeYearsResponse_trial_bs_three_years_items")]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsItems : IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsItems>
    {
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsItems(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
