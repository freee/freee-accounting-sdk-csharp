...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class JournalsEnqueueJournalsResponseJournals :  IEquatable<JournalsEnqueueJournalsResponseJournals>
    {
        /// <summary>
        /// ダウンロード形式
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JournalsEnqueueJournalsResponseJournals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JournalsEnqueueJournalsResponseJournals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JournalsEnqueueJournalsResponseJournals" /> class.
        /// </summary>
        ...
        public JournalsEnqueueJournalsResponseJournals(int id = default(int), string messages = default(string), int companyId = default(int), DownloadTypeEnum? downloadType = default(DownloadTypeEnum?), string startDate = default(string), string endDate = default(string), List<VisibleTagsEnum> visibleTags = default(List<VisibleTagsEnum>), string statusUrl = default(string))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as JournalsEnqueueJournalsResponseJournals);
        }

        /// <summary>
        /// Returns true if JournalsEnqueueJournalsResponseJournals instances are equal
        /// </summary>
        /// <param name="input">Instance of JournalsEnqueueJournalsResponseJournals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JournalsEnqueueJournalsResponseJournals input)
        {
            if (input == null)
                return false;
