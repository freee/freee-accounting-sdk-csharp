...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlResponse_trial_pl_balances")]
    public partial class TrialPlResponseTrialPlBalances : IEquatable<TrialPlResponseTrialPlBalances>
    {
        ...
        public TrialPlResponseTrialPlBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int hierarchyLevel = default(int), List<TrialBsResponseTrialBsItems> items = default(List<TrialBsResponseTrialBsItems>), int openingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialBsResponseTrialBsPartners> partners = default(List<TrialBsResponseTrialBsPartners>), List<TrialPlResponseTrialPlSections> sections = default(List<TrialPlResponseTrialPlSections>), List<TrialBsResponseTrialBsSegment1Tags> segment1Tags = default(List<TrialBsResponseTrialBsSegment1Tags>), List<TrialBsResponseTrialBsSegment2Tags> segment2Tags = default(List<TrialBsResponseTrialBsSegment2Tags>), List<TrialBsResponseTrialBsSegment3Tags> segment3Tags = default(List<TrialBsResponseTrialBsSegment3Tags>), bool totalLine = default(bool))
        {
