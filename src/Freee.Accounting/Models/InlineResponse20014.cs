...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20014 : IEquatable<InlineResponse20014>
    {
        ...
        public InlineResponse20014(List<Transfer> transfers = default(List<Transfer>))
        {
            // to ensure "transfers" is required (not null)
            this.Transfers = transfers ?? throw new ArgumentNullException("transfers is a required property for InlineResponse20014 and cannot be null");
        }
