...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20014 :  IEquatable<InlineResponse20014>
    {
        ...
        public InlineResponse20014(List<InlineResponse20014Taxes> taxes = default(List<InlineResponse20014Taxes>))
        {
            // to ensure "taxes" is required (not null)
            this.Taxes = taxes ?? throw new ArgumentNullException("taxes is a required property for InlineResponse20014 and cannot be null");
        }
        ...
        public List<InlineResponse20014Taxes> Taxes { get; set; }
