...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_sections")]
    public partial class TrialBsResponseTrialBsSections : IEquatable<TrialBsResponseTrialBsSections>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSections" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsResponseTrialBsSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSections" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsSections(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsSections);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsSections input)
        {
            if (input == null)
            {
                return false;
