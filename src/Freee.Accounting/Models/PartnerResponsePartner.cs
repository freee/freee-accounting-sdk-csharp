...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "partnerResponse_partner")]
    public partial class PartnerResponsePartner : IEquatable<PartnerResponsePartner>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerResponsePartner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PartnerResponsePartner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerResponsePartner" /> class.
        /// </summary>
        ...
        /// <param name="invoicePaymentTermAttributesAdditionalMonths">支払月.</param>
        /// <param name="invoicePaymentTermAttributesCutoffDay">締め日（29, 30, 31日の末日を指定する場合は、32。）.</param>
        /// <param name="invoicePaymentTermAttributesFixedDay">支払日（29, 30, 31日の末日を指定する場合は、32。）.</param>
        ...
        /// <param name="partnerDocSettingAttributesSendingMethod">請求書送付方法(email:メール、posting:郵送、email_and_posting:メールと郵送).</param>
        /// <param name="payerWalletableId">振込元口座ID（一括振込ファイル用）:（未設定の場合は、nullです。）.</param>
        /// <param name="paymentTermAttributesAdditionalMonths">支払月.</param>
        /// <param name="paymentTermAttributesCutoffDay">締め日（29, 30, 31日の末日を指定する場合は、32。）.</param>
        /// <param name="paymentTermAttributesFixedDay">支払日（29, 30, 31日の末日を指定する場合は、32。）.</param>
        ...
        public PartnerResponsePartner(PartnerResponsePartnerAddressAttributes addressAttributes = default(PartnerResponsePartnerAddressAttributes), string code = default(string), int companyId = default(int), string contactName = default(string), string countryCode = default(string), string defaultTitle = default(string), string email = default(string), int id = default(int), int? invoicePaymentTermAttributesAdditionalMonths = default(int?), int? invoicePaymentTermAttributesCutoffDay = default(int?), int? invoicePaymentTermAttributesFixedDay = default(int?), string longName = default(string), string name = default(string), string nameKana = default(string), int? orgCode = default(int?), string partnerBankAccountAttributesAccountName = default(string), string partnerBankAccountAttributesAccountNumber = default(string), PartnerBankAccountAttributesAccountTypeEnum? partnerBankAccountAttributesAccountType = default(PartnerBankAccountAttributesAccountTypeEnum?), string partnerBankAccountAttributesBankCode = default(string), string partnerBankAccountAttributesBankName = default(string), string partnerBankAccountAttributesBankNameKana = default(string), string partnerBankAccountAttributesBranchCode = default(string), string partnerBankAccountAttributesBranchKana = default(string), string partnerBankAccountAttributesBranchName = default(string), string partnerBankAccountAttributesLongAccountName = default(string), PartnerDocSettingAttributesSendingMethodEnum? partnerDocSettingAttributesSendingMethod = default(PartnerDocSettingAttributesSendingMethodEnum?), int? payerWalletableId = default(int?), int? paymentTermAttributesAdditionalMonths = default(int?), int? paymentTermAttributesCutoffDay = default(int?), int? paymentTermAttributesFixedDay = default(int?), string phone = default(string), string shortcut1 = default(string), string shortcut2 = default(string), TransferFeeHandlingSideEnum? transferFeeHandlingSide = default(TransferFeeHandlingSideEnum?))
        {
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for PartnerResponsePartner and cannot be null");
            this.CompanyId = companyId;
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PartnerResponsePartner and cannot be null");
        ...
        /// </summary>
        /// <value>支払月</value>
        [DataMember(Name = "invoice_payment_term_attributes[additional_months]", EmitDefaultValue = true)]
        public int? InvoicePaymentTermAttributesAdditionalMonths { get; set; }

        /// <summary>
        /// 締め日（29, 30, 31日の末日を指定する場合は、32。）
        /// </summary>
        /// <value>締め日（29, 30, 31日の末日を指定する場合は、32。）</value>
        [DataMember(Name = "invoice_payment_term_attributes[cutoff_day]", EmitDefaultValue = true)]
        public int? InvoicePaymentTermAttributesCutoffDay { get; set; }

        /// <summary>
        /// 支払日（29, 30, 31日の末日を指定する場合は、32。）
        /// </summary>
        /// <value>支払日（29, 30, 31日の末日を指定する場合は、32。）</value>
        [DataMember(Name = "invoice_payment_term_attributes[fixed_day]", EmitDefaultValue = true)]
        public int? InvoicePaymentTermAttributesFixedDay { get; set; }
        ...
        /// </summary>
        /// <value>支払月</value>
        [DataMember(Name = "payment_term_attributes[additional_months]", EmitDefaultValue = true)]
        public int? PaymentTermAttributesAdditionalMonths { get; set; }

        /// <summary>
        /// 締め日（29, 30, 31日の末日を指定する場合は、32。）
        /// </summary>
        /// <value>締め日（29, 30, 31日の末日を指定する場合は、32。）</value>
        [DataMember(Name = "payment_term_attributes[cutoff_day]", EmitDefaultValue = true)]
        public int? PaymentTermAttributesCutoffDay { get; set; }

        /// <summary>
        /// 支払日（29, 30, 31日の末日を指定する場合は、32。）
        /// </summary>
        /// <value>支払日（29, 30, 31日の末日を指定する場合は、32。）</value>
        [DataMember(Name = "payment_term_attributes[fixed_day]", EmitDefaultValue = true)]
        public int? PaymentTermAttributesFixedDay { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  InvoicePaymentTermAttributesAdditionalMonths: ").Append(InvoicePaymentTermAttributesAdditionalMonths).Append("\n");
            sb.Append("  InvoicePaymentTermAttributesCutoffDay: ").Append(InvoicePaymentTermAttributesCutoffDay).Append("\n");
            sb.Append("  InvoicePaymentTermAttributesFixedDay: ").Append(InvoicePaymentTermAttributesFixedDay).Append("\n");
            ...
            sb.Append("  PaymentTermAttributesAdditionalMonths: ").Append(PaymentTermAttributesAdditionalMonths).Append("\n");
            sb.Append("  PaymentTermAttributesCutoffDay: ").Append(PaymentTermAttributesCutoffDay).Append("\n");
            sb.Append("  PaymentTermAttributesFixedDay: ").Append(PaymentTermAttributesFixedDay).Append("\n");
        ...
        {
            return this.Equals(input as PartnerResponsePartner);
        }

        /// <summary>
        /// Returns true if PartnerResponsePartner instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerResponsePartner to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerResponsePartner input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.InvoicePaymentTermAttributesAdditionalMonths == input.InvoicePaymentTermAttributesAdditionalMonths ||
                    (this.InvoicePaymentTermAttributesAdditionalMonths != null &&
                    this.InvoicePaymentTermAttributesAdditionalMonths.Equals(input.InvoicePaymentTermAttributesAdditionalMonths))
                ) && 
                (
                    this.InvoicePaymentTermAttributesCutoffDay == input.InvoicePaymentTermAttributesCutoffDay ||
                    (this.InvoicePaymentTermAttributesCutoffDay != null &&
                    this.InvoicePaymentTermAttributesCutoffDay.Equals(input.InvoicePaymentTermAttributesCutoffDay))
                ) && 
                (
                    this.InvoicePaymentTermAttributesFixedDay == input.InvoicePaymentTermAttributesFixedDay ||
                    (this.InvoicePaymentTermAttributesFixedDay != null &&
                    this.InvoicePaymentTermAttributesFixedDay.Equals(input.InvoicePaymentTermAttributesFixedDay))
                ) && 
                (
                ...
                (
                    this.PaymentTermAttributesAdditionalMonths == input.PaymentTermAttributesAdditionalMonths ||
                    (this.PaymentTermAttributesAdditionalMonths != null &&
                    this.PaymentTermAttributesAdditionalMonths.Equals(input.PaymentTermAttributesAdditionalMonths))
                ) && 
                (
                    this.PaymentTermAttributesCutoffDay == input.PaymentTermAttributesCutoffDay ||
                    (this.PaymentTermAttributesCutoffDay != null &&
                    this.PaymentTermAttributesCutoffDay.Equals(input.PaymentTermAttributesCutoffDay))
                ) && 
                (
                    this.PaymentTermAttributesFixedDay == input.PaymentTermAttributesFixedDay ||
                    (this.PaymentTermAttributesFixedDay != null &&
                    this.PaymentTermAttributesFixedDay.Equals(input.PaymentTermAttributesFixedDay))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.InvoicePaymentTermAttributesAdditionalMonths != null)
                    hashCode = hashCode * 59 + this.InvoicePaymentTermAttributesAdditionalMonths.GetHashCode();
                if (this.InvoicePaymentTermAttributesCutoffDay != null)
                    hashCode = hashCode * 59 + this.InvoicePaymentTermAttributesCutoffDay.GetHashCode();
                if (this.InvoicePaymentTermAttributesFixedDay != null)
                    hashCode = hashCode * 59 + this.InvoicePaymentTermAttributesFixedDay.GetHashCode();
                ...
                if (this.PaymentTermAttributesAdditionalMonths != null)
                    hashCode = hashCode * 59 + this.PaymentTermAttributesAdditionalMonths.GetHashCode();
                if (this.PaymentTermAttributesCutoffDay != null)
                    hashCode = hashCode * 59 + this.PaymentTermAttributesCutoffDay.GetHashCode();
                if (this.PaymentTermAttributesFixedDay != null)
                    hashCode = hashCode * 59 + this.PaymentTermAttributesFixedDay.GetHashCode();
                if (this.Phone != null)
