...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompaniesUpdateResponseCompany :  IEquatable<CompaniesUpdateResponseCompany>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesUpdateResponseCompany" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompaniesUpdateResponseCompany() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesUpdateResponseCompany" /> class.
        /// </summary>
        ...
        public CompaniesUpdateResponseCompany(int id = default(int), string name = default(string), string nameKana = default(string), string displayName = default(string), int taxAtSourceCalcType = default(int), string contactName = default(string), int? headCount = default(int?), string corporateNumber = default(string), TxnNumberFormatEnum txnNumberFormat = default(TxnNumberFormatEnum), int defaultWalletAccountId = default(int), bool privateSettlement = default(bool), int minusFormat = default(int), RoleEnum role = default(RoleEnum), string phone1 = default(string), string phone2 = default(string), string fax = default(string), string zipcode = default(string), int prefectureCode = default(int), string streetName1 = default(string), string streetName2 = default(string), int invoiceLayout = default(int), int invoiceStyle = default(int), int amountFraction = default(int), IndustryClassEnum industryClass = default(IndustryClassEnum), IndustryCodeEnum industryCode = default(IndustryCodeEnum), WorkflowSettingEnum workflowSetting = default(WorkflowSettingEnum), List<FiscalYears> fiscalYears = default(List<FiscalYears>))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "nameKana" is required (not null)
            this.NameKana = nameKana ?? throw new ArgumentNullException("nameKana is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            this.TaxAtSourceCalcType = taxAtSourceCalcType;
            // to ensure "contactName" is required (not null)
            this.ContactName = contactName ?? throw new ArgumentNullException("contactName is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "headCount" is required (not null)
            this.HeadCount = headCount ?? throw new ArgumentNullException("headCount is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "corporateNumber" is required (not null)
            this.CorporateNumber = corporateNumber ?? throw new ArgumentNullException("corporateNumber is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            ...
            this.Phone1 = phone1 ?? throw new ArgumentNullException("phone1 is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "phone2" is required (not null)
            this.Phone2 = phone2 ?? throw new ArgumentNullException("phone2 is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "fax" is required (not null)
            this.Fax = fax ?? throw new ArgumentNullException("fax is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "zipcode" is required (not null)
            this.Zipcode = zipcode ?? throw new ArgumentNullException("zipcode is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            this.PrefectureCode = prefectureCode;
            // to ensure "streetName1" is required (not null)
            this.StreetName1 = streetName1 ?? throw new ArgumentNullException("streetName1 is a required property for CompaniesUpdateResponseCompany and cannot be null");;
            // to ensure "streetName2" is required (not null)
            this.StreetName2 = streetName2 ?? throw new ArgumentNullException("streetName2 is a required property for CompaniesUpdateResponseCompany and cannot be null");;
        ...
        {
            return this.Equals(input as CompaniesUpdateResponseCompany);
        }

        /// <summary>
        /// Returns true if CompaniesUpdateResponseCompany instances are equal
        /// </summary>
        /// <param name="input">Instance of CompaniesUpdateResponseCompany to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompaniesUpdateResponseCompany input)
        {
            if (input == null)
                return false;
