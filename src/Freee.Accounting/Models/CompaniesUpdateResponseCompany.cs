...
namespace Freee.Accounting.Models
{
    ...
    public partial class CompaniesUpdateResponseCompany
    {
        /// <summary>
        /// Initializes a new instance of the CompaniesUpdateResponseCompany
        /// class.
        /// </summary>
        public CompaniesUpdateResponseCompany()
        {
            CustomInit();
        }
        ...
        public CompaniesUpdateResponseCompany(int id, string name, string nameKana, string displayName, int taxAtSourceCalcType, string contactName, int? headCount, string corporateNumber, string txnNumberFormat, bool privateSettlement, int minusFormat, string role, string phone1, string phone2, string fax, string zipcode, int prefectureCode, string streetName1, string streetName2, int invoiceLayout, int invoiceStyle, int amountFraction, string industryClass, string industryCode, string workflowSetting, int? defaultWalletAccountId = default(int?), IList<FiscalYears> fiscalYears = default(IList<FiscalYears>))
        {
            Id = id;
            Name = name;
            NameKana = nameKana;
        ...
        /// <summary>
        /// </summary>
        [JsonProperty(PropertyName = "fiscal_years")]
        public IList<FiscalYears> FiscalYears { get; set; }
