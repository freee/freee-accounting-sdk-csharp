...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class Deals :  IEquatable<Deals>
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>取引の+更新行</value>
        [DataMember(Name="renews", EmitDefaultValue=false)]
        public List<DealsRenews> Renews { get; set; }
        ...
        {
            return this.Equals(input as Deals);
        }

        /// <summary>
        /// Returns true if Deals instances are equal
        /// </summary>
        /// <param name="input">Instance of Deals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Deals input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Renews == input.Renews ||
                    this.Renews != null &&
                    input.Renews != null &&
                    this.Renews.SequenceEqual(input.Renews)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Renews != null)
                    hashCode = hashCode * 59 + this.Renews.GetHashCode();
