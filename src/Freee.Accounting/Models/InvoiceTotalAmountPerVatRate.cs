...
namespace Freee.Accounting.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceTotalAmountPerVatRate" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceTotalAmountPerVatRate() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceTotalAmountPerVatRate" /> class.
        /// </summary>
        ...
        public InvoiceTotalAmountPerVatRate(int vat5 = default(int), int vat8 = default(int), int reducedVat8 = default(int), int vat10 = default(int))
        {
            this.Vat5 = vat5;
            this.Vat8 = vat8;
        ...
        {
            return this.Equals(input as InvoiceTotalAmountPerVatRate);
        }

        /// <summary>
        /// Returns true if InvoiceTotalAmountPerVatRate instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceTotalAmountPerVatRate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceTotalAmountPerVatRate input)
        {
            if (input == null)
                return false;
