...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCompanyParamsAddressAttributes :  IEquatable<UpdateCompanyParamsAddressAttributes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCompanyParamsAddressAttributes" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateCompanyParamsAddressAttributes);
        }

        /// <summary>
        /// Returns true if UpdateCompanyParamsAddressAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCompanyParamsAddressAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCompanyParamsAddressAttributes input)
        {
            if (input == null)
                return false;
