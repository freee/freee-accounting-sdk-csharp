...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSegment_3TagsResponse_trial_cr_segment_3_tags_segment_3_tags")]
    public partial class TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags : IEquatable<TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags);
        }

        /// <summary>
        /// Returns true if TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags input)
        {
            if (input == null)
            {
                return false;
