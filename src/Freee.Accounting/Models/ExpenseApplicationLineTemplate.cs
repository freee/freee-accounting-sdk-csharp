...
namespace Freee.Accounting.Models
{
    ...
    public partial class ExpenseApplicationLineTemplate :  IEquatable<ExpenseApplicationLineTemplate>
    {
        ...
        public ExpenseApplicationLineTemplate(int id = default(int), string name = default(string), int accountItemId = default(int), string accountItemName = default(string), int taxCode = default(int), string taxName = default(string), string description = default(string), string lineDescription = default(string))
        {
            this.Id = id;
