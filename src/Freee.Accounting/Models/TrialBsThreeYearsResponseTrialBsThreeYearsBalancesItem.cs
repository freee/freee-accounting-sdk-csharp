...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem class.
        /// </summary>
        public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem()
        {
            CustomInit();
        }
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem(int? accountItemId = default(int?), string accountItemName = default(string), IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemPartnersItem> partners = default(IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemPartnersItem>), IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem> items = default(IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem>), int? accountCategoryId = default(int?), string accountCategoryName = default(string), bool? totalLine = default(bool?), int? hierarchyLevel = default(int?), int? parentAccountCategoryId = default(int?), string parentAccountCategoryName = default(string), int? twoYearsBeforeClosingBalance = default(int?), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
        ...
        public IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemPartnersItem> Partners { get; set; }
        ...
        public IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem> Items { get; set; }
