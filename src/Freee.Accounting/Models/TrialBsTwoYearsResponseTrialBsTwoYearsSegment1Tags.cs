...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsTwoYearsResponse_trial_bs_two_years_segment_1_tags")]
    public partial class TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags : IEquatable<TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags" /> class.
        /// </summary>
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags);
        }

        /// <summary>
        /// Returns true if TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsTwoYearsResponseTrialBsTwoYearsSegment1Tags input)
        {
            if (input == null)
            {
                return false;
