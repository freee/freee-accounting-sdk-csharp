...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoicesUpdateParamsInvoiceContents :  IEquatable<InvoicesUpdateParamsInvoiceContents>
    {
        /// <summary>
        /// 行の種類
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicesUpdateParamsInvoiceContents" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoicesUpdateParamsInvoiceContents() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicesUpdateParamsInvoiceContents" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as InvoicesUpdateParamsInvoiceContents);
        }

        /// <summary>
        /// Returns true if InvoicesUpdateParamsInvoiceContents instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoicesUpdateParamsInvoiceContents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoicesUpdateParamsInvoiceContents input)
        {
            if (input == null)
                return false;
