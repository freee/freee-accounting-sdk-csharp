...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrTwoYearsResponse_trial_cr_two_years_partners")]
    public partial class TrialCrTwoYearsResponseTrialCrTwoYearsPartners : IEquatable<TrialCrTwoYearsResponseTrialCrTwoYearsPartners>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsPartners" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrTwoYearsResponseTrialCrTwoYearsPartners() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsPartners" /> class.
        /// </summary>
        ...
        public TrialCrTwoYearsResponseTrialCrTwoYearsPartners(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrTwoYearsResponseTrialCrTwoYearsPartners);
        }

        /// <summary>
        /// Returns true if TrialCrTwoYearsResponseTrialCrTwoYearsPartners instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrTwoYearsResponseTrialCrTwoYearsPartners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrTwoYearsResponseTrialCrTwoYearsPartners input)
        {
            if (input == null)
            {
                return false;
