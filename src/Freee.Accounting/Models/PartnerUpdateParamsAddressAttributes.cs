...
namespace Freee.Accounting.Models
{
    ...
    public partial class PartnerUpdateParamsAddressAttributes
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PartnerUpdateParamsAddressAttributes class.
        /// </summary>
        public PartnerUpdateParamsAddressAttributes()
        {
            CustomInit();
        }
        ...
        public PartnerUpdateParamsAddressAttributes(string zipcode = default(string), int? prefectureCode = default(int?), string streetName1 = default(string), string streetName2 = default(string))
        {
            Zipcode = zipcode;
