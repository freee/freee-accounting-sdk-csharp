...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_segment_1_tags")]
    public partial class TrialBsResponseTrialBsSegment1Tags : IEquatable<TrialBsResponseTrialBsSegment1Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSegment1Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsResponseTrialBsSegment1Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSegment1Tags" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsSegment1Tags(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsSegment1Tags);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsSegment1Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsSegment1Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsSegment1Tags input)
        {
            if (input == null)
            {
                return false;
