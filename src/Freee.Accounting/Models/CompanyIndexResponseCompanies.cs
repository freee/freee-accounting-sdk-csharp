...
namespace Freee.Accounting.Models
{
    ...
    public partial class CompanyIndexResponseCompanies : IEquatable<CompanyIndexResponseCompanies>
    {
        ...
        public CompanyIndexResponseCompanies(string displayName = default(string), int id = default(int), string name = default(string), string nameKana = default(string), RoleEnum role = default(RoleEnum))
        {
            ...
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for CompanyIndexResponseCompanies and cannot be null");
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CompanyIndexResponseCompanies and cannot be null");
            // to ensure "nameKana" is required (not null)
            this.NameKana = nameKana ?? throw new ArgumentNullException("nameKana is a required property for CompanyIndexResponseCompanies and cannot be null");
            this.Role = role;
        }
