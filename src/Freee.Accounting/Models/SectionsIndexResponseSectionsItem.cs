...
namespace Freee.Accounting.Models
{
    ...
    public partial class SectionsIndexResponseSectionsItem
    {
        /// <summary>
        /// Initializes a new instance of the SectionsIndexResponseSectionsItem
        /// class.
        /// </summary>
        public SectionsIndexResponseSectionsItem()
        {
            CustomInit();
        }
        ...
        public SectionsIndexResponseSectionsItem(int id, string name, int companyId, string longName = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            Id = id;
            Name = name;
            LongName = longName;
