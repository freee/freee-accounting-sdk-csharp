...
namespace Freee.Accounting.Models
{
    ...
    public partial class Deal : IEquatable<Deal>
    {
        ...
        public Deal(long amount = default(long), int companyId = default(int), List<DealDetails> details = default(List<DealDetails>), int dueAmount = default(int), string dueDate = default(string), int id = default(int), string issueDate = default(string), string partnerCode = default(string), int partnerId = default(int), List<DealPayments> payments = default(List<DealPayments>), List<DealReceipts> receipts = default(List<DealReceipts>), string refNumber = default(string), List<DealRenews> renews = default(List<DealRenews>), StatusEnum status = default(StatusEnum), TypeEnum? type = default(TypeEnum?))
        {
            ...
            if (issueDate == null)
            {
                throw new ArgumentNullException("issueDate is a required property for Deal and cannot be null");
            }
        ...
        public List<DealReceipts> Receipts { get; set; }
        ...
        public List<DealRenews> Renews { get; set; }
