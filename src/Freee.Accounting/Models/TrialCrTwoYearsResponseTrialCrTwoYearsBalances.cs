...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrTwoYearsResponse_trial_cr_two_years_balances")]
    public partial class TrialCrTwoYearsResponseTrialCrTwoYearsBalances : IEquatable<TrialCrTwoYearsResponseTrialCrTwoYearsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsBalances" /> class.
        /// </summary>
        ...
        public TrialCrTwoYearsResponseTrialCrTwoYearsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), List<TrialCrTwoYearsResponseTrialCrTwoYearsItems> items = default(List<TrialCrTwoYearsResponseTrialCrTwoYearsItems>), int lastYearClosingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialCrTwoYearsResponseTrialCrTwoYearsPartners> partners = default(List<TrialCrTwoYearsResponseTrialCrTwoYearsPartners>), List<TrialBsTwoYearsResponseTrialBsTwoYearsSections> sections = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsSections>), List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags> segment1Tags = default(List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags>), List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment2Tags> segment2Tags = default(List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment2Tags>), List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment3Tags> segment3Tags = default(List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment3Tags>), bool totalLine = default(bool), decimal yearOnYear = default(decimal))
        {
        ...
        public List<TrialCrTwoYearsResponseTrialCrTwoYearsItems> Items { get; set; }
        ...
        public List<TrialCrTwoYearsResponseTrialCrTwoYearsPartners> Partners { get; set; }
        ...
        public List<TrialBsTwoYearsResponseTrialBsTwoYearsSections> Sections { get; set; }
        ...
        public List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags> Segment1Tags { get; set; }
        ...
        public List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment2Tags> Segment2Tags { get; set; }
        ...
        public List<TrialCrTwoYearsResponseTrialCrTwoYearsSegment3Tags> Segment3Tags { get; set; }
        ...
        {
            return this.Equals(input as TrialCrTwoYearsResponseTrialCrTwoYearsBalances);
        }

        /// <summary>
        /// Returns true if TrialCrTwoYearsResponseTrialCrTwoYearsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrTwoYearsResponseTrialCrTwoYearsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrTwoYearsResponseTrialCrTwoYearsBalances input)
        {
            if (input == null)
            {
                return false;
