...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>
    {
        ...
        public InlineResponse2002(List<Deal> deals = default(List<Deal>), InlineResponse2002Meta meta = default(InlineResponse2002Meta))
        {
            // to ensure "deals" is required (not null)
            this.Deals = deals ?? throw new ArgumentNullException("deals is a required property for InlineResponse2002 and cannot be null");
            // to ensure "meta" is required (not null)
            this.Meta = meta ?? throw new ArgumentNullException("meta is a required property for InlineResponse2002 and cannot be null");
        }
