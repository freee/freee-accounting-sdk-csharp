...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "expenseApplicationActionCreateParams")]
    public partial class ExpenseApplicationActionCreateParams : IEquatable<ExpenseApplicationActionCreateParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseApplicationActionCreateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpenseApplicationActionCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseApplicationActionCreateParams" /> class.
        /// </summary>
        ...
        /// <param name="targetRound">対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。経費申請の取得APIレスポンス.current_roundを送信してください。 (required).</param>
        /// <param name="targetStepId">対象承認ステップID 経費申請の取得APIレスポンス.current_step_idを送信してください。 (required).</param>
        public ExpenseApplicationActionCreateParams(ApprovalActionEnum approvalAction = default(ApprovalActionEnum), int companyId = default(int), int? nextApproverId = default(int?), int targetRound = default(int), int targetStepId = default(int))
        {
        ...
        /// </summary>
        /// <value>対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。経費申請の取得APIレスポンス.current_roundを送信してください。</value>
        ...
        /// </summary>
        /// <value>対象承認ステップID 経費申請の取得APIレスポンス.current_step_idを送信してください。</value>
        ...
        {
            return this.Equals(input as ExpenseApplicationActionCreateParams);
        }

        /// <summary>
        /// Returns true if ExpenseApplicationActionCreateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseApplicationActionCreateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseApplicationActionCreateParams input)
        {
            if (input == null)
            {
                return false;
