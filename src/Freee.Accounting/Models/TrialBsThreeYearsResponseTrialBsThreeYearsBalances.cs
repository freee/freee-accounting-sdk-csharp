...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsThreeYearsResponse_trial_bs_three_years_balances")]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsBalances : IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsBalances>
    {
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), List<TrialBsThreeYearsResponseTrialBsThreeYearsItems> items = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsItems>), int lastYearClosingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners> partners = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>), List<TrialBsThreeYearsResponseTrialBsThreeYearsSections> sections = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsSections>), List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags> segment1Tags = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags>), List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags> segment2Tags = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags>), List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags> segment3Tags = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags>), bool totalLine = default(bool), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
        ...
        public List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment1Tags> Segment1Tags { get; set; }
        ...
        public List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags> Segment2Tags { get; set; }
        ...
        public List<TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags> Segment3Tags { get; set; }
