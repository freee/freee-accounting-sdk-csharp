...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsBalances :  IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsBalances" /> class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsBalances(int accountItemId = default(int), string accountItemName = default(string), List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners> partners = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>), List<TrialBsThreeYearsResponseTrialBsThreeYearsItems> items = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsItems>), int accountCategoryId = default(int), string accountCategoryName = default(string), bool totalLine = default(bool), int hierarchyLevel = default(int), int parentAccountCategoryId = default(int), string parentAccountCategoryName = default(string), int twoYearsBeforeClosingBalance = default(int), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
        ...
        {
            return this.Equals(input as TrialBsThreeYearsResponseTrialBsThreeYearsBalances);
        }

        /// <summary>
        /// Returns true if TrialBsThreeYearsResponseTrialBsThreeYearsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsThreeYearsResponseTrialBsThreeYearsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsThreeYearsResponseTrialBsThreeYearsBalances input)
        {
            if (input == null)
                return false;
