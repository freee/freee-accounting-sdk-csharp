...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersMeResponseUserCompanies :  IEquatable<UsersMeResponseUserCompanies>
    {
        /// <summary>
        /// ユーザーの権限
        /// </summary>
        ...
        protected UsersMeResponseUserCompanies() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersMeResponseUserCompanies" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UsersMeResponseUserCompanies);
        }

        /// <summary>
        /// Returns true if UsersMeResponseUserCompanies instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersMeResponseUserCompanies to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersMeResponseUserCompanies input)
        {
            if (input == null)
                return false;
