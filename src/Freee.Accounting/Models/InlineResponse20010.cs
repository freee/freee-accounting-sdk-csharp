...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20010 :  IEquatable<InlineResponse20010>
    {
        ...
        public InlineResponse20010(List<Section> sections = default(List<Section>))
        {
            // to ensure "sections" is required (not null)
            this.Sections = sections ?? throw new ArgumentNullException("sections is a required property for InlineResponse20010 and cannot be null");
        }
