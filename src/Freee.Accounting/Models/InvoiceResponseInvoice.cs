...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "invoiceResponse_invoice")]
    public partial class InvoiceResponseInvoice : IEquatable<InvoiceResponseInvoice>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceResponseInvoice" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected InvoiceResponseInvoice() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoiceResponseInvoice" /> class.
        /// </summary>
        ...
        /// <param name="relatedQuotationIds">関連する見積書ID(配列)&lt;br&gt; 下記で作成したものが該当します。  &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/203318410#1-2\&quot; target&#x3D;\&quot;_blank\&quot;&gt;見積書・納品書を納品書・請求書に変換する&lt;/a&gt;&lt;br&gt; &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/209076226\&quot; target&#x3D;\&quot;_blank\&quot;&gt;複数の見積書・納品書から合算請求書を作成する&lt;/a&gt;&lt;br&gt; .</param>
        ...
        public InvoiceResponseInvoice(string bookingDate = default(string), string companyAddress1 = default(string), string companyAddress2 = default(string), string companyContactInfo = default(string), int companyId = default(int), string companyName = default(string), int? companyPrefectureCode = default(int?), string companyPrefectureName = default(string), string companyZipcode = default(string), int? dealId = default(int?), string description = default(string), string dueDate = default(string), int id = default(int), List<InvoiceIndexResponseInvoiceContents> invoiceContents = default(List<InvoiceIndexResponseInvoiceContents>), InvoiceLayoutEnum invoiceLayout = default(InvoiceLayoutEnum), string invoiceNumber = default(string), InvoiceStatusEnum invoiceStatus = default(InvoiceStatusEnum), string issueDate = default(string), string mailSentAt = default(string), string message = default(string), string notes = default(string), string partnerAddress1 = default(string), string partnerAddress2 = default(string), string partnerCode = default(string), string partnerContactInfo = default(string), string partnerDisplayName = default(string), int? partnerId = default(int?), string partnerName = default(string), int? partnerPrefectureCode = default(int?), string partnerPrefectureName = default(string), string partnerTitle = default(string), string partnerZipcode = default(string), string paymentBankInfo = default(string), string paymentDate = default(string), PaymentStatusEnum? paymentStatus = default(PaymentStatusEnum?), PaymentTypeEnum paymentType = default(PaymentTypeEnum), PostingStatusEnum postingStatus = default(PostingStatusEnum), List<int> relatedQuotationIds = default(List<int>), int subTotal = default(int), TaxEntryMethodEnum taxEntryMethod = default(TaxEntryMethodEnum), string title = default(string), int totalAmount = default(int), InvoiceIndexResponseTotalAmountPerVatRate totalAmountPerVatRate = default(InvoiceIndexResponseTotalAmountPerVatRate), int totalVat = default(int), string webConfirmedAt = default(string), string webDownloadedAt = default(string), string webPublishedAt = default(string))
        {
            ...
            {
                throw new ArgumentNullException("invoiceNumber is a required property for InvoiceResponseInvoice and cannot be null");
            }
            ...
            if (issueDate == null)
            {
                throw new ArgumentNullException("issueDate is a required property for InvoiceResponseInvoice and cannot be null");
            }
            this.IssueDate = issueDate;
            // to ensure "partnerId" is required (not null)
            if (partnerId == null)
            {
                throw new ArgumentNullException("partnerId is a required property for InvoiceResponseInvoice and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("totalAmountPerVatRate is a required property for InvoiceResponseInvoice and cannot be null");
            }
        ...
        /// </summary>
        /// <value>関連する見積書ID(配列)&lt;br&gt; 下記で作成したものが該当します。  &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/203318410#1-2\&quot; target&#x3D;\&quot;_blank\&quot;&gt;見積書・納品書を納品書・請求書に変換する&lt;/a&gt;&lt;br&gt; &lt;a href&#x3D;\&quot;https://support.freee.co.jp/hc/ja/articles/209076226\&quot; target&#x3D;\&quot;_blank\&quot;&gt;複数の見積書・納品書から合算請求書を作成する&lt;/a&gt;&lt;br&gt; </value>
        [DataMember(Name = "related_quotation_ids", EmitDefaultValue = false)]
        public List<int> RelatedQuotationIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RelatedQuotationIds: ").Append(RelatedQuotationIds).Append("\n");
        ...
        {
            return this.Equals(input as InvoiceResponseInvoice);
        }

        /// <summary>
        /// Returns true if InvoiceResponseInvoice instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoiceResponseInvoice to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoiceResponseInvoice input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.RelatedQuotationIds == input.RelatedQuotationIds ||
                    this.RelatedQuotationIds != null &&
                    input.RelatedQuotationIds != null &&
                    this.RelatedQuotationIds.SequenceEqual(input.RelatedQuotationIds)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                {
                    hashCode = (hashCode * 59) + this.RelatedQuotationIds.GetHashCode();
                }
