...
namespace Freee.Accounting.Models
{
    ...
    public partial class ExpenseApplicationResponseExpenseApplication : IEquatable<ExpenseApplicationResponseExpenseApplication>
    {
        ...
        public ExpenseApplicationResponseExpenseApplication(int companyId = default(int), int? dealId = default(int?), DealStatusEnum dealStatus = default(DealStatusEnum), string description = default(string), bool editableOnWeb = default(bool), List<ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines> expenseApplicationLines = default(List<ExpenseApplicationResponseExpenseApplicationExpenseApplicationLines>), int id = default(int), string issueDate = default(string), int? sectionId = default(int?), StatusEnum status = default(StatusEnum), List<int> tagIds = default(List<int>), string title = default(string), int totalAmount = default(int))
        {
            this.CompanyId = companyId;
            // to ensure "dealId" is required (not null)
            this.DealId = dealId ?? throw new ArgumentNullException("dealId is a required property for ExpenseApplicationResponseExpenseApplication and cannot be null");
            this.DealStatus = dealStatus;
            this.EditableOnWeb = editableOnWeb;
            // to ensure "expenseApplicationLines" is required (not null)
            this.ExpenseApplicationLines = expenseApplicationLines ?? throw new ArgumentNullException("expenseApplicationLines is a required property for ExpenseApplicationResponseExpenseApplication and cannot be null");
            this.Id = id;
            // to ensure "issueDate" is required (not null)
            this.IssueDate = issueDate ?? throw new ArgumentNullException("issueDate is a required property for ExpenseApplicationResponseExpenseApplication and cannot be null");
            this.Status = status;
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for ExpenseApplicationResponseExpenseApplication and cannot be null");
