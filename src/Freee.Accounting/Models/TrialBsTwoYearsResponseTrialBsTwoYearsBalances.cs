...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsTwoYearsResponseTrialBsTwoYearsBalances :  IEquatable<TrialBsTwoYearsResponseTrialBsTwoYearsBalances>
    {
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsBalances(int accountItemId = default(int), string accountItemName = default(string), List<TrialBsTwoYearsResponseTrialBsTwoYearsPartners> partners = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsPartners>), List<TrialBsTwoYearsResponseTrialBsTwoYearsItems> items = default(List<TrialBsTwoYearsResponseTrialBsTwoYearsItems>), int accountCategoryId = default(int), string accountCategoryName = default(string), bool totalLine = default(bool), int hierarchyLevel = default(int), int parentAccountCategoryId = default(int), string parentAccountCategoryName = default(string), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
        ...
        {
            return this.Equals(input as TrialBsTwoYearsResponseTrialBsTwoYearsBalances);
        }

        /// <summary>
        /// Returns true if TrialBsTwoYearsResponseTrialBsTwoYearsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsTwoYearsResponseTrialBsTwoYearsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsTwoYearsResponseTrialBsTwoYearsBalances input)
        {
            if (input == null)
                return false;
