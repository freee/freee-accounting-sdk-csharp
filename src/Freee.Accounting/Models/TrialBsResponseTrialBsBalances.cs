...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsResponseTrialBsBalances : IEquatable<TrialBsResponseTrialBsBalances>
    {
        ...
        public TrialBsResponseTrialBsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int hierarchyLevel = default(int), List<TrialBsResponseTrialBsItems> items = default(List<TrialBsResponseTrialBsItems>), int openingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialBsResponseTrialBsPartners> partners = default(List<TrialBsResponseTrialBsPartners>), bool totalLine = default(bool))
        {
