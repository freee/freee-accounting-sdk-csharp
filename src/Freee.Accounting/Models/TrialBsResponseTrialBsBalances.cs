...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsResponseTrialBsBalances :  IEquatable<TrialBsResponseTrialBsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsBalances" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsBalances(int accountItemId = default(int), string accountItemName = default(string), List<TrialBsResponseTrialBsPartners> partners = default(List<TrialBsResponseTrialBsPartners>), List<TrialBsResponseTrialBsItems> items = default(List<TrialBsResponseTrialBsItems>), int accountCategoryId = default(int), string accountCategoryName = default(string), bool totalLine = default(bool), int hierarchyLevel = default(int), int parentAccountCategoryId = default(int), string parentAccountCategoryName = default(string), int openingBalance = default(int), int debitAmount = default(int), int creditAmount = default(int), int closingBalance = default(int), decimal compositionRatio = default(decimal))
        {
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsBalances);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsBalances input)
        {
            if (input == null)
                return false;
