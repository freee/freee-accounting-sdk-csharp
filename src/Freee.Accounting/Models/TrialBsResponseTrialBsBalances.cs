...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_balances")]
    public partial class TrialBsResponseTrialBsBalances : IEquatable<TrialBsResponseTrialBsBalances>
    {
        ...
        public TrialBsResponseTrialBsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int hierarchyLevel = default(int), List<TrialBsResponseTrialBsItems> items = default(List<TrialBsResponseTrialBsItems>), int openingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialBsResponseTrialBsPartners> partners = default(List<TrialBsResponseTrialBsPartners>), List<TrialBsResponseTrialBsSections> sections = default(List<TrialBsResponseTrialBsSections>), List<TrialBsResponseTrialBsSegment1Tags> segment1Tags = default(List<TrialBsResponseTrialBsSegment1Tags>), List<TrialBsResponseTrialBsSegment2Tags> segment2Tags = default(List<TrialBsResponseTrialBsSegment2Tags>), List<TrialBsResponseTrialBsSegment3Tags> segment3Tags = default(List<TrialBsResponseTrialBsSegment3Tags>), bool totalLine = default(bool))
        {
        ...
        public List<TrialBsResponseTrialBsSegment1Tags> Segment1Tags { get; set; }
        ...
        public List<TrialBsResponseTrialBsSegment2Tags> Segment2Tags { get; set; }
        ...
        public List<TrialBsResponseTrialBsSegment3Tags> Segment3Tags { get; set; }
