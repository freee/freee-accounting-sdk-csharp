...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialPlTwoYearsResponseTrialPlTwoYears :  IEquatable<TrialPlTwoYearsResponseTrialPlTwoYears>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlTwoYearsResponseTrialPlTwoYears" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlTwoYearsResponseTrialPlTwoYears() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlTwoYearsResponseTrialPlTwoYears" /> class.
        /// </summary>
        ...
        public List<TrialPlTwoYearsResponseTrialPlTwoYearsBalances> Balances { get; set; }
        ...
        {
            return this.Equals(input as TrialPlTwoYearsResponseTrialPlTwoYears);
        }

        /// <summary>
        /// Returns true if TrialPlTwoYearsResponseTrialPlTwoYears instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlTwoYearsResponseTrialPlTwoYears to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlTwoYearsResponseTrialPlTwoYears input)
        {
            if (input == null)
                return false;
