...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlTwoYearsResponseTrialPlTwoYears
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlTwoYearsResponseTrialPlTwoYears class.
        /// </summary>
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYears(int companyId, IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem> balances, int? fiscalYear = default(int?), int? startMonth = default(int?), int? endMonth = default(int?), string startDate = default(string), string endDate = default(string), string accountItemDisplayType = default(string), string breakdownDisplayType = default(string), int? partnerId = default(int?), string partnerCode = default(string), int? itemId = default(int?), int? sectionId = default(int?), string adjustment = default(string), string costAllocation = default(string), string createdAt = default(string))
        {
            CompanyId = companyId;
        ...
        public IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem> Balances { get; set; }
