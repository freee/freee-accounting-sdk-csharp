...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSegment_3TagsResponse_trial_cr_segment_3_tags_balances")]
    public partial class TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances : IEquatable<TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances" /> class.
        /// </summary>
        ...
        public List<TrialCrSegment3TagsResponseTrialCrSegment3TagsSegment3Tags> Segment3Tags { get; set; }
        ...
        {
            return this.Equals(input as TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances);
        }

        /// <summary>
        /// Returns true if TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSegment3TagsResponseTrialCrSegment3TagsBalances input)
        {
            if (input == null)
            {
                return false;
