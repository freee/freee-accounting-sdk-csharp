...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialPlThreeYearsResponseTrialPlThreeYears :  IEquatable<TrialPlThreeYearsResponseTrialPlThreeYears>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlThreeYearsResponseTrialPlThreeYears" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlThreeYearsResponseTrialPlThreeYears() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlThreeYearsResponseTrialPlThreeYears" /> class.
        /// </summary>
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYears(int companyId = default(int), bool upToDate = default(bool), int fiscalYear = default(int), int startMonth = default(int), int endMonth = default(int), string startDate = default(string), string endDate = default(string), AccountItemDisplayTypeEnum? accountItemDisplayType = default(AccountItemDisplayTypeEnum?), BreakdownDisplayTypeEnum? breakdownDisplayType = default(BreakdownDisplayTypeEnum?), int partnerId = default(int), string partnerCode = default(string), int itemId = default(int), int sectionId = default(int), AdjustmentEnum? adjustment = default(AdjustmentEnum?), CostAllocationEnum? costAllocation = default(CostAllocationEnum?), string createdAt = default(string), List<TrialPlThreeYearsResponseTrialPlThreeYearsBalances> balances = default(List<TrialPlThreeYearsResponseTrialPlThreeYearsBalances>))
        {
            this.CompanyId = companyId;
            this.UpToDate = upToDate;
            // to ensure "balances" is required (not null)
            this.Balances = balances ?? throw new ArgumentNullException("balances is a required property for TrialPlThreeYearsResponseTrialPlThreeYears and cannot be null");;
        ...
        {
            return this.Equals(input as TrialPlThreeYearsResponseTrialPlThreeYears);
        }

        /// <summary>
        /// Returns true if TrialPlThreeYearsResponseTrialPlThreeYears instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlThreeYearsResponseTrialPlThreeYears to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlThreeYearsResponseTrialPlThreeYears input)
        {
            if (input == null)
                return false;
