...
namespace Freee.Accounting.Models
{
    ...
    public partial class Partner :  IEquatable<Partner>
    {
        ...
        public Partner(int id = default(int), string code = default(string), int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string), string longName = default(string), string nameKana = default(string), string defaultTitle = default(string), string phone = default(string), string contactName = default(string), string email = default(string), string addressAttributesZipcode = default(string), int addressAttributesPrefectureCode = default(int), string addressAttributesStreetName1 = default(string), string addressAttributesStreetName2 = default(string), PartnerDocSettingAttributesSendingMethodEnum? partnerDocSettingAttributesSendingMethod = default(PartnerDocSettingAttributesSendingMethodEnum?), string partnerBankAccountAttributesBankName = default(string), string partnerBankAccountAttributesBankNameKana = default(string), string partnerBankAccountAttributesBankCode = default(string), string partnerBankAccountAttributesBranchName = default(string), string partnerBankAccountAttributesBranchKana = default(string), string partnerBankAccountAttributesBranchCode = default(string), PartnerBankAccountAttributesAccountTypeEnum? partnerBankAccountAttributesAccountType = default(PartnerBankAccountAttributesAccountTypeEnum?), string partnerBankAccountAttributesAccountNumber = default(string), string partnerBankAccountAttributesAccountName = default(string), string partnerBankAccountAttributesLongAccountName = default(string))
        {
            this.Id = id;
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for Partner and cannot be null");;
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Partner and cannot be null");;
