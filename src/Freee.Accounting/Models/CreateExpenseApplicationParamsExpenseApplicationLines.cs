...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateExpenseApplicationParamsExpenseApplicationLines :  IEquatable<CreateExpenseApplicationParamsExpenseApplicationLines>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateExpenseApplicationParamsExpenseApplicationLines" /> class.
        /// </summary>
        ...
        public CreateExpenseApplicationParamsExpenseApplicationLines(string transactionDate = default(string), string description = default(string), int amount = default(int), int expenseApplicationLineTemplateId = default(int), int receiptId = default(int))
        {
        ...
        {
            return this.Equals(input as CreateExpenseApplicationParamsExpenseApplicationLines);
        }

        /// <summary>
        /// Returns true if CreateExpenseApplicationParamsExpenseApplicationLines instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateExpenseApplicationParamsExpenseApplicationLines to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateExpenseApplicationParamsExpenseApplicationLines input)
        {
            if (input == null)
                return false;
