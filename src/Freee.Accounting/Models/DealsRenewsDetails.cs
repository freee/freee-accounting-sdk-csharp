...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DealsRenewsDetails :  IEquatable<DealsRenewsDetails>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsRenewsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsRenewsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsRenewsDetails" /> class.
        /// </summary>
        ...
        public DealsRenewsDetails(int id = default(int), EntrySideEnum entrySide = default(EntrySideEnum), int accountItemId = default(int), int taxCode = default(int), int? itemId = default(int?), int? sectionId = default(int?), List<int> tagIds = default(List<int>), int? segment1TagId = default(int?), int? segment2TagId = default(int?), int? segment3TagId = default(int?), int amount = default(int), int vat = default(int), string description = default(string))
        {
            this.Id = id;
            ...
            this.TagIds = tagIds ?? throw new ArgumentNullException("tagIds is a required property for DealsRenewsDetails and cannot be null");;
            this.Amount = amount;
            this.Vat = vat;
            this.ItemId = itemId;
        ...
        {
            return this.Equals(input as DealsRenewsDetails);
        }

        /// <summary>
        /// Returns true if DealsRenewsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsRenewsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsRenewsDetails input)
        {
            if (input == null)
                return false;
