...
namespace Freee.Accounting.Models
{
    ...
    public partial class SegmentTagParams :  IEquatable<SegmentTagParams>
    {
        ...
        public SegmentTagParams(int companyId = default(int), string name = default(string), string description = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SegmentTagParams and cannot be null");;
