...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrResponse_trial_cr_partners")]
    public partial class TrialCrResponseTrialCrPartners : IEquatable<TrialCrResponseTrialCrPartners>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrResponseTrialCrPartners" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrResponseTrialCrPartners() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrResponseTrialCrPartners" /> class.
        /// </summary>
        ...
        public TrialCrResponseTrialCrPartners(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrResponseTrialCrPartners);
        }

        /// <summary>
        /// Returns true if TrialCrResponseTrialCrPartners instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrResponseTrialCrPartners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrResponseTrialCrPartners input)
        {
            if (input == null)
            {
                return false;
