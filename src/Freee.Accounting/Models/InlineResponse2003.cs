...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2003 : IEquatable<InlineResponse2003>
    {
        ...
        public InlineResponse2003(List<ExpenseApplicationLineTemplate> expenseApplicationLineTemplates = default(List<ExpenseApplicationLineTemplate>))
        {
            // to ensure "expenseApplicationLineTemplates" is required (not null)
            this.ExpenseApplicationLineTemplates = expenseApplicationLineTemplates ?? throw new ArgumentNullException("expenseApplicationLineTemplates is a required property for InlineResponse2003 and cannot be null");
        }
