...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialPlThreeYearsResponseTrialPlThreeYearsSections :  IEquatable<TrialPlThreeYearsResponseTrialPlThreeYearsSections>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlThreeYearsResponseTrialPlThreeYearsSections" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlThreeYearsResponseTrialPlThreeYearsSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlThreeYearsResponseTrialPlThreeYearsSections" /> class.
        /// </summary>
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYearsSections(int id = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialPlThreeYearsResponseTrialPlThreeYearsSections);
        }

        /// <summary>
        /// Returns true if TrialPlThreeYearsResponseTrialPlThreeYearsSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlThreeYearsResponseTrialPlThreeYearsSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlThreeYearsResponseTrialPlThreeYearsSections input)
        {
            if (input == null)
                return false;
