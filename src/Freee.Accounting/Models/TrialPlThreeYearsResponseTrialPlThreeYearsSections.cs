...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlThreeYearsResponse_trial_pl_three_years_sections")]
    public partial class TrialPlThreeYearsResponseTrialPlThreeYearsSections : IEquatable<TrialPlThreeYearsResponseTrialPlThreeYearsSections>
    {
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYearsSections(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
