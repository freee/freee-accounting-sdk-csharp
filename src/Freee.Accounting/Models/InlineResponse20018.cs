...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20018 :  IEquatable<InlineResponse20018>
    {
        ...
        public InlineResponse20018(List<WalletTxn> walletTxns = default(List<WalletTxn>))
        {
            // to ensure "walletTxns" is required (not null)
            this.WalletTxns = walletTxns ?? throw new ArgumentNullException("walletTxns is a required property for InlineResponse20018 and cannot be null");
        }
