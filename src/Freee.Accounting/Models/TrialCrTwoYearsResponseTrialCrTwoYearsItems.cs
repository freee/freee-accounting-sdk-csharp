...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrTwoYearsResponse_trial_cr_two_years_items")]
    public partial class TrialCrTwoYearsResponseTrialCrTwoYearsItems : IEquatable<TrialCrTwoYearsResponseTrialCrTwoYearsItems>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrTwoYearsResponseTrialCrTwoYearsItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsItems" /> class.
        /// </summary>
        ...
        public TrialCrTwoYearsResponseTrialCrTwoYearsItems(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrTwoYearsResponseTrialCrTwoYearsItems);
        }

        /// <summary>
        /// Returns true if TrialCrTwoYearsResponseTrialCrTwoYearsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrTwoYearsResponseTrialCrTwoYearsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrTwoYearsResponseTrialCrTwoYearsItems input)
        {
            if (input == null)
            {
                return false;
