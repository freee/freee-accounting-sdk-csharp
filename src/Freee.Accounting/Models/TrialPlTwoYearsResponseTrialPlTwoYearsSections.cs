...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlTwoYearsResponse_trial_pl_two_years_sections")]
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsSections : IEquatable<TrialPlTwoYearsResponseTrialPlTwoYearsSections>
    {
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsSections(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
