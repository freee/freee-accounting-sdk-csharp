...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsSections :  IEquatable<TrialPlTwoYearsResponseTrialPlTwoYearsSections>
    {
        ...
        protected TrialPlTwoYearsResponseTrialPlTwoYearsSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlTwoYearsResponseTrialPlTwoYearsSections" /> class.
        /// </summary>
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsSections(int id = default(int), string name = default(string), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialPlTwoYearsResponseTrialPlTwoYearsSections);
        }

        /// <summary>
        /// Returns true if TrialPlTwoYearsResponseTrialPlTwoYearsSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlTwoYearsResponseTrialPlTwoYearsSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlTwoYearsResponseTrialPlTwoYearsSections input)
        {
            if (input == null)
                return false;
