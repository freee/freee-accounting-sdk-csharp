...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateExpenseApplicationParamsExpenseApplicationLines :  IEquatable<UpdateExpenseApplicationParamsExpenseApplicationLines>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateExpenseApplicationParamsExpenseApplicationLines" /> class.
        /// </summary>
        ...
        public UpdateExpenseApplicationParamsExpenseApplicationLines(int id = default(int), string transactionDate = default(string), string description = default(string), int amount = default(int), int expenseApplicationLineTemplateId = default(int), int receiptId = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as UpdateExpenseApplicationParamsExpenseApplicationLines);
        }

        /// <summary>
        /// Returns true if UpdateExpenseApplicationParamsExpenseApplicationLines instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateExpenseApplicationParamsExpenseApplicationLines to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateExpenseApplicationParamsExpenseApplicationLines input)
        {
            if (input == null)
                return false;
