...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsTwoYearsResponse :  IEquatable<TrialBsTwoYearsResponse>
    {
        ...
        public TrialBsTwoYearsResponse(TrialBsTwoYearsResponseTrialBsTwoYears trialBsTwoYears = default(TrialBsTwoYearsResponseTrialBsTwoYears))
        {
            // to ensure "trialBsTwoYears" is required (not null)
            this.TrialBsTwoYears = trialBsTwoYears ?? throw new ArgumentNullException("trialBsTwoYears is a required property for TrialBsTwoYearsResponse and cannot be null");;
        }
        
        /// <summary>
        /// Gets or Sets TrialBsTwoYears
        /// </summary>
        [DataMember(Name="trial_bs_two_years", EmitDefaultValue=false)]
