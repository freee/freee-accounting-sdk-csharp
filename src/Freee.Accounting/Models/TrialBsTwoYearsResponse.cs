...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsTwoYearsResponse :  IEquatable<TrialBsTwoYearsResponse>
    {
        ...
        public TrialBsTwoYearsResponse(TrialBsTwoYearsResponseTrialBsTwoYears trialBsTwoYears = default(TrialBsTwoYearsResponseTrialBsTwoYears), bool upToDate = default(bool))
        {
