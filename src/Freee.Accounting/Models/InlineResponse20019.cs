...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20019 :  IEquatable<InlineResponse20019>
    {
        ...
        public InlineResponse20019(InlineResponse20019Meta meta = default(InlineResponse20019Meta), List<Walletable> walletables = default(List<Walletable>))
        {
            // to ensure "walletables" is required (not null)
            this.Walletables = walletables ?? throw new ArgumentNullException("walletables is a required property for InlineResponse20019 and cannot be null");
            this.Meta = meta;
        }
        ...
        public InlineResponse20019Meta Meta { get; set; }
