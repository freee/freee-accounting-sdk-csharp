...
namespace Freee.Accounting.Models
{
    ...
    public partial class SelectablesIndexResponseAccountItems :  IEquatable<SelectablesIndexResponseAccountItems>
    {
        ...
        public SelectablesIndexResponseAccountItems(int id = default(int), string name = default(string), string desc = default(string), string help = default(string), string shortcut = default(string), SelectablesIndexResponseDefaultTax defaultTax = default(SelectablesIndexResponseDefaultTax))
        {
            this.Id = id;
            this.Name = name;
            this.Desc = desc;
