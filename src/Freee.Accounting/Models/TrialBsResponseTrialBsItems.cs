...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsResponseTrialBsItems :  IEquatable<TrialBsResponseTrialBsItems>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsResponseTrialBsItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsItems" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsItems(int id = default(int), string name = default(string), int openingBalance = default(int), int debitAmount = default(int), int creditAmount = default(int), int closingBalance = default(int), decimal compositionRatio = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsItems);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsItems input)
        {
            if (input == null)
                return false;
