...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_items")]
    public partial class TrialBsResponseTrialBsItems : IEquatable<TrialBsResponseTrialBsItems>
    {
        ...
        public TrialBsResponseTrialBsItems(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
