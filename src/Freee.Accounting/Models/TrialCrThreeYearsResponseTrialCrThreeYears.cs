...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrThreeYearsResponse_trial_cr_three_years")]
    public partial class TrialCrThreeYearsResponseTrialCrThreeYears : IEquatable<TrialCrThreeYearsResponseTrialCrThreeYears>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYears" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrThreeYearsResponseTrialCrThreeYears() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYears" /> class.
        /// </summary>
        ...
        public TrialCrThreeYearsResponseTrialCrThreeYears(AccountItemDisplayTypeEnum? accountItemDisplayType = default(AccountItemDisplayTypeEnum?), AdjustmentEnum? adjustment = default(AdjustmentEnum?), ApprovalFlowStatusEnum? approvalFlowStatus = default(ApprovalFlowStatusEnum?), List<TrialCrThreeYearsResponseTrialCrThreeYearsBalances> balances = default(List<TrialCrThreeYearsResponseTrialCrThreeYearsBalances>), BreakdownDisplayTypeEnum? breakdownDisplayType = default(BreakdownDisplayTypeEnum?), int companyId = default(int), CostAllocationEnum? costAllocation = default(CostAllocationEnum?), string createdAt = default(string), string endDate = default(string), int endMonth = default(int), int fiscalYear = default(int), int itemId = default(int), string partnerCode = default(string), int partnerId = default(int), int sectionId = default(int), string startDate = default(string), int startMonth = default(int))
        {
            // to ensure "balances" is required (not null)
            if (balances == null) {
                throw new ArgumentNullException("balances is a required property for TrialCrThreeYearsResponseTrialCrThreeYears and cannot be null");
            }
        ...
        public List<TrialCrThreeYearsResponseTrialCrThreeYearsBalances> Balances { get; set; }
        ...
        {
            return this.Equals(input as TrialCrThreeYearsResponseTrialCrThreeYears);
        }

        /// <summary>
        /// Returns true if TrialCrThreeYearsResponseTrialCrThreeYears instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrThreeYearsResponseTrialCrThreeYears to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrThreeYearsResponseTrialCrThreeYears input)
        {
            if (input == null)
            {
                return false;
