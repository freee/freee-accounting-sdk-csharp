...
namespace Freee.Accounting.Models
{
    ...
    public partial class WalletTxn :  IEquatable<WalletTxn>
    {
        ...
        public WalletTxn(int id = default(int), int companyId = default(int), string date = default(string), int amount = default(int), int dueAmount = default(int), int balance = default(int), EntrySideEnum entrySide = default(EntrySideEnum), WalletableTypeEnum walletableType = default(WalletableTypeEnum), int walletableId = default(int), string description = default(string), int status = default(int))
        {
            this.Id = id;
