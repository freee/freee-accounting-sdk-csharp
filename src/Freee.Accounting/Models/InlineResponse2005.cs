...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>
    {
        ...
        public InlineResponse2005(List<Invoice> invoices = default(List<Invoice>))
        {
            // to ensure "invoices" is required (not null)
            this.Invoices = invoices ?? throw new ArgumentNullException("invoices is a required property for InlineResponse2005 and cannot be null");
        }
