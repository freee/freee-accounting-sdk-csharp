...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2005 :  IEquatable<InlineResponse2005>
    {
        ...
        public InlineResponse2005(List<Item> items = default(List<Item>))
        {
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for InlineResponse2005 and cannot be null");
        }
