...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsThreeYearsResponse_trial_bs_three_years_segment_3_tags")]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags : IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags" /> class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags);
        }

        /// <summary>
        /// Returns true if TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsThreeYearsResponseTrialBsThreeYearsSegment3Tags input)
        {
            if (input == null)
            {
                return false;
