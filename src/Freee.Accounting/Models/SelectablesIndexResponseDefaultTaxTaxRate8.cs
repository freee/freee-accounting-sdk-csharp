...
namespace Freee.Accounting.Models
{
    ...
    public partial class SelectablesIndexResponseDefaultTaxTaxRate8 :  IEquatable<SelectablesIndexResponseDefaultTaxTaxRate8>
    {
        ...
        {
            return this.Equals(input as SelectablesIndexResponseDefaultTaxTaxRate8);
        }

        /// <summary>
        /// Returns true if SelectablesIndexResponseDefaultTaxTaxRate8 instances are equal
        /// </summary>
        /// <param name="input">Instance of SelectablesIndexResponseDefaultTaxTaxRate8 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SelectablesIndexResponseDefaultTaxTaxRate8 input)
        {
            if (input == null)
                return false;
