...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemResponseItem :  IEquatable<ItemResponseItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemResponseItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemResponseItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemResponseItem" /> class.
        /// </summary>
        ...
        public ItemResponseItem(int id = default(int), int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.Id = id;
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ItemResponseItem and cannot be null");;
        ...
        {
            return this.Equals(input as ItemResponseItem);
        }

        /// <summary>
        /// Returns true if ItemResponseItem instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemResponseItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemResponseItem input)
        {
            if (input == null)
                return false;
