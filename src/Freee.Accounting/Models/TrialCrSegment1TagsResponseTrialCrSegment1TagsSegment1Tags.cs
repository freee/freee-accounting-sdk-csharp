...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSegment_1TagsResponse_trial_cr_segment_1_tags_segment_1_tags")]
    public partial class TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags : IEquatable<TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags);
        }

        /// <summary>
        /// Returns true if TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSegment1TagsResponseTrialCrSegment1TagsSegment1Tags input)
        {
            if (input == null)
            {
                return false;
