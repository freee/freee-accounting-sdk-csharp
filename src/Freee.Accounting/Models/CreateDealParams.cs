...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateDealParams :  IEquatable<CreateDealParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDealParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateDealParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateDealParams" /> class.
        /// </summary>
        ...
        public CreateDealParams(string issueDate = default(string), TypeEnum type = default(TypeEnum), int companyId = default(int), string dueDate = default(string), int partnerId = default(int), string partnerCode = default(string), string refNumber = default(string), List<CreateDealParamsDetails> details = default(List<CreateDealParamsDetails>), List<CreateDealParamsPayments> payments = default(List<CreateDealParamsPayments>), List<int> receiptIds = default(List<int>))
        {
            // to ensure "issueDate" is required (not null)
            this.IssueDate = issueDate ?? throw new ArgumentNullException("issueDate is a required property for CreateDealParams and cannot be null");;
            this.Type = type;
            this.CompanyId = companyId;
            // to ensure "details" is required (not null)
            this.Details = details ?? throw new ArgumentNullException("details is a required property for CreateDealParams and cannot be null");;
        ...
        public List<CreateDealParamsDetails> Details { get; set; }
        ...
        public List<CreateDealParamsPayments> Payments { get; set; }
        ...
        {
            return this.Equals(input as CreateDealParams);
        }

        /// <summary>
        /// Returns true if CreateDealParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateDealParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateDealParams input)
        {
            if (input == null)
                return false;
