...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsThreeYearsResponseTrialBsThreeYears
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialBsThreeYearsResponseTrialBsThreeYears class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYears(int companyId, IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem> balances, int? fiscalYear = default(int?), int? startMonth = default(int?), int? endMonth = default(int?), string startDate = default(string), string endDate = default(string), string accountItemDisplayType = default(string), string breakdownDisplayType = default(string), int? partnerId = default(int?), string partnerCode = default(string), int? itemId = default(int?), string adjustment = default(string), string createdAt = default(string))
        {
            CompanyId = companyId;
        ...
        public IList<TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItem> Balances { get; set; }
