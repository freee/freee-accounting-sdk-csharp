...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "paymentRequestUpdateParams_payment_request_lines")]
    public partial class PaymentRequestUpdateParamsPaymentRequestLines : IEquatable<PaymentRequestUpdateParamsPaymentRequestLines>
    {
        ...
        /// </summary>
        /// <value>&#39;行の種類 (deal_line: 支払依頼, withholding_tax: 源泉徴収税)&#39;&lt;br&gt; &#39;デフォルトは deal_line: 支払依頼 です&#39; </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequestUpdateParamsPaymentRequestLines" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentRequestUpdateParamsPaymentRequestLines() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequestUpdateParamsPaymentRequestLines" /> class.
        /// </summary>
        ...
        /// <param name="lineType">&#39;行の種類 (deal_line: 支払依頼, withholding_tax: 源泉徴収税)&#39;&lt;br&gt; &#39;デフォルトは deal_line: 支払依頼 です&#39; .</param>
        ...
        /// </summary>
        /// <value>支払依頼の項目行ID: 既存項目行を更新する場合に指定します。IDを指定しない項目行は、新規行として扱われ追加されます。また、payment_request_linesに含まれない既存の項目行は削除されます。更新後も残したい行は、必ず支払依頼の項目行IDを指定してpayment_request_linesに含めてください。</value>
        ...
        {
            return this.Equals(input as PaymentRequestUpdateParamsPaymentRequestLines);
        }

        /// <summary>
        /// Returns true if PaymentRequestUpdateParamsPaymentRequestLines instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequestUpdateParamsPaymentRequestLines to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequestUpdateParamsPaymentRequestLines input)
        {
            if (input == null)
            {
                return false;
