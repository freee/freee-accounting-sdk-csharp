...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrTwoYearsResponse_trial_cr_two_years_segment_1_tags")]
    public partial class TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags : IEquatable<TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags" /> class.
        /// </summary>
        ...
        public TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags);
        }

        /// <summary>
        /// Returns true if TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrTwoYearsResponseTrialCrTwoYearsSegment1Tags input)
        {
            if (input == null)
            {
                return false;
