...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "paymentRequestActionCreateParams")]
    public partial class PaymentRequestActionCreateParams : IEquatable<PaymentRequestActionCreateParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequestActionCreateParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentRequestActionCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentRequestActionCreateParams" /> class.
        /// </summary>
        ...
        /// <param name="targetRound">対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。支払依頼の取得APIレスポンス.current_roundを送信してください。 (required).</param>
        /// <param name="targetStepId">対象承認ステップID 支払依頼の取得APIレスポンス.current_step_idを送信してください。 (required).</param>
        public PaymentRequestActionCreateParams(ApprovalActionEnum approvalAction = default(ApprovalActionEnum), int companyId = default(int), int? nextApproverId = default(int?), int targetRound = default(int), int targetStepId = default(int))
        {
        ...
        /// </summary>
        /// <value>対象round。差し戻し等により申請がstepの最初からやり直しになるとroundの値が増えます。支払依頼の取得APIレスポンス.current_roundを送信してください。</value>
        ...
        /// </summary>
        /// <value>対象承認ステップID 支払依頼の取得APIレスポンス.current_step_idを送信してください。</value>
        ...
        {
            return this.Equals(input as PaymentRequestActionCreateParams);
        }

        /// <summary>
        /// Returns true if PaymentRequestActionCreateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of PaymentRequestActionCreateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentRequestActionCreateParams input)
        {
            if (input == null)
            {
                return false;
