...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20011 :  IEquatable<InlineResponse20011>
    {
        ...
        public InlineResponse20011(List<SegmentTag> segmentTags = default(List<SegmentTag>))
        {
            // to ensure "segmentTags" is required (not null)
            this.SegmentTags = segmentTags ?? throw new ArgumentNullException("segmentTags is a required property for InlineResponse20011 and cannot be null");
        }
