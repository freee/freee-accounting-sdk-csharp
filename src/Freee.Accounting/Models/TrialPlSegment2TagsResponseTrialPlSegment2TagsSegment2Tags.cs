...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlSegment_2TagsResponse_trial_pl_segment_2_tags_segment_2_tags")]
    public partial class TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags : IEquatable<TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags);
        }

        /// <summary>
        /// Returns true if TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags input)
        {
            if (input == null)
            {
                return false;
