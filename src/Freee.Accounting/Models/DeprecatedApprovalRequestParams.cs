...
namespace Freee.Accounting.Models
{
    ...
    public partial class DeprecatedApprovalRequestParams : IEquatable<DeprecatedApprovalRequestParams>
    {
        ...
        protected DeprecatedApprovalRequestParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DeprecatedApprovalRequestParams" /> class.
        /// </summary>
        /// <param name="approvalFlowRouteId">経路申請ID (required).</param>
        /// <param name="approverId">承認者のユーザーID.</param>
        /// <param name="companyId">事業所ID (required).</param>
        /// <param name="requestFormId">申請フォームID (required).</param>
        /// <param name="requestItems">requestItems.</param>
        /// <param name="title">申請タイトル (255文字以内) (required).</param>
        public DeprecatedApprovalRequestParams(int approvalFlowRouteId = default(int), int approverId = default(int), int companyId = default(int), int requestFormId = default(int), List<DeprecatedApprovalRequestParamsRequestItems> requestItems = default(List<DeprecatedApprovalRequestParamsRequestItems>), string title = default(string))
        {
            this.ApprovalFlowRouteId = approvalFlowRouteId;
            this.CompanyId = companyId;
            this.RequestFormId = requestFormId;
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for DeprecatedApprovalRequestParams and cannot be null");
        ...
        public override string ToString()
        {
            ...
            sb.Append("  RequestFormId: ").Append(RequestFormId).Append("\n");
        ...
        {
            return this.Equals(input as DeprecatedApprovalRequestParams);
        }

        /// <summary>
        /// Returns true if DeprecatedApprovalRequestParams instances are equal
        /// </summary>
        /// <param name="input">Instance of DeprecatedApprovalRequestParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DeprecatedApprovalRequestParams input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.RequestFormId == input.RequestFormId ||
                    this.RequestFormId.Equals(input.RequestFormId)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.RequestFormId.GetHashCode();
