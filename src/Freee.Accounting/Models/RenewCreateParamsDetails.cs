...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "renewCreateParams_details")]
    public partial class RenewCreateParamsDetails : IEquatable<RenewCreateParamsDetails>
    {
        ...
        public RenewCreateParamsDetails(int accountItemId = default(int), long amount = default(long), string description = default(string), int itemId = default(int), int sectionId = default(int), long segment1TagId = default(long), long segment2TagId = default(long), long segment3TagId = default(long), List<int> tagIds = default(List<int>), int taxCode = default(int), long vat = default(long))
        {
