...
namespace Freee.Accounting.Models
{
    ...
    public partial class SectionParams :  IEquatable<SectionParams>
    {
        ...
        public SectionParams(int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string), int parentId = default(int))
        {
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SectionParams and cannot be null");;
