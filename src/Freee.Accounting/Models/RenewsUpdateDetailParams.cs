...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class RenewsUpdateDetailParams :  IEquatable<RenewsUpdateDetailParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewsUpdateDetailParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RenewsUpdateDetailParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewsUpdateDetailParams" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RenewsUpdateDetailParams);
        }

        /// <summary>
        /// Returns true if RenewsUpdateDetailParams instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewsUpdateDetailParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewsUpdateDetailParams input)
        {
            if (input == null)
                return false;
