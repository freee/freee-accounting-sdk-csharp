...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem
        /// class.
        /// </summary>
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem()
        {
            CustomInit();
        }
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem(int id, string name = default(string), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
            Id = id;
            Name = name;
