...
namespace Freee.Accounting.Models
{
    ...
    /// ItemParams
    /// </summary>
    [DataContract(Name = "itemParams")]
    public partial class ItemParams : IEquatable<ItemParams>
    {
        /// <summary>
        ...
        public ItemParams(int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ItemParams and cannot be null");
        ...
        {
            return this.Equals(input as ItemParams);
        }

        /// <summary>
        /// Returns true if ItemParams instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemParams input)
        {
            if (input == null)
                return false;
