...
namespace Freee.Accounting.Models
{
    ...
    public partial class Transfer :  IEquatable<Transfer>
    {
        ...
        public Transfer(int id = default(int), int companyId = default(int), int amount = default(int), string date = default(string), FromWalletableTypeEnum fromWalletableType = default(FromWalletableTypeEnum), int fromWalletableId = default(int), ToWalletableTypeEnum toWalletableType = default(ToWalletableTypeEnum), int toWalletableId = default(int), string description = default(string))
        {
            this.Id = id;
            this.CompanyId = companyId;
            this.Amount = amount;
            // to ensure "date" is required (not null)
            this.Date = date ?? throw new ArgumentNullException("date is a required property for Transfer and cannot be null");;
            ...
            this.Description = description ?? throw new ArgumentNullException("description is a required property for Transfer and cannot be null");;
        }
