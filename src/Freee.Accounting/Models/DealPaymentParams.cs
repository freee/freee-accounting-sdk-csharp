...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DealPaymentParams :  IEquatable<DealPaymentParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealPaymentParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealPaymentParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealPaymentParams" /> class.
        /// </summary>
        ...
        public DealPaymentParams(int companyId = default(int), string date = default(string), FromWalletableTypeEnum fromWalletableType = default(FromWalletableTypeEnum), int fromWalletableId = default(int), int amount = default(int))
        {
            this.CompanyId = companyId;
            // to ensure "date" is required (not null)
            this.Date = date ?? throw new ArgumentNullException("date is a required property for DealPaymentParams and cannot be null");;
        ...
        {
            return this.Equals(input as DealPaymentParams);
        }

        /// <summary>
        /// Returns true if DealPaymentParams instances are equal
        /// </summary>
        /// <param name="input">Instance of DealPaymentParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealPaymentParams input)
        {
            if (input == null)
                return false;
