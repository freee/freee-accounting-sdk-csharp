...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20012 : IEquatable<InlineResponse20012>
    {
        ...
        public InlineResponse20012(List<Tax> taxes = default(List<Tax>))
        {
            // to ensure "taxes" is required (not null)
            this.Taxes = taxes ?? throw new ArgumentNullException("taxes is a required property for InlineResponse20012 and cannot be null");
        }
