...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ItemsIndexResponseItems :  IEquatable<ItemsIndexResponseItems>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemsIndexResponseItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ItemsIndexResponseItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemsIndexResponseItems" /> class.
        /// </summary>
        ...
        public ItemsIndexResponseItems(int id = default(int), int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.Id = id;
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ItemsIndexResponseItems and cannot be null");;
        ...
        {
            return this.Equals(input as ItemsIndexResponseItems);
        }

        /// <summary>
        /// Returns true if ItemsIndexResponseItems instances are equal
        /// </summary>
        /// <param name="input">Instance of ItemsIndexResponseItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ItemsIndexResponseItems input)
        {
            if (input == null)
                return false;
