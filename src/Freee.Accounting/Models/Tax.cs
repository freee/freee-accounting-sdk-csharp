...
namespace Freee.Accounting.Models
{
    ...
    public partial class Tax : IEquatable<Tax>
    {
        ...
        public Tax(int code = default(int), string name = default(string), string nameJa = default(string))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Tax and cannot be null");
            // to ensure "nameJa" is required (not null)
            this.NameJa = nameJa ?? throw new ArgumentNullException("nameJa is a required property for Tax and cannot be null");
        }
