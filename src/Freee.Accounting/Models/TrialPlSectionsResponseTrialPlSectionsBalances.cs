...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlSectionsResponseTrialPlSectionsBalances :  IEquatable<TrialPlSectionsResponseTrialPlSectionsBalances>
    {
        ...
        public TrialPlSectionsResponseTrialPlSectionsBalances(int accountItemId = default(int), string accountItemName = default(string), List<TrialPlSectionsResponseTrialPlSectionsSections> sections = default(List<TrialPlSectionsResponseTrialPlSectionsSections>), int accountCategoryId = default(int), string accountCategoryName = default(string), bool totalLine = default(bool), int hierarchyLevel = default(int), int parentAccountCategoryId = default(int), string parentAccountCategoryName = default(string), int closingBalance = default(int))
        {
