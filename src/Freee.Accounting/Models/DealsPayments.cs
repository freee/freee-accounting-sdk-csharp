...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class DealsPayments :  IEquatable<DealsPayments>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsPayments" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealsPayments() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealsPayments" /> class.
        /// </summary>
        ...
        public DealsPayments(int id = default(int), string date = default(string), FromWalletableTypeEnum? fromWalletableType = default(FromWalletableTypeEnum?), int fromWalletableId = default(int), int amount = default(int))
        {
            this.Id = id;
            // to ensure "date" is required (not null)
            this.Date = date ?? throw new ArgumentNullException("date is a required property for DealsPayments and cannot be null");;
            this.Amount = amount;
        ...
        {
            return this.Equals(input as DealsPayments);
        }

        /// <summary>
        /// Returns true if DealsPayments instances are equal
        /// </summary>
        /// <param name="input">Instance of DealsPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealsPayments input)
        {
            if (input == null)
                return false;
