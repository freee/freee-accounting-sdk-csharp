...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrThreeYearsResponse_trial_cr_three_years_balances")]
    public partial class TrialCrThreeYearsResponseTrialCrThreeYearsBalances : IEquatable<TrialCrThreeYearsResponseTrialCrThreeYearsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsBalances" /> class.
        /// </summary>
        ...
        public TrialCrThreeYearsResponseTrialCrThreeYearsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), List<TrialCrThreeYearsResponseTrialCrThreeYearsItems> items = default(List<TrialCrThreeYearsResponseTrialCrThreeYearsItems>), int lastYearClosingBalance = default(int), string parentAccountCategoryName = default(string), List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners> partners = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsPartners>), List<TrialBsThreeYearsResponseTrialBsThreeYearsSections> sections = default(List<TrialBsThreeYearsResponseTrialBsThreeYearsSections>), List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags> segment1Tags = default(List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags>), List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags> segment2Tags = default(List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags>), List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags> segment3Tags = default(List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags>), bool totalLine = default(bool), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
        ...
        public List<TrialCrThreeYearsResponseTrialCrThreeYearsItems> Items { get; set; }
        ...
        public List<TrialBsThreeYearsResponseTrialBsThreeYearsSections> Sections { get; set; }
        ...
        public List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment1Tags> Segment1Tags { get; set; }
        ...
        public List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags> Segment2Tags { get; set; }
        ...
        public List<TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags> Segment3Tags { get; set; }
        ...
        {
            return this.Equals(input as TrialCrThreeYearsResponseTrialCrThreeYearsBalances);
        }

        /// <summary>
        /// Returns true if TrialCrThreeYearsResponseTrialCrThreeYearsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrThreeYearsResponseTrialCrThreeYearsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrThreeYearsResponseTrialCrThreeYearsBalances input)
        {
            if (input == null)
            {
                return false;
