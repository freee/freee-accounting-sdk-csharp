...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrResponse_trial_cr_segment_1_tags")]
    public partial class TrialCrResponseTrialCrSegment1Tags : IEquatable<TrialCrResponseTrialCrSegment1Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrResponseTrialCrSegment1Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrResponseTrialCrSegment1Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrResponseTrialCrSegment1Tags" /> class.
        /// </summary>
        ...
        public TrialCrResponseTrialCrSegment1Tags(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrResponseTrialCrSegment1Tags);
        }

        /// <summary>
        /// Returns true if TrialCrResponseTrialCrSegment1Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrResponseTrialCrSegment1Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrResponseTrialCrSegment1Tags input)
        {
            if (input == null)
            {
                return false;
