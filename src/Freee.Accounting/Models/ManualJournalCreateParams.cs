...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "manualJournalCreateParams")]
    public partial class ManualJournalCreateParams : IEquatable<ManualJournalCreateParams>
    {
        ...
        protected ManualJournalCreateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalCreateParams" /> class.
        /// </summary>
        ...
        public ManualJournalCreateParams(bool adjustment = default(bool), int companyId = default(int), List<ManualJournalCreateParamsDetails> details = default(List<ManualJournalCreateParamsDetails>), string issueDate = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "details" is required (not null)
            this.Details = details ?? throw new ArgumentNullException("details is a required property for ManualJournalCreateParams and cannot be null");
            // to ensure "issueDate" is required (not null)
            this.IssueDate = issueDate ?? throw new ArgumentNullException("issueDate is a required property for ManualJournalCreateParams and cannot be null");
        ...
        {
            return this.Equals(input as ManualJournalCreateParams);
        }

        /// <summary>
        /// Returns true if ManualJournalCreateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualJournalCreateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualJournalCreateParams input)
        {
            if (input == null)
                return false;
