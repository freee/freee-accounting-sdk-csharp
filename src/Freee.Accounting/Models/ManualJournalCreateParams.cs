...
namespace Freee.Accounting.Models
{
    ...
    public partial class ManualJournalCreateParams : IEquatable<ManualJournalCreateParams>
    {
        ...
        public ManualJournalCreateParams(bool adjustment = default(bool), int companyId = default(int), List<ManualJournalCreateParamsDetails> details = default(List<ManualJournalCreateParamsDetails>), string issueDate = default(string), List<int> receiptIds = default(List<int>))
        {
            this.CompanyId = companyId;
            // to ensure "details" is required (not null)
            if (details == null) {
                throw new ArgumentNullException("details is a required property for ManualJournalCreateParams and cannot be null");
            }
            this.Details = details;
            // to ensure "issueDate" is required (not null)
            if (issueDate == null) {
                throw new ArgumentNullException("issueDate is a required property for ManualJournalCreateParams and cannot be null");
            }
