...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "partnerUpdateParams_payment_term_attributes")]
    public partial class PartnerUpdateParamsPaymentTermAttributes : IEquatable<PartnerUpdateParamsPaymentTermAttributes>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerUpdateParamsPaymentTermAttributes" /> class.
        /// </summary>
        ...
        public PartnerUpdateParamsPaymentTermAttributes(int additionalMonths = default(int), int cutoffDay = default(int), int fixedDay = default(int))
        {
        ...
        {
            return this.Equals(input as PartnerUpdateParamsPaymentTermAttributes);
        }

        /// <summary>
        /// Returns true if PartnerUpdateParamsPaymentTermAttributes instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerUpdateParamsPaymentTermAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerUpdateParamsPaymentTermAttributes input)
        {
            if (input == null)
            {
                return false;
