...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialPlResponseTrialPl :  IEquatable<TrialPlResponseTrialPl>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlResponseTrialPl" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlResponseTrialPl() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlResponseTrialPl" /> class.
        /// </summary>
        ...
        public TrialPlResponseTrialPl(int companyId = default(int), bool upToDate = default(bool), int fiscalYear = default(int), int startMonth = default(int), int endMonth = default(int), string startDate = default(string), string endDate = default(string), AccountItemDisplayTypeEnum? accountItemDisplayType = default(AccountItemDisplayTypeEnum?), BreakdownDisplayTypeEnum? breakdownDisplayType = default(BreakdownDisplayTypeEnum?), int partnerId = default(int), string partnerCode = default(string), int itemId = default(int), int sectionId = default(int), AdjustmentEnum? adjustment = default(AdjustmentEnum?), CostAllocationEnum? costAllocation = default(CostAllocationEnum?), string createdAt = default(string), List<TrialPlResponseTrialPlBalances> balances = default(List<TrialPlResponseTrialPlBalances>))
        {
            this.CompanyId = companyId;
            this.UpToDate = upToDate;
            // to ensure "balances" is required (not null)
            this.Balances = balances ?? throw new ArgumentNullException("balances is a required property for TrialPlResponseTrialPl and cannot be null");;
        ...
        public List<TrialPlResponseTrialPlBalances> Balances { get; set; }
        ...
        {
            return this.Equals(input as TrialPlResponseTrialPl);
        }

        /// <summary>
        /// Returns true if TrialPlResponseTrialPl instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlResponseTrialPl to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlResponseTrialPl input)
        {
            if (input == null)
                return false;
