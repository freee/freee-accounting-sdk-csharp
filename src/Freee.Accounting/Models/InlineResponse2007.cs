...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2007 : IEquatable<InlineResponse2007>
    {
        ...
        public InlineResponse2007(List<Quotation> quotations = default(List<Quotation>))
        {
            // to ensure "quotations" is required (not null)
            this.Quotations = quotations ?? throw new ArgumentNullException("quotations is a required property for InlineResponse2007 and cannot be null");
        }
