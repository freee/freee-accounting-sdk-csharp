...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2007 :  IEquatable<InlineResponse2007>
    {
        ...
        public InlineResponse2007(List<ManualJournal> manualJournals = default(List<ManualJournal>))
        {
            // to ensure "manualJournals" is required (not null)
            this.ManualJournals = manualJournals ?? throw new ArgumentNullException("manualJournals is a required property for InlineResponse2007 and cannot be null");
        }
