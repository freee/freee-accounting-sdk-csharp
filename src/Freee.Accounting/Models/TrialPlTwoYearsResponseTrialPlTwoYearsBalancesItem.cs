...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem class.
        /// </summary>
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem()
        {
            CustomInit();
        }
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItem(int? accountItemId = default(int?), string accountItemName = default(string), IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem> partners = default(IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem>), IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemItemsItem> items = default(IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemItemsItem>), IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem> sections = default(IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem>), int? accountCategoryId = default(int?), string accountCategoryName = default(string), bool? totalLine = default(bool?), int? hierarchyLevel = default(int?), int? parentAccountCategoryId = default(int?), string parentAccountCategoryName = default(string), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
        ...
        public IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem> Partners { get; set; }
        ...
        public IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemItemsItem> Items { get; set; }
        ...
        public IList<TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemSectionsItem> Sections { get; set; }
