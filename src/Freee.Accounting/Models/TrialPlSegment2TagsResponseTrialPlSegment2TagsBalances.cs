...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlSegment_2TagsResponse_trial_pl_segment_2_tags_balances")]
    public partial class TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances : IEquatable<TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances" /> class.
        /// </summary>
        ...
        public List<TrialPlSegment2TagsResponseTrialPlSegment2TagsSegment2Tags> Segment2Tags { get; set; }
        ...
        {
            return this.Equals(input as TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances);
        }

        /// <summary>
        /// Returns true if TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlSegment2TagsResponseTrialPlSegment2TagsBalances input)
        {
            if (input == null)
            {
                return false;
