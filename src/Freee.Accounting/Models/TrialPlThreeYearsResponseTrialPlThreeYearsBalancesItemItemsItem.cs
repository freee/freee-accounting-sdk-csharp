...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem
        /// class.
        /// </summary>
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem()
        {
            CustomInit();
        }
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemItemsItem(int id, string name = default(string), int? twoYearsBeforeClosingBalance = default(int?), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
            Id = id;
            Name = name;
