...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlResponseTrialPlBalancesItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlResponseTrialPlBalancesItem class.
        /// </summary>
        public TrialPlResponseTrialPlBalancesItem()
        {
            CustomInit();
        }
        ...
        public TrialPlResponseTrialPlBalancesItem(int? accountItemId = default(int?), string accountItemName = default(string), IList<TrialPlResponseTrialPlBalancesItemPartnersItem> partners = default(IList<TrialPlResponseTrialPlBalancesItemPartnersItem>), IList<TrialPlResponseTrialPlBalancesItemItemsItem> items = default(IList<TrialPlResponseTrialPlBalancesItemItemsItem>), IList<TrialPlResponseTrialPlBalancesItemSectionsItem> sections = default(IList<TrialPlResponseTrialPlBalancesItemSectionsItem>), int? accountCategoryId = default(int?), string accountCategoryName = default(string), bool? totalLine = default(bool?), int? hierarchyLevel = default(int?), int? parentAccountCategoryId = default(int?), string parentAccountCategoryName = default(string), int? openingBalance = default(int?), int? debitAmount = default(int?), int? creditAmount = default(int?), int? closingBalance = default(int?), double? compositionRatio = default(double?))
        {
        ...
        public IList<TrialPlResponseTrialPlBalancesItemPartnersItem> Partners { get; set; }
        ...
        public IList<TrialPlResponseTrialPlBalancesItemItemsItem> Items { get; set; }
        ...
        public IList<TrialPlResponseTrialPlBalancesItemSectionsItem> Sections { get; set; }
