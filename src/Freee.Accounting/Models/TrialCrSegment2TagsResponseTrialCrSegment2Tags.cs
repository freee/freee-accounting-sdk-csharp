...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSegment_2TagsResponse_trial_cr_segment_2_tags")]
    public partial class TrialCrSegment2TagsResponseTrialCrSegment2Tags : IEquatable<TrialCrSegment2TagsResponseTrialCrSegment2Tags>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment2TagsResponseTrialCrSegment2Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrSegment2TagsResponseTrialCrSegment2Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment2TagsResponseTrialCrSegment2Tags" /> class.
        /// </summary>
        ...
        /// <param name="segment2TagIds">出力するセグメント2の指定 (required).</param>
        ...
        public List<TrialCrSegment2TagsResponseTrialCrSegment2TagsBalances> Balances { get; set; }
        ...
        /// 出力するセグメント2の指定
        /// </summary>
        /// <value>出力するセグメント2の指定</value>
        [DataMember(Name = "segment_2_tag_ids", IsRequired = true, EmitDefaultValue = false)]
        public string Segment2TagIds { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  Segment2TagIds: ").Append(Segment2TagIds).Append("\n");
        ...
        {
            return this.Equals(input as TrialCrSegment2TagsResponseTrialCrSegment2Tags);
        }

        /// <summary>
        /// Returns true if TrialCrSegment2TagsResponseTrialCrSegment2Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSegment2TagsResponseTrialCrSegment2Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSegment2TagsResponseTrialCrSegment2Tags input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Segment2TagIds == input.Segment2TagIds ||
                    (this.Segment2TagIds != null &&
                    this.Segment2TagIds.Equals(input.Segment2TagIds))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Segment2TagIds != null)
                {
                    hashCode = (hashCode * 59) + this.Segment2TagIds.GetHashCode();
                }
