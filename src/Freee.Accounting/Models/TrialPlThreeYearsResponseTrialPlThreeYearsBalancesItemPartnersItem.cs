...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem
        /// class.
        /// </summary>
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem()
        {
            CustomInit();
        }
        ...
        public TrialPlThreeYearsResponseTrialPlThreeYearsBalancesItemPartnersItem(int id, string name = default(string), int? twoYearsBeforeClosingBalance = default(int?), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
            Id = id;
            Name = name;
