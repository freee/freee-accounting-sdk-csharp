...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrThreeYearsResponse_trial_cr_three_years_segment_3_tags")]
    public partial class TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags : IEquatable<TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags" /> class.
        /// </summary>
        ...
        public TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags);
        }

        /// <summary>
        /// Returns true if TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrThreeYearsResponseTrialCrThreeYearsSegment3Tags input)
        {
            if (input == null)
            {
                return false;
