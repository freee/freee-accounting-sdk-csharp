...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_segment_2_tags")]
    public partial class TrialBsResponseTrialBsSegment2Tags : IEquatable<TrialBsResponseTrialBsSegment2Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSegment2Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsResponseTrialBsSegment2Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSegment2Tags" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsSegment2Tags(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsSegment2Tags);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsSegment2Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsSegment2Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsSegment2Tags input)
        {
            if (input == null)
            {
                return false;
