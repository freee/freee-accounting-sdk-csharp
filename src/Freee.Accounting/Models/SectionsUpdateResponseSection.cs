...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class SectionsUpdateResponseSection :  IEquatable<SectionsUpdateResponseSection>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionsUpdateResponseSection" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SectionsUpdateResponseSection() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SectionsUpdateResponseSection" /> class.
        /// </summary>
        ...
        public SectionsUpdateResponseSection(int id = default(int), string name = default(string), string longName = default(string), int companyId = default(int), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for SectionsUpdateResponseSection and cannot be null");;
        ...
        {
            return this.Equals(input as SectionsUpdateResponseSection);
        }

        /// <summary>
        /// Returns true if SectionsUpdateResponseSection instances are equal
        /// </summary>
        /// <param name="input">Instance of SectionsUpdateResponseSection to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SectionsUpdateResponseSection input)
        {
            if (input == null)
                return false;
