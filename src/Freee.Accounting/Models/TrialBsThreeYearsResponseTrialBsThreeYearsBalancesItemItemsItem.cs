...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem
        /// class.
        /// </summary>
        public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem()
        {
            CustomInit();
        }
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsBalancesItemItemsItem(int id, string name = default(string), int? twoYearsBeforeClosingBalance = default(int?), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
            Id = id;
            Name = name;
