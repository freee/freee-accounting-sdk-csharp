...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class JournalsStatusResponseJournals :  IEquatable<JournalsStatusResponseJournals>
    {
        /// <summary>
        /// ダウンロード形式
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JournalsStatusResponseJournals" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JournalsStatusResponseJournals() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JournalsStatusResponseJournals" /> class.
        /// </summary>
        ...
        public JournalsStatusResponseJournals(int id = default(int), int companyId = default(int), DownloadTypeEnum downloadType = default(DownloadTypeEnum), StatusEnum status = default(StatusEnum), string startDate = default(string), string endDate = default(string), List<VisibleTagsEnum> visibleTags = default(List<VisibleTagsEnum>), string downloadUrl = default(string))
        {
            this.Id = id;
            ...
            this.StartDate = startDate ?? throw new ArgumentNullException("startDate is a required property for JournalsStatusResponseJournals and cannot be null");;
            // to ensure "endDate" is required (not null)
            this.EndDate = endDate ?? throw new ArgumentNullException("endDate is a required property for JournalsStatusResponseJournals and cannot be null");;
            // to ensure "visibleTags" is required (not null)
            this.VisibleTags = visibleTags ?? throw new ArgumentNullException("visibleTags is a required property for JournalsStatusResponseJournals and cannot be null");;
        ...
        {
            return this.Equals(input as JournalsStatusResponseJournals);
        }

        /// <summary>
        /// Returns true if JournalsStatusResponseJournals instances are equal
        /// </summary>
        /// <param name="input">Instance of JournalsStatusResponseJournals to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JournalsStatusResponseJournals input)
        {
            if (input == null)
                return false;
