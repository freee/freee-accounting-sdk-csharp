...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateCompanyParamsDocTemplate :  IEquatable<UpdateCompanyParamsDocTemplate>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateCompanyParamsDocTemplate" /> class.
        /// </summary>
        /// <param name="invoiceLayout">レイアウト(0: レイアウト1, 1:レイアウト2, 3:封筒1, 4:レイアウト3(繰越金額欄あり), 5: 封筒2(繰越金額欄あり)).</param>
        /// <param name="invoiceStyle">スタイル(0: クラシック, 1: モダン).</param>
        /// <param name="amountFraction">金額端数処理方法（0: 切り上げ、1: 切り捨て, 2: 四捨五入）.</param>
        ...
        /// </summary>
        /// <value>金額端数処理方法（0: 切り上げ、1: 切り捨て, 2: 四捨五入）</value>
        ...
        {
            return this.Equals(input as UpdateCompanyParamsDocTemplate);
        }

        /// <summary>
        /// Returns true if UpdateCompanyParamsDocTemplate instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateCompanyParamsDocTemplate to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateCompanyParamsDocTemplate input)
        {
            if (input == null)
                return false;
