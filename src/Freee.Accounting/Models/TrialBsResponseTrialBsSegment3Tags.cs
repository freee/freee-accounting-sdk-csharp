...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_segment_3_tags")]
    public partial class TrialBsResponseTrialBsSegment3Tags : IEquatable<TrialBsResponseTrialBsSegment3Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSegment3Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsResponseTrialBsSegment3Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsSegment3Tags" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsSegment3Tags(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsSegment3Tags);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsSegment3Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsSegment3Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsSegment3Tags input)
        {
            if (input == null)
            {
                return false;
