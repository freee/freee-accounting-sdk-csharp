...
namespace Freee.Accounting.Models
{
    ...
    public partial class MeResponseUserCompanies : IEquatable<MeResponseUserCompanies>
    {
        ...
        public MeResponseUserCompanies(string displayName = default(string), int id = default(int), RoleEnum role = default(RoleEnum), bool useCustomRole = default(bool))
        {
            // to ensure "displayName" is required (not null)
            this.DisplayName = displayName ?? throw new ArgumentNullException("displayName is a required property for MeResponseUserCompanies and cannot be null");
            this.Id = id;
            this.Role = role;
