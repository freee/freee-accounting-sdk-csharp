...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlSegment_3TagsResponse_trial_pl_segment_3_tags")]
    public partial class TrialPlSegment3TagsResponseTrialPlSegment3Tags : IEquatable<TrialPlSegment3TagsResponseTrialPlSegment3Tags>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment3TagsResponseTrialPlSegment3Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlSegment3TagsResponseTrialPlSegment3Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment3TagsResponseTrialPlSegment3Tags" /> class.
        /// </summary>
        ...
        public List<TrialPlSegment3TagsResponseTrialPlSegment3TagsBalances> Balances { get; set; }
        ...
        {
            return this.Equals(input as TrialPlSegment3TagsResponseTrialPlSegment3Tags);
        }

        /// <summary>
        /// Returns true if TrialPlSegment3TagsResponseTrialPlSegment3Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlSegment3TagsResponseTrialPlSegment3Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlSegment3TagsResponseTrialPlSegment3Tags input)
        {
            if (input == null)
            {
                return false;
