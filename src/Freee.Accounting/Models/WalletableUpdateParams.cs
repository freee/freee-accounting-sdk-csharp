...
namespace Freee.Accounting.Models
{
    ...
    public partial class WalletableUpdateParams :  IEquatable<WalletableUpdateParams>
    {
        ...
        public WalletableUpdateParams(string name = default(string), int companyId = default(int))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for WalletableUpdateParams and cannot be null");;
