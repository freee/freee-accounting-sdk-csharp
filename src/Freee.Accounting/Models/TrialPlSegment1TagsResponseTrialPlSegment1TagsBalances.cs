...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlSegment_1TagsResponse_trial_pl_segment_1_tags_balances")]
    public partial class TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances : IEquatable<TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances" /> class.
        /// </summary>
        ...
        public TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances(string accountCategoryName = default(string), string accountGroupName = default(string), int accountItemId = default(int), string accountItemName = default(string), int closingBalance = default(int), int hierarchyLevel = default(int), string parentAccountCategoryName = default(string), List<TrialPlSegment1TagsResponseTrialPlSegment1TagsSegment1Tags> segment1Tags = default(List<TrialPlSegment1TagsResponseTrialPlSegment1TagsSegment1Tags>), bool totalLine = default(bool))
        {
        ...
        public List<TrialPlSegment1TagsResponseTrialPlSegment1TagsSegment1Tags> Segment1Tags { get; set; }
        ...
        {
            return this.Equals(input as TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances);
        }

        /// <summary>
        /// Returns true if TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlSegment1TagsResponseTrialPlSegment1TagsBalances input)
        {
            if (input == null)
            {
                return false;
