...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateItemParams :  IEquatable<CreateItemParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateItemParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateItemParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateItemParams" /> class.
        /// </summary>
        ...
        public CreateItemParams(int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateItemParams and cannot be null");;
        ...
        {
            return this.Equals(input as CreateItemParams);
        }

        /// <summary>
        /// Returns true if CreateItemParams instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateItemParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateItemParams input)
        {
            if (input == null)
                return false;
