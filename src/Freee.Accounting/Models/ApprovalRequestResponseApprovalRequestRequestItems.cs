...
namespace Freee.Accounting.Models
{
    ...
    public partial class ApprovalRequestResponseApprovalRequestRequestItems : IEquatable<ApprovalRequestResponseApprovalRequestRequestItems>
    {
        ...
        /// <param name="type">項目タイプ(title: 申請タイトル, single_line: 自由記述形式 1行, multi_line: 自由記述形式 複数行, select: プルダウン, date: 日付, amount: 金額, receipt: 添付ファイル) (required).</param>
        ...
        public ApprovalRequestResponseApprovalRequestRequestItems(int id = default(int), TypeEnum type = default(TypeEnum), string value = default(string))
        {
            ...
            this.Value = value ?? throw new ArgumentNullException("value is a required property for ApprovalRequestResponseApprovalRequestRequestItems and cannot be null");
        }
