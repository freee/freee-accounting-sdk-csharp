...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlSectionsResponseTrialPlSectionsSections :  IEquatable<TrialPlSectionsResponseTrialPlSectionsSections>
    {
        ...
        public TrialPlSectionsResponseTrialPlSectionsSections(int id = default(int), string name = default(string), int closingBalance = default(int), List<TrialPlSectionsResponseTrialPlSectionsPartners> partners = default(List<TrialPlSectionsResponseTrialPlSectionsPartners>), List<TrialPlSectionsResponseTrialPlSectionsItems> items = default(List<TrialPlSectionsResponseTrialPlSectionsItems>))
        {
            this.Id = id;
            this.Name = name;
