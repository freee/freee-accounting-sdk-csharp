...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsResponseTrialBs
    {
        /// <summary>
        /// Initializes a new instance of the TrialBsResponseTrialBs class.
        /// </summary>
        ...
        public TrialBsResponseTrialBs(int companyId, IList<TrialBsResponseTrialBsBalancesItem> balances, int? fiscalYear = default(int?), int? startMonth = default(int?), int? endMonth = default(int?), string startDate = default(string), string endDate = default(string), string accountItemDisplayType = default(string), string breakdownDisplayType = default(string), int? partnerId = default(int?), string partnerCode = default(string), int? itemId = default(int?), string adjustment = default(string), string createdAt = default(string))
        {
            CompanyId = companyId;
        ...
        public IList<TrialBsResponseTrialBsBalancesItem> Balances { get; set; }
