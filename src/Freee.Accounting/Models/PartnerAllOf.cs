...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PartnerAllOf :  IEquatable<PartnerAllOf>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerAllOf" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PartnerAllOf() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerAllOf" /> class.
        /// </summary>
        ...
        public PartnerAllOf(int id = default(int), string code = default(string), int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.Id = id;
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for PartnerAllOf and cannot be null");;
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PartnerAllOf and cannot be null");;
        ...
        {
            return this.Equals(input as PartnerAllOf);
        }

        /// <summary>
        /// Returns true if PartnerAllOf instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerAllOf to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerAllOf input)
        {
            if (input == null)
                return false;
