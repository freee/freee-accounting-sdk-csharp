...
namespace Freee.Accounting.Models
{
    ...
    public partial class WalletableCreateParams :  IEquatable<WalletableCreateParams>
    {
        ...
        public WalletableCreateParams(string name = default(string), TypeEnum type = default(TypeEnum), int companyId = default(int), int bankId = default(int), string groupName = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for WalletableCreateParams and cannot be null");;
            this.Type = type;
