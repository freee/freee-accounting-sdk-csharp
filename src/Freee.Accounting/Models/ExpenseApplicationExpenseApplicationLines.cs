...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExpenseApplicationExpenseApplicationLines :  IEquatable<ExpenseApplicationExpenseApplicationLines>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseApplicationExpenseApplicationLines" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExpenseApplicationExpenseApplicationLines() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExpenseApplicationExpenseApplicationLines" /> class.
        /// </summary>
        ...
        public ExpenseApplicationExpenseApplicationLines(int id = default(int), string transactionDate = default(string), string description = default(string), int amount = default(int), int expenseApplicationLineTemplateId = default(int), int receiptId = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as ExpenseApplicationExpenseApplicationLines);
        }

        /// <summary>
        /// Returns true if ExpenseApplicationExpenseApplicationLines instances are equal
        /// </summary>
        /// <param name="input">Instance of ExpenseApplicationExpenseApplicationLines to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExpenseApplicationExpenseApplicationLines input)
        {
            if (input == null)
                return false;
