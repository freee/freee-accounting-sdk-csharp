...
namespace Freee.Accounting.Models
{
    ...
    public partial class ExpenseApplicationExpenseApplicationLines :  IEquatable<ExpenseApplicationExpenseApplicationLines>
    {
        ...
        public ExpenseApplicationExpenseApplicationLines(int amount = default(int), string description = default(string), int expenseApplicationLineTemplateId = default(int), int id = default(int), int receiptId = default(int), string transactionDate = default(string))
        {
            this.Id = id;
            this.Amount = amount;
