...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class InvoicesUpdateParams :  IEquatable<InvoicesUpdateParams>
    {
        /// <summary>
        ...
        protected InvoicesUpdateParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InvoicesUpdateParams" /> class.
        /// </summary>
        ...
        public List<InvoicesUpdateParamsInvoiceContents> InvoiceContents { get; set; }
        ...
        {
            return this.Equals(input as InvoicesUpdateParams);
        }

        /// <summary>
        /// Returns true if InvoicesUpdateParams instances are equal
        /// </summary>
        /// <param name="input">Instance of InvoicesUpdateParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InvoicesUpdateParams input)
        {
            if (input == null)
                return false;
