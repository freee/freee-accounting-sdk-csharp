...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem
        /// class.
        /// </summary>
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem()
        {
            CustomInit();
        }
        ...
        public TrialPlTwoYearsResponseTrialPlTwoYearsBalancesItemPartnersItem(int id, string name = default(string), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
            Id = id;
            Name = name;
