...
namespace Freee.Accounting.Models
{
    ...
    public partial class DealReceipts :  IEquatable<DealReceipts>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealReceipts" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealReceipts() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealReceipts" /> class.
        /// </summary>
        ...
        public DealReceipts(string createdAt = default(string), string description = default(string), string fileSrc = default(string), int id = default(int), string issueDate = default(string), string mimeType = default(string), OriginEnum origin = default(OriginEnum), StatusEnum status = default(StatusEnum), DealUser user = default(DealUser))
        {
            ...
            this.CreatedAt = createdAt ?? throw new ArgumentNullException("createdAt is a required property for DealReceipts and cannot be null");
            // to ensure "fileSrc" is required (not null)
            this.FileSrc = fileSrc ?? throw new ArgumentNullException("fileSrc is a required property for DealReceipts and cannot be null");
            this.Id = id;
            // to ensure "mimeType" is required (not null)
            this.MimeType = mimeType ?? throw new ArgumentNullException("mimeType is a required property for DealReceipts and cannot be null");
            this.Origin = origin;
            this.Status = status;
            // to ensure "user" is required (not null)
            this.User = user ?? throw new ArgumentNullException("user is a required property for DealReceipts and cannot be null");
        ...
        {
            return this.Equals(input as DealReceipts);
        }

        /// <summary>
        /// Returns true if DealReceipts instances are equal
        /// </summary>
        /// <param name="input">Instance of DealReceipts to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealReceipts input)
        {
            if (input == null)
                return false;
