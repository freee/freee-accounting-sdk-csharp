...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ManualJournalsUpdateParamsDetails :  IEquatable<ManualJournalsUpdateParamsDetails>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalsUpdateParamsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManualJournalsUpdateParamsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalsUpdateParamsDetails" /> class.
        /// </summary>
        ...
        public ManualJournalsUpdateParamsDetails(int id = default(int), EntrySideEnum entrySide = default(EntrySideEnum), int taxCode = default(int), int accountItemId = default(int), int amount = default(int), int vat = default(int), int partnerId = default(int), string partnerCode = default(string), int itemId = default(int), int sectionId = default(int), List<int> tagIds = default(List<int>), int segment1TagId = default(int), int segment2TagId = default(int), int segment3TagId = default(int), string description = default(string))
        {
        ...
        {
            return this.Equals(input as ManualJournalsUpdateParamsDetails);
        }

        /// <summary>
        /// Returns true if ManualJournalsUpdateParamsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualJournalsUpdateParamsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualJournalsUpdateParamsDetails input)
        {
            if (input == null)
                return false;
