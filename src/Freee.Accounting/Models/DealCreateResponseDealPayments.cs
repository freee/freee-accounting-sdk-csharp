...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "dealCreateResponse_deal_payments")]
    public partial class DealCreateResponseDealPayments : IEquatable<DealCreateResponseDealPayments>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DealCreateResponseDealPayments" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected DealCreateResponseDealPayments() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="DealCreateResponseDealPayments" /> class.
        /// </summary>
        ...
        public DealCreateResponseDealPayments(int amount = default(int), string date = default(string), int fromWalletableId = default(int), FromWalletableTypeEnum? fromWalletableType = default(FromWalletableTypeEnum?), int id = default(int))
        {
            ...
            this.Date = date ?? throw new ArgumentNullException("date is a required property for DealCreateResponseDealPayments and cannot be null");
            this.Id = id;
        ...
        {
            return this.Equals(input as DealCreateResponseDealPayments);
        }

        /// <summary>
        /// Returns true if DealCreateResponseDealPayments instances are equal
        /// </summary>
        /// <param name="input">Instance of DealCreateResponseDealPayments to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DealCreateResponseDealPayments input)
        {
            if (input == null)
                return false;
