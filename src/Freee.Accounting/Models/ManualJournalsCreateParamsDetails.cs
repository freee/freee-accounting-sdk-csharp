...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class ManualJournalsCreateParamsDetails :  IEquatable<ManualJournalsCreateParamsDetails>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalsCreateParamsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ManualJournalsCreateParamsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ManualJournalsCreateParamsDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ManualJournalsCreateParamsDetails);
        }

        /// <summary>
        /// Returns true if ManualJournalsCreateParamsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of ManualJournalsCreateParamsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ManualJournalsCreateParamsDetails input)
        {
            if (input == null)
                return false;
