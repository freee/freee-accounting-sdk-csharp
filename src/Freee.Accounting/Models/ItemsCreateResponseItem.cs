...
namespace Freee.Accounting.Models
{
    ...
    public partial class ItemsCreateResponseItem
    {
        /// <summary>
        /// Initializes a new instance of the ItemsCreateResponseItem class.
        /// </summary>
        public ItemsCreateResponseItem()
        {
            CustomInit();
        }
        ...
        public ItemsCreateResponseItem(int id, int companyId, string name, string shortcut1 = default(string), string shortcut2 = default(string))
        {
            Id = id;
            CompanyId = companyId;
            Name = name;
