...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TransfersResponse :  IEquatable<TransfersResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransfersResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TransfersResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TransfersResponse" /> class.
        /// </summary>
        /// <param name="transfer">transfer (required).</param>
        public TransfersResponse(Transfer transfer = default(Transfer))
        {
            // to ensure "transfer" is required (not null)
            this.Transfer = transfer ?? throw new ArgumentNullException("transfer is a required property for TransfersResponse and cannot be null");;
        }
