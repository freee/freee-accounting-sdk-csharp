...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem
    {
        /// <summary>
        /// Initializes a new instance of the
        /// TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem
        /// class.
        /// </summary>
        public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem()
        {
            CustomInit();
        }
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsBalancesItemPartnersItem(int id, string name = default(string), int? lastYearClosingBalance = default(int?), int? closingBalance = default(int?), double? yearOnYear = default(double?))
        {
            Id = id;
            Name = name;
