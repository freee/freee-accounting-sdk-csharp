...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersCapability :  IEquatable<UsersCapability>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersCapability" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UsersCapability);
        }

        /// <summary>
        /// Returns true if UsersCapability instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersCapability to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersCapability input)
        {
            if (input == null)
                return false;
