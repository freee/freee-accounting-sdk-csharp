...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse20013 : IEquatable<InlineResponse20013>
    {
        ...
        public InlineResponse20013(List<InlineResponse20013Taxes> taxes = default(List<InlineResponse20013Taxes>))
        {
            // to ensure "taxes" is required (not null)
            this.Taxes = taxes ?? throw new ArgumentNullException("taxes is a required property for InlineResponse20013 and cannot be null");
        }
        ...
        public List<InlineResponse20013Taxes> Taxes { get; set; }
