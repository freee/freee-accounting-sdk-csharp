...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateItemParams :  IEquatable<UpdateItemParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateItemParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateItemParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateItemParams" /> class.
        /// </summary>
        ...
        public UpdateItemParams(int companyId = default(int), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for UpdateItemParams and cannot be null");;
        ...
        {
            return this.Equals(input as UpdateItemParams);
        }

        /// <summary>
        /// Returns true if UpdateItemParams instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateItemParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateItemParams input)
        {
            if (input == null)
                return false;
