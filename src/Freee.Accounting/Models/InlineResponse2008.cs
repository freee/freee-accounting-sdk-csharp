...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>
    {
        ...
        public InlineResponse2008(List<Quotation> quotations = default(List<Quotation>))
        {
            // to ensure "quotations" is required (not null)
            this.Quotations = quotations ?? throw new ArgumentNullException("quotations is a required property for InlineResponse2008 and cannot be null");
        }
