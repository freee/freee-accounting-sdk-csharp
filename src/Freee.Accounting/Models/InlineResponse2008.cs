...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2008 : IEquatable<InlineResponse2008>
    {
        ...
        public InlineResponse2008(List<Receipt> receipts = default(List<Receipt>))
        {
            // to ensure "receipts" is required (not null)
            this.Receipts = receipts ?? throw new ArgumentNullException("receipts is a required property for InlineResponse2008 and cannot be null");
        }
