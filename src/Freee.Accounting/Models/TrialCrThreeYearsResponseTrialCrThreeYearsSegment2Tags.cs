...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrThreeYearsResponse_trial_cr_three_years_segment_2_tags")]
    public partial class TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags : IEquatable<TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags" /> class.
        /// </summary>
        ...
        public TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags);
        }

        /// <summary>
        /// Returns true if TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrThreeYearsResponseTrialCrThreeYearsSegment2Tags input)
        {
            if (input == null)
            {
                return false;
