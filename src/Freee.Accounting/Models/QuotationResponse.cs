...
namespace Freee.Accounting.Models
{
    ...
    public partial class QuotationResponse : IEquatable<QuotationResponse>
    {
        ...
        public QuotationResponse(Quotation quotation = default(Quotation))
        {
            // to ensure "quotation" is required (not null)
            this.Quotation = quotation ?? throw new ArgumentNullException("quotation is a required property for QuotationResponse and cannot be null");
        }
