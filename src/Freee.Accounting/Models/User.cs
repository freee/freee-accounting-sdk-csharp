...
namespace Freee.Accounting.Models
{
    ...
    public partial class User :  IEquatable<User>
    {
        ...
        /// <param name="firstName">氏名（名）.</param>
        /// <param name="lastName">氏名（姓）.</param>
        /// <param name="firstNameKana">氏名（カナ・名）.</param>
        /// <param name="lastNameKana">氏名（カナ・姓）.</param>
        public User(int id = default(int), string email = default(string), string displayName = default(string), string firstName = default(string), string lastName = default(string), string firstNameKana = default(string), string lastNameKana = default(string))
        {
            this.Id = id;
