...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class WalletablesResponse :  IEquatable<WalletablesResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletablesResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WalletablesResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletablesResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as WalletablesResponse);
        }

        /// <summary>
        /// Returns true if WalletablesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletablesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletablesResponse input)
        {
            if (input == null)
                return false;
