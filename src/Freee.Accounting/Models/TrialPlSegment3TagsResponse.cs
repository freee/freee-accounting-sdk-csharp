...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlSegment_3TagsResponse")]
    public partial class TrialPlSegment3TagsResponse : IEquatable<TrialPlSegment3TagsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment3TagsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialPlSegment3TagsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlSegment3TagsResponse" /> class.
        /// </summary>
        ...
        public TrialPlSegment3TagsResponse(TrialPlSegment3TagsResponseTrialPlSegment3Tags trialPlSegment3Tags = default(TrialPlSegment3TagsResponseTrialPlSegment3Tags), bool upToDate = default(bool), List<JournalsResponseJournalsUpToDateReasons> upToDateReasons = default(List<JournalsResponseJournalsUpToDateReasons>))
        {
            ...
            {
                throw new ArgumentNullException("trialPlSegment3Tags is a required property for TrialPlSegment3TagsResponse and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TrialPlSegment3Tags: ").Append(TrialPlSegment3Tags).Append("\n");
        ...
        {
            return this.Equals(input as TrialPlSegment3TagsResponse);
        }

        /// <summary>
        /// Returns true if TrialPlSegment3TagsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlSegment3TagsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlSegment3TagsResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.TrialPlSegment3Tags == input.TrialPlSegment3Tags ||
                    (this.TrialPlSegment3Tags != null &&
                    this.TrialPlSegment3Tags.Equals(input.TrialPlSegment3Tags))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TrialPlSegment3Tags != null)
                {
                    hashCode = (hashCode * 59) + this.TrialPlSegment3Tags.GetHashCode();
                }
