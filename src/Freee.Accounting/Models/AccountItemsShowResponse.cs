...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class AccountItemsShowResponse :  IEquatable<AccountItemsShowResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountItemsShowResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountItemsShowResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountItemsShowResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AccountItemsShowResponse);
        }

        /// <summary>
        /// Returns true if AccountItemsShowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountItemsShowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountItemsShowResponse input)
        {
            if (input == null)
                return false;
