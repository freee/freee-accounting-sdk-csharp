...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsThreeYearsResponse_trial_bs_three_years_sections")]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsSections : IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsSections>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsSections" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsThreeYearsResponseTrialBsThreeYearsSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsSections" /> class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsSections(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsThreeYearsResponseTrialBsThreeYearsSections);
        }

        /// <summary>
        /// Returns true if TrialBsThreeYearsResponseTrialBsThreeYearsSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsThreeYearsResponseTrialBsThreeYearsSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsThreeYearsResponseTrialBsThreeYearsSections input)
        {
            if (input == null)
            {
                return false;
