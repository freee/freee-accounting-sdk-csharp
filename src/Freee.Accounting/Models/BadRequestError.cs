...
namespace Freee.Accounting.Models
{
    ...
    public partial class BadRequestError :  IEquatable<BadRequestError>
    {
        ...
        public BadRequestError(int statusCode = default(int), List<BadRequestErrorErrors> errors = default(List<BadRequestErrorErrors>))
        {
        ...
        public List<BadRequestErrorErrors> Errors { get; set; }
