...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlResponseTrialPlSections :  IEquatable<TrialPlResponseTrialPlSections>
    {
        ...
        protected TrialPlResponseTrialPlSections() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialPlResponseTrialPlSections" /> class.
        /// </summary>
        ...
        public TrialPlResponseTrialPlSections(int id = default(int), string name = default(string), int openingBalance = default(int), int debitAmount = default(int), int creditAmount = default(int), int closingBalance = default(int), decimal compositionRatio = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialPlResponseTrialPlSections);
        }

        /// <summary>
        /// Returns true if TrialPlResponseTrialPlSections instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialPlResponseTrialPlSections to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialPlResponseTrialPlSections input)
        {
            if (input == null)
                return false;
