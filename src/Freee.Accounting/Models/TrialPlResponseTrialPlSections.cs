...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialPlResponse_trial_pl_sections")]
    public partial class TrialPlResponseTrialPlSections : IEquatable<TrialPlResponseTrialPlSections>
    {
        ...
        public TrialPlResponseTrialPlSections(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
