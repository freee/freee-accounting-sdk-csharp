...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsResponseTrialBsPartners :  IEquatable<TrialBsResponseTrialBsPartners>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsPartners" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsResponseTrialBsPartners() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsResponseTrialBsPartners" /> class.
        /// </summary>
        ...
        public TrialBsResponseTrialBsPartners(int id = default(int), string name = default(string), int openingBalance = default(int), int debitAmount = default(int), int creditAmount = default(int), int closingBalance = default(int), decimal compositionRatio = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialBsResponseTrialBsPartners);
        }

        /// <summary>
        /// Returns true if TrialBsResponseTrialBsPartners instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsResponseTrialBsPartners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsResponseTrialBsPartners input)
        {
            if (input == null)
                return false;
