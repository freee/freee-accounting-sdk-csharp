...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsResponse_trial_bs_partners")]
    public partial class TrialBsResponseTrialBsPartners : IEquatable<TrialBsResponseTrialBsPartners>
    {
        ...
        public TrialBsResponseTrialBsPartners(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
