...
namespace Freee.Accounting.Models
{
    ...
    public partial class CreateExpenseApplicationParams
    {
        /// <summary>
        /// Initializes a new instance of the CreateExpenseApplicationParams
        /// class.
        /// </summary>
        public CreateExpenseApplicationParams()
        {
            CustomInit();
        }
        ...
        /// <param name="editableOnWeb">会計freeeのWeb画面から申請内容を編集可能（デフォルト:
        ...
        /// <summary>
        /// Gets or sets 会計freeeのWeb画面から申請内容を編集可能（デフォルト:
        ...
        public IList<CreateExpenseApplicationParamsExpenseApplicationLinesItem> ExpenseApplicationLines { get; set; }
