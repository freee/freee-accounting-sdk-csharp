...
namespace Freee.Accounting.Models
{
    ...
    public partial class ApprovalRequestResponseApprovalRequestComments :  IEquatable<ApprovalRequestResponseApprovalRequestComments>
    {
        ...
        public ApprovalRequestResponseApprovalRequestComments(string comment = default(string), string postedAt = default(string), int userId = default(int))
        {
            ...
            this.Comment = comment ?? throw new ArgumentNullException("comment is a required property for ApprovalRequestResponseApprovalRequestComments and cannot be null");
            // to ensure "postedAt" is required (not null)
            this.PostedAt = postedAt ?? throw new ArgumentNullException("postedAt is a required property for ApprovalRequestResponseApprovalRequestComments and cannot be null");
            this.UserId = userId;
        }
