...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UsersMeResponseUser :  IEquatable<UsersMeResponseUser>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersMeResponseUser" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UsersMeResponseUser() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersMeResponseUser" /> class.
        /// </summary>
        ...
        public UsersMeResponseUser(int id = default(int), string email = default(string), string displayName = default(string), string firstName = default(string), string lastName = default(string), string firstNameKana = default(string), string lastNameKana = default(string), List<UsersMeResponseUserCompanies> companies = default(List<UsersMeResponseUserCompanies>))
        {
            this.Id = id;
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for UsersMeResponseUser and cannot be null");;
        ...
        public List<UsersMeResponseUserCompanies> Companies { get; set; }
        ...
        {
            return this.Equals(input as UsersMeResponseUser);
        }

        /// <summary>
        /// Returns true if UsersMeResponseUser instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersMeResponseUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersMeResponseUser input)
        {
            if (input == null)
                return false;
