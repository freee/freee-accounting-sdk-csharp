...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class TrialBsTwoYearsResponseTrialBsTwoYearsPartners :  IEquatable<TrialBsTwoYearsResponseTrialBsTwoYearsPartners>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsTwoYearsResponseTrialBsTwoYearsPartners" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsTwoYearsResponseTrialBsTwoYearsPartners() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsTwoYearsResponseTrialBsTwoYearsPartners" /> class.
        /// </summary>
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsPartners(int id = default(int), string name = default(string), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialBsTwoYearsResponseTrialBsTwoYearsPartners);
        }

        /// <summary>
        /// Returns true if TrialBsTwoYearsResponseTrialBsTwoYearsPartners instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsTwoYearsResponseTrialBsTwoYearsPartners to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsTwoYearsResponseTrialBsTwoYearsPartners input)
        {
            if (input == null)
                return false;
