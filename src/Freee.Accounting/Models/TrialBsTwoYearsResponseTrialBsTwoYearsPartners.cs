...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsTwoYearsResponse_trial_bs_two_years_partners")]
    public partial class TrialBsTwoYearsResponseTrialBsTwoYearsPartners : IEquatable<TrialBsTwoYearsResponseTrialBsTwoYearsPartners>
    {
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsPartners(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
