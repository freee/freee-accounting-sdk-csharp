...
namespace Freee.Accounting.Models
{
    ...
    public partial class ExpenseApplicationCreateParams : IEquatable<ExpenseApplicationCreateParams>
    {
        ...
        public ExpenseApplicationCreateParams(int companyId = default(int), string description = default(string), bool editableOnWeb = default(bool), List<ExpenseApplicationCreateParamsExpenseApplicationLines> expenseApplicationLines = default(List<ExpenseApplicationCreateParamsExpenseApplicationLines>), string issueDate = default(string), int sectionId = default(int), List<int> tagIds = default(List<int>), string title = default(string))
        {
            this.CompanyId = companyId;
            // to ensure "expenseApplicationLines" is required (not null)
            this.ExpenseApplicationLines = expenseApplicationLines ?? throw new ArgumentNullException("expenseApplicationLines is a required property for ExpenseApplicationCreateParams and cannot be null");
            // to ensure "issueDate" is required (not null)
            this.IssueDate = issueDate ?? throw new ArgumentNullException("issueDate is a required property for ExpenseApplicationCreateParams and cannot be null");
            // to ensure "title" is required (not null)
            this.Title = title ?? throw new ArgumentNullException("title is a required property for ExpenseApplicationCreateParams and cannot be null");
