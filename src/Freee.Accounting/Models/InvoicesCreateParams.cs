...
namespace Freee.Accounting.Models
{
    ...
    public partial class InvoicesCreateParams
    {
        /// <summary>
        /// Initializes a new instance of the InvoicesCreateParams class.
        /// </summary>
        ...
        /// 発行(請求先ワークフローを利用している場合は指定できません)). Possible values include: 'draft',
        /// 'issue'</param>
        ...
        public InvoicesCreateParams(int companyId, string issueDate = default(string), int? partnerId = default(int?), string partnerCode = default(string), string invoiceNumber = default(string), string title = default(string), string dueDate = default(string), string bookingDate = default(string), string description = default(string), string invoiceStatus = default(string), string partnerName = default(string), string partnerTitle = default(string), string partnerContactInfo = default(string), string companyName = default(string), string companyZipcode = default(string), int? companyPrefectureCode = default(int?), string companyAddress1 = default(string), string companyAddress2 = default(string), string companyContactInfo = default(string), string paymentType = default(string), string paymentBankInfo = default(string), string useVirtualTransferAccount = default(string), string message = default(string), string notes = default(string), string invoiceLayout = default(string), string taxEntryMethod = default(string), IList<InvoicesCreateParamsInvoiceContentsItem> invoiceContents = default(IList<InvoicesCreateParamsInvoiceContentsItem>))
        {
            CompanyId = companyId;
            IssueDate = issueDate;
            PartnerId = partnerId;
        ...
        public IList<InvoicesCreateParamsInvoiceContentsItem> InvoiceContents { get; set; }
