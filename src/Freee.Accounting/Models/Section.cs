...
namespace Freee.Accounting.Models
{
    ...
    public partial class Section : IEquatable<Section>
    {
        ...
        public Section(int companyId = default(int), int id = default(int), string longName = default(string), string name = default(string), string shortcut1 = default(string), string shortcut2 = default(string))
        {
