...
namespace Freee.Accounting.Models
{
    ...
    public partial class Section :  IEquatable<Section>
    {
        ...
        public Section(int id = default(int), string name = default(string), string longName = default(string), int companyId = default(int), string shortcut1 = default(string), string shortcut2 = default(string))
        {
            this.Id = id;
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for Section and cannot be null");;
