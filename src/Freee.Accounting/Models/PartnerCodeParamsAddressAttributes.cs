...
namespace Freee.Accounting.Models
{
    ...
    public partial class PartnerCodeParamsAddressAttributes
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PartnerCodeParamsAddressAttributes class.
        /// </summary>
        public PartnerCodeParamsAddressAttributes()
        {
            CustomInit();
        }
        ...
        public PartnerCodeParamsAddressAttributes(string zipcode = default(string), int? prefectureCode = default(int?), string streetName1 = default(string), string streetName2 = default(string))
        {
            Zipcode = zipcode;
