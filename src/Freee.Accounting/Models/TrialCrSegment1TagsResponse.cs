...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrSegment_1TagsResponse")]
    public partial class TrialCrSegment1TagsResponse : IEquatable<TrialCrSegment1TagsResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment1TagsResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrSegment1TagsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrSegment1TagsResponse" /> class.
        /// </summary>
        /// <param name="trialCrSegment1Tags">trialCrSegment1Tags (required).</param>
        ...
        /// <summary>
        /// Gets or Sets TrialCrSegment1Tags
        /// </summary>
        [DataMember(Name = "trial_cr_segment_1_tags", IsRequired = true, EmitDefaultValue = false)]
        public TrialCrSegment1TagsResponseTrialCrSegment1Tags TrialCrSegment1Tags { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TrialCrSegment1Tags: ").Append(TrialCrSegment1Tags).Append("\n");
        ...
        {
            return this.Equals(input as TrialCrSegment1TagsResponse);
        }

        /// <summary>
        /// Returns true if TrialCrSegment1TagsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrSegment1TagsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrSegment1TagsResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                (
                    this.TrialCrSegment1Tags == input.TrialCrSegment1Tags ||
                    (this.TrialCrSegment1Tags != null &&
                    this.TrialCrSegment1Tags.Equals(input.TrialCrSegment1Tags))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.TrialCrSegment1Tags != null)
                {
                    hashCode = (hashCode * 59) + this.TrialCrSegment1Tags.GetHashCode();
                }
