...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateDealParamsDetails :  IEquatable<UpdateDealParamsDetails>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDealParamsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDealParamsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDealParamsDetails" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateDealParamsDetails);
        }

        /// <summary>
        /// Returns true if UpdateDealParamsDetails instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDealParamsDetails to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDealParamsDetails input)
        {
            if (input == null)
                return false;
