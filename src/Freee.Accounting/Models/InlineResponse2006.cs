...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2006 : IEquatable<InlineResponse2006>
    {
        ...
        public InlineResponse2006(List<ManualJournal> manualJournals = default(List<ManualJournal>))
        {
            // to ensure "manualJournals" is required (not null)
            this.ManualJournals = manualJournals ?? throw new ArgumentNullException("manualJournals is a required property for InlineResponse2006 and cannot be null");
        }
