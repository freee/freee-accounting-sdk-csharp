...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2006 :  IEquatable<InlineResponse2006>
    {
        ...
        public InlineResponse2006(List<Item> items = default(List<Item>))
        {
            // to ensure "items" is required (not null)
            this.Items = items ?? throw new ArgumentNullException("items is a required property for InlineResponse2006 and cannot be null");
        }
