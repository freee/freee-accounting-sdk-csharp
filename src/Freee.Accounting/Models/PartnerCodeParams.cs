...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class PartnerCodeParams :  IEquatable<PartnerCodeParams>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerCodeParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PartnerCodeParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PartnerCodeParams" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as PartnerCodeParams);
        }

        /// <summary>
        /// Returns true if PartnerCodeParams instances are equal
        /// </summary>
        /// <param name="input">Instance of PartnerCodeParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PartnerCodeParams input)
        {
            if (input == null)
                return false;
