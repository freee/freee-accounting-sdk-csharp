...
namespace Freee.Accounting.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsTwoYearsResponseTrialBsTwoYearsItems" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsTwoYearsResponseTrialBsTwoYearsItems() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsTwoYearsResponseTrialBsTwoYearsItems" /> class.
        /// </summary>
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsItems(int id = default(int), string name = default(string), int lastYearClosingBalance = default(int), int closingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
            this.Name = name;
        ...
        {
            return this.Equals(input as TrialBsTwoYearsResponseTrialBsTwoYearsItems);
        }

        /// <summary>
        /// Returns true if TrialBsTwoYearsResponseTrialBsTwoYearsItems instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsTwoYearsResponseTrialBsTwoYearsItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsTwoYearsResponseTrialBsTwoYearsItems input)
        {
            if (input == null)
                return false;
