...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialBsTwoYearsResponseTrialBsTwoYearsItems : IEquatable<TrialBsTwoYearsResponseTrialBsTwoYearsItems>
    {
        ...
        public TrialBsTwoYearsResponseTrialBsTwoYearsItems(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
