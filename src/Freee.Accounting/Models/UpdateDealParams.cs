...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateDealParams :  IEquatable<UpdateDealParams>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDealParams" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected UpdateDealParams() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateDealParams" /> class.
        /// </summary>
        ...
        public UpdateDealParams(string issueDate = default(string), TypeEnum type = default(TypeEnum), int companyId = default(int), string dueDate = default(string), int partnerId = default(int), string partnerCode = default(string), string refNumber = default(string), List<UpdateDealParamsDetails> details = default(List<UpdateDealParamsDetails>), List<int> receiptIds = default(List<int>))
        {
            // to ensure "issueDate" is required (not null)
            this.IssueDate = issueDate ?? throw new ArgumentNullException("issueDate is a required property for UpdateDealParams and cannot be null");;
            this.Type = type;
            this.CompanyId = companyId;
            // to ensure "details" is required (not null)
            this.Details = details ?? throw new ArgumentNullException("details is a required property for UpdateDealParams and cannot be null");;
        ...
        public List<UpdateDealParamsDetails> Details { get; set; }
        ...
        {
            return this.Equals(input as UpdateDealParams);
        }

        /// <summary>
        /// Returns true if UpdateDealParams instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateDealParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateDealParams input)
        {
            if (input == null)
                return false;
