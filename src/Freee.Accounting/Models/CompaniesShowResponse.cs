...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract]
    public partial class CompaniesShowResponse :  IEquatable<CompaniesShowResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesShowResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CompaniesShowResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompaniesShowResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CompaniesShowResponse);
        }

        /// <summary>
        /// Returns true if CompaniesShowResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CompaniesShowResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompaniesShowResponse input)
        {
            if (input == null)
                return false;
