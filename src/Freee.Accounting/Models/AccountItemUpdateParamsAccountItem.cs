...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "accountItemUpdateParams_account_item")]
    public partial class AccountItemUpdateParamsAccountItem : IEquatable<AccountItemUpdateParamsAccountItem>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountItemUpdateParamsAccountItem" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AccountItemUpdateParamsAccountItem() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountItemUpdateParamsAccountItem" /> class.
        /// </summary>
        ...
        /// <param name="name">勘定科目名 (30文字以内) 口座に紐付かない勘定科目の更新時は必須です。 口座に紐付く勘定科目の更新時は指定することができません。 .</param>
        ...
        public AccountItemUpdateParamsAccountItem(int accountCategoryId = default(int), int accumulatedDepAccountItemId = default(int), int correspondingExpenseId = default(int), int correspondingIncomeId = default(int), string groupName = default(string), List<AccountItemCreateParamsAccountItemItems> items = default(List<AccountItemCreateParamsAccountItemItems>), string name = default(string), List<AccountItemCreateParamsAccountItemItems> partners = default(List<AccountItemCreateParamsAccountItemItems>), int searchable = default(int), string shortcut = default(string), string shortcutNum = default(string), int taxCode = default(int))
        {
            ...
            if (groupName == null) {
                throw new ArgumentNullException("groupName is a required property for AccountItemUpdateParamsAccountItem and cannot be null");
            }
        ...
        /// </summary>
        /// <value>勘定科目名 (30文字以内) 口座に紐付かない勘定科目の更新時は必須です。 口座に紐付く勘定科目の更新時は指定することができません。 </value>
        ...
        {
            return this.Equals(input as AccountItemUpdateParamsAccountItem);
        }

        /// <summary>
        /// Returns true if AccountItemUpdateParamsAccountItem instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountItemUpdateParamsAccountItem to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountItemUpdateParamsAccountItem input)
        {
            if (input == null)
            {
                return false;
