...
namespace Freee.Accounting.Models
{
    ...
    public partial class PartnerCreateParamsPartnerDocSettingAttributes :  IEquatable<PartnerCreateParamsPartnerDocSettingAttributes>
    {
        ...
        /// </summary>
        /// <param name="sendingMethod">請求書送付方法(mail:メール、posting:郵送、mail_and_posting:メールと郵送).</param>
        public PartnerCreateParamsPartnerDocSettingAttributes(string sendingMethod = default(string))
        {
