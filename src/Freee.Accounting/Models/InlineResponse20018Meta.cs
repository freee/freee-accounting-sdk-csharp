...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "inline_response_200_18_meta")]
    public partial class InlineResponse20018Meta : IEquatable<InlineResponse20018Meta>
    {
        ...
        public InlineResponse20018Meta(bool upToDate = default(bool))
        {
        ...
        {
            return this.Equals(input as InlineResponse20018Meta);
        }

        /// <summary>
        /// Returns true if InlineResponse20018Meta instances are equal
        /// </summary>
        /// <param name="input">Instance of InlineResponse20018Meta to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InlineResponse20018Meta input)
        {
            if (input == null)
                return false;
