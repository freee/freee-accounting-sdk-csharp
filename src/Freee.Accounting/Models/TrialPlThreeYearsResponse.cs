...
namespace Freee.Accounting.Models
{
    ...
    public partial class TrialPlThreeYearsResponse :  IEquatable<TrialPlThreeYearsResponse>
    {
        ...
        public TrialPlThreeYearsResponse(TrialPlThreeYearsResponseTrialPlThreeYears trialPlThreeYears = default(TrialPlThreeYearsResponseTrialPlThreeYears))
        {
            // to ensure "trialPlThreeYears" is required (not null)
            this.TrialPlThreeYears = trialPlThreeYears ?? throw new ArgumentNullException("trialPlThreeYears is a required property for TrialPlThreeYearsResponse and cannot be null");;
        }
        
        /// <summary>
        /// Gets or Sets TrialPlThreeYears
        /// </summary>
        [DataMember(Name="trial_pl_three_years", EmitDefaultValue=false)]
