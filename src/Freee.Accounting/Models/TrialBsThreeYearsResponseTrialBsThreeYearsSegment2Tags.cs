...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialBsThreeYearsResponse_trial_bs_three_years_segment_2_tags")]
    public partial class TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags : IEquatable<TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags" /> class.
        /// </summary>
        ...
        public TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags(int closingBalance = default(int), int id = default(int), int lastYearClosingBalance = default(int), string name = default(string), int twoYearsBeforeClosingBalance = default(int), decimal yearOnYear = default(decimal))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags);
        }

        /// <summary>
        /// Returns true if TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialBsThreeYearsResponseTrialBsThreeYearsSegment2Tags input)
        {
            if (input == null)
            {
                return false;
