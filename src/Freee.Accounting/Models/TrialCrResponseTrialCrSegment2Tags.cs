...
namespace Freee.Accounting.Models
{
    ...
    /// </summary>
    [DataContract(Name = "trialCrResponse_trial_cr_segment_2_tags")]
    public partial class TrialCrResponseTrialCrSegment2Tags : IEquatable<TrialCrResponseTrialCrSegment2Tags>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrResponseTrialCrSegment2Tags" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TrialCrResponseTrialCrSegment2Tags() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TrialCrResponseTrialCrSegment2Tags" /> class.
        /// </summary>
        ...
        public TrialCrResponseTrialCrSegment2Tags(int closingBalance = default(int), decimal compositionRatio = default(decimal), int creditAmount = default(int), int debitAmount = default(int), int id = default(int), string name = default(string), int openingBalance = default(int))
        {
            this.Id = id;
        ...
        {
            return this.Equals(input as TrialCrResponseTrialCrSegment2Tags);
        }

        /// <summary>
        /// Returns true if TrialCrResponseTrialCrSegment2Tags instances are equal
        /// </summary>
        /// <param name="input">Instance of TrialCrResponseTrialCrSegment2Tags to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TrialCrResponseTrialCrSegment2Tags input)
        {
            if (input == null)
            {
                return false;
