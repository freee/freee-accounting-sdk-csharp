...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2004 : IEquatable<InlineResponse2004>
    {
        ...
        public InlineResponse2004(List<Invoice> invoices = default(List<Invoice>))
        {
            // to ensure "invoices" is required (not null)
            this.Invoices = invoices ?? throw new ArgumentNullException("invoices is a required property for InlineResponse2004 and cannot be null");
        }
