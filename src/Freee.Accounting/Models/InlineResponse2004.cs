...
namespace Freee.Accounting.Models
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>
    {
        ...
        public InlineResponse2004(List<ExpenseApplication> expenseApplications = default(List<ExpenseApplication>))
        {
            // to ensure "expenseApplications" is required (not null)
            this.ExpenseApplications = expenseApplications ?? throw new ArgumentNullException("expenseApplications is a required property for InlineResponse2004 and cannot be null");
        }
