...
namespace Freee.Accounting.Models
{
    ...
    public partial class PartnersResponsePartners : IEquatable<PartnersResponsePartners>
    {
        ...
        public PartnersResponsePartners(PartnersResponseAddressAttributes addressAttributes = default(PartnersResponseAddressAttributes), bool available = default(bool), string code = default(string), int companyId = default(int), string contactName = default(string), string countryCode = default(string), string defaultTitle = default(string), string email = default(string), int id = default(int), string longName = default(string), string name = default(string), string nameKana = default(string), int? orgCode = default(int?), PartnerResponsePartnerPartnerBankAccountAttributes partnerBankAccountAttributes = default(PartnerResponsePartnerPartnerBankAccountAttributes), PartnerResponsePartnerPartnerDocSettingAttributes partnerDocSettingAttributes = default(PartnerResponsePartnerPartnerDocSettingAttributes), int? payerWalletableId = default(int?), string phone = default(string), string shortcut1 = default(string), string shortcut2 = default(string), TransferFeeHandlingSideEnum? transferFeeHandlingSide = default(TransferFeeHandlingSideEnum?), string updateDate = default(string))
        {
